...
def _find_cli_binary() -> str:
    ...
    fixed = os.path.expanduser(
        "~/Library/Developer/Xcode/DerivedData/bmux-tests-v2/Build/Products/Debug/bmux"
    )
...
<!doctype html>
<html>
  <head><title>bmux-browser-cli-regression</title></head>
  <body>
    <main>
...
""".strip()
        ...
        out_dir = Path(tempfile.mkdtemp(prefix="bmux-browser-screenshot-cli-")) / "nested" / "dir"
