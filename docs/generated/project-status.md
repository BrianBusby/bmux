...
| Richer Coding-Agent Evidence and SessionWorkModel (`richer_session_work_model`) | Provenance Engine | open | implemented | BrianBusby/provenance-engine@2add52c611e2 |
