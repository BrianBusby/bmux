  ...
  - **Process Integrity** (`process_integrity`) - program; status: active; owner: Bmux; repositories: Bmux, Provenance Engine; concept: platform; layer: platform; execution: current / Bmux; parallelism: serial
    ...
    - **App Runtime Composition and Test Isolation** (`app_runtime_composition_and_test_isolation`) - phase; status: active; owner: Bmux; repositories: Bmux, Provenance Engine; concept: platform; layer: platform; execution: current / Bmux; parallelism: serial
      ...
      - **App Runtime Composition Migration** (`app_runtime_composition_migration`) - milestone; status: active; owner: Bmux; repositories: Bmux, Provenance Engine; concept: platform; layer: platform; execution: current / Bmux; parallelism: serial
        ...
        - **Browser and DevTools Lifecycle Migration** (`app_runtime_browser_devtools_lifecycle_migration`) - slice; status: active; owner: Bmux; repositories: Bmux; concept: platform; layer: platform; execution: current / Bmux; parallelism: serial; delivery: open; acceptance: implemented; maturity: active
          ...
          Worktree required: true
          Active assignment: worktree: `/Users/brianbusby/repos/.bmux-worktrees/app-runtime-browser-devtools-lifecycle`; branch: `app-runtime-browser-devtools-lifecycle`; agent: `codex`
          ...
          Evidence: BrianBusby/bmux@aa63c9218b1c, BrianBusby/bmux#103 by [BrianBusby](https://github.com/BrianBusby)
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Browser and DevTools Lifecycle Migration (`app_runtime_browser_devtools_lifecycle_migration`) | serial | /Users/brianbusby/repos/.bmux-worktrees/app-runtime-browser-devtools-lifecycle | app-runtime-browser-devtools-lifecycle | codex | `app_delegate_startup`, `app_host_test_side_effects`, `browser_singletons`, `webview_inspector_teardown` | `app_host_test_runtime_isolation`, `app_runtime_composition_boundary` | single active assignment |
