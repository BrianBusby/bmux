...
Status: planning context. Generated Project Truth is authoritative for
dependency readiness, selected-next work, and active implementation:
...
1. Cross-session work awareness foundation: PE public read model and
   deterministic related-session briefs.
