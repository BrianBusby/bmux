...
| PE runtime bridge | root macOS app | `Sources/WorkProvenance/WorkProvenanceRuntime.swift`, `Sources/AppDelegate+AgentChat.swift` |
...
local package references, Project Truth validation, and documentation rules.
