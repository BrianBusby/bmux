...
- Bubble view: `Packages/iOS/BmuxAgentChatUI/Sources/BmuxAgentChatUI/Transcript/Rows/ChatProseBubbleView.swift:41-71` (HStack with `Spacer(minLength: 64)` on the user side + `.frame(maxWidth: bubbleMaxWidth)`).
