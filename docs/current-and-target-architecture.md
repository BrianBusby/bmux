...
- Active implementation slice: Notification and Push-Registration Lifecycle Migration (`app_runtime_notification_push_lifecycle_migration`) - implemented
...
- Notification and Push-Registration Lifecycle Migration (`app_runtime_notification_push_lifecycle_migration`) - slice; status: implemented; owner: Bmux
...
- Menu-Bar and Presentation Preference Lifecycle Migration (`app_runtime_menu_bar_presentation_lifecycle_migration`) - owner: Bmux; depends on: `app_runtime_notification_push_lifecycle_migration`
