...
- use a v2 JSON client (`tests_v2/bmux.py`)
- avoid depending on v1 text output formats

VM runners:
- v1: `ssh bmux-vm 'cd /Users/bmux/bmux && ./scripts/run-tests-v1.sh'`
- v2: `ssh bmux-vm 'cd /Users/bmux/bmux && ./scripts/run-tests-v2.sh'`
