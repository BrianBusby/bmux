...
<p align="center">
  <a href="https://github.com/manaflow-ai/bmux/releases/latest/download/bmux-macos.dmg">
    <img src="../assets/macos-badge.png" alt="Download bmux for macOS" width="180" />
  </a>
</p>
...
<p align="center">
  <a href="https://www.youtube.com/watch?v=i-WxO5YUTOs">▶ វីដេអូបង្ហាញពីដំណើរការ (Demo)</a> · <a href="https://bmux.com/blog/zen-of-bmux">ទស្សនវិជ្ជារបស់ bmux (The Zen of bmux)</a>
</p>
...
<td width="40%" valign="middle">
<h3>SSH</h3>
<code>bmux ssh user@remote</code> បង្កើត workspace សម្រាប់ម៉ាស៊ីនពីចម្ងាយ។ ផ្ទាំងកម្មវិធីរុករកធ្វើដំណើរឆ្លងកាត់បណ្តាញពីចម្ងាយ ដូច្នេះ localhost ដំណើរការបានយ៉ាងស្រួល។ អូសរូបភាពចូលទៅក្នុង session ពីចម្ងាយ ដើម្បីផ្ទុកឡើងតាមរយៈ scp។
</td>
<td width="60%">
...
<code>bmux claude-teams</code> ដំណើរការ teammate mode របស់ Claude Code ដោយប្រើពាក្យបញ្ជាតែមួយ។ សមាជិកក្រុមកើតឡើងជា splits ដើមកំណើត ជាមួយ metadata របារចំហៀង និងការជូនដំណឹង។ មិនត្រូវការ tmux ឡើយ។
</td>
<td width="60%">
...
- **ពាក្យបញ្ជាផ្ទាល់ខ្លួន** — កំណត់សកម្មភាពជាក់លាក់តាមគម្រោងនៅក្នុង [`bmux.json`](https://bmux.com/docs/custom-commands) ដែលចាប់ផ្តើមពី command palette
...
- **ផ្លូវកាត់គ្រាប់ចុច** — [ផ្លូវកាត់ដ៏ទូលំទូលាយ](https://bmux.com/docs/keyboard-shortcuts) សម្រាប់ workspaces, splits, កម្មវិធីរុករក, និងច្រើនទៀត
...
បើក `.dmg` ហើយអូស bmux ទៅកាន់ថត Applications របស់អ្នក។ bmux ធ្វើបច្ចុប្បន្នភាពដោយស្វ័យប្រវត្តិតាមរយៈ Sparkle ដូច្នេះអ្នកគ្រាន់តែទាញយកម្តងគឺគ្រប់គ្រាន់ហើយ។
...
bmux មិនកំណត់ច្បាប់អំពីរបៀបដែលអ្នកអភិវឌ្ឍកាន់ឧបករណ៍របស់ពួកគេទេ។ វាជា terminal និង browser ជាមួយ CLI ហើយផ្នែកដែលនៅសល់គឺអាស្រ័យលើអ្នក។

bmux គឺជា primitive មិនមែនជាដំណោះស្រាយទេ។ វាផ្ដល់ឲ្យអ្នកនូវ terminal មួយ browser មួយ ការជូនដំណឹង workspace ការបំបែក ផ្ទាំង និង CLI មួយដើម្បីគ្រប់គ្រងវាទាំងអស់។ bmux មិនបង្ខំអ្នកចូលទៅក្នុងវិធីដែលមានគំនិតផ្ដាច់ការក្នុងការប្រើភ្នាក់ងារសរសេរកូដទេ។ អ្វីដែលអ្នកសាងសង់ជាមួយ primitive គឺជារបស់អ្នក។
...
សម្រាប់ព័ត៌មានបន្ថែមអំពីរបៀបកំណត់រចនាសម្ព័ន្ធ bmux [សូមមកកាន់ឯកសាររបស់យើង](https://bmux.com/docs/getting-started?utm_source=readme)។
...
bmux NIGHTLY គឺជាកម្មវិធីដាច់ដោយឡែកមួយដែលមាន bundle ID ផ្ទាល់របស់វា ដូច្នេះវាដំណើរការទន្ទឹមនឹងកំណែដែលមានស្ថិរភាព។ វាត្រូវបានស្ថាបនាដោយស្វ័យប្រវត្តិពី commit `main` ចុងក្រោយបង្អស់ និងធ្វើបច្ចុប្បន្នភាពដោយស្វ័យប្រវត្តិតាមរយៈ feed Sparkle ផ្ទាល់របស់វា។

រាយការណ៍ពីបញ្ហា nightly នៅលើ [GitHub Issues](https://github.com/manaflow-ai/bmux/issues) ឬនៅក្នុង [#nightly-bugs on Discord](https://discord.gg/xsgFEVrWCZ)។

## ការស្ដារ Session ឡើងវិញ

ការចាកចេញពី bmux រក្សាទុក session បច្ចុប្បន្ន។ នៅពេលបើកដំណើរការឡើងវិញ bmux ស្ដារស្ថានភាពដែលជាកម្មសិទ្ធិរបស់កម្មវិធីឡើងវិញ៖
- ប្លង់ Window/workspace/pane
- ថតធ្វើការ
- Terminal scrollback (តាមការខិតខំល្អបំផុត)
- URL របស់ browser និងប្រវត្តិការរុករក

bmux មិនធ្វើ checkpoint ស្ថានភាពដំណើរការផ្ទាល់ណាមួយតាមអំពើចិត្តទេ។ tmux, vim, shells និងកម្មវិធី terminal ដែលមិនត្រូវបានគាំទ្រ នឹងបើកឡើងវិញជា terminal ធម្មតា។
...
`bmux hooks setup` ដំឡើង agent ដែលត្រូវបានគាំទ្រដែលវាអាចរកឃើញ និងបោះពុម្ពសេចក្ដីសង្ខេបសម្រាប់ agent ដែលត្រូវបានរំលង។ ការរួមបញ្ចូលការបន្តដំណើរការវិញ (resume) ដែលត្រូវបានគាំទ្ររួមមាន Claude Code, Codex, Grok, OpenCode, Pi, Amp, Cursor CLI, Gemini, Rovo Dev, Copilot, CodeBuddy, Factory និង Qoder។ Claude Code ត្រូវបានដោះស្រាយដោយ bmux Claude wrapper នៅពេលដែលការរួមបញ្ចូល Claude ត្រូវបានបើកនៅក្នុង Settings។
...
ការភ្ជាប់នេះនៅតែភ្ជាប់ជាប់នឹង surface របស់ bmux។ ការភ្ជាប់ដែលបង្កើតឡើងតាមរយៈ CLI សាធារណៈ ឬ socket ត្រូវបានរក្សាទុកសម្រាប់ការត្រួតពិនិត្យ និងការស្ដារដោយដៃ លុះត្រាតែអ្នកអនុម័តបុព្វបទពាក្យបញ្ជាដែលបានចុះហត្ថលេខា (signed command prefix) សម្រាប់ការស្ដារដោយស្វ័យប្រវត្តិ។ បុព្វបទដែលបានអនុម័តក៏ត្រូវបានភ្ជាប់ទៅនឹងថតធ្វើការ និងតម្លៃបរិស្ថានពិតប្រាកដផងដែរ នៅពេលដែលមាន។ ត្រួតពិនិត្យ ឬកែសម្រួលការអនុម័តនៅក្នុង **Settings > Terminal > Resume Commands**។ bmux ដំណើរការដោយស្វ័យប្រវត្តិតែការភ្ជាប់ resume ដែលវាសម្គាល់ថាគួរឱ្យទុកចិត្តប៉ុណ្ណោះ ដូចជាការភ្ជាប់ tmux ដែលត្រូវបានរកឃើញពីដំណើរការផ្ទាល់ ឬបុព្វបទដែលអ្នកប្រើបានអនុម័ត។ កូនសោបរិស្ថានរសើបដូចជា tokens, passwords, secrets និង API keys ត្រូវបានលុបចេញមុនពេលការភ្ជាប់ resume ត្រូវបានរក្សាទុក។

ដើម្បីរក្សា terminal របស់ agent ដែលបានស្ដារ ឱ្យនៅទំនេរ ជំនួសឱ្យការដំណើរការពាក្យបញ្ជា resume របស់ពួកវាដោយស្វ័យប្រវត្តិ សូមបិទ **Settings > Terminal > Resume Agent Sessions on Reopen** ឬកំណត់វានៅក្នុង `~/.config/bmux/bmux.json`៖
...
វាបិទតែពាក្យបញ្ជា resume របស់ agent ដោយស្វ័យប្រវត្តិប៉ុណ្ណោះ។ bmux នៅតែស្ដារប្លង់ដែលបានរក្សាទុក ថតធ្វើការ scrollback និងប្រវត្តិ browser ឡើងវិញ។
...
នៅពីក្រោយឆាក bmux សរសេរ snapshot ដែលមានកំណែ នៅក្រោម `~/Library/Application Support/bmux/` ហើយ agent hooks សរសេរ session mappings នៅក្រោម `~/.bmuxterm/`។ នៅពេលស្ដារ bmux កសាងប្លង់ឡើងវិញជាមុនសិន បន្ទាប់មកដំណើរការពាក្យបញ្ជា resume ដើមកំណើតរបស់ agent ដែលត្រូវបានគាំទ្រ នៅពេលដែលការ resume agent ដោយស្វ័យប្រវត្តិត្រូវបានបើក។

អានការណែនាំពេញលេញនៅ <https://bmux.com/docs/session-restore>។

## សំណួរ​ដែល​សួរ​ញឹកញាប់

### តើ bmux ទាក់ទង​នឹង Ghostty យ៉ាង​ដូចម្ដេច?

bmux មិន​មែន​ជា fork របស់ Ghostty ទេ។ វា​ប្រើ [libghostty](https://github.com/ghostty-org/ghostty) ជា library សម្រាប់​ការ​បង្ហាញ​ terminal ដូចគ្នា​នឹង​របៀប​ដែល​កម្មវិធី​ផ្សេងៗ​ប្រើ WebKit សម្រាប់ web views។ Ghostty គឺ​ជា terminal ឯករាជ្យ​មួយ ឯ bmux គឺ​ជា​កម្មវិធី​ផ្សេង​មួយ​ដែល​សាងសង់​នៅ​លើ engine បង្ហាញ​របស់​វា។

### តើ​វា​គាំទ្រ platform អ្វីខ្លះ?

បច្ចុប្បន្ន​មាន​តែ macOS ប៉ុណ្ណោះ។ bmux គឺ​ជា​កម្មវិធី native Swift + AppKit។

### តើ​មាន​កម្មវិធី iOS ដែរ​ឬ​ទេ?

មាន ប៉ុន្តែ​នៅ​ក្នុង​ដំណាក់​កាល beta។ ផ្គូផ្គង iPhone របស់​អ្នក​ជាមួយ Mac របស់​អ្នក​ពី​បង្អួច Mobile Connect រួច​ភ្ជាប់​ទៅ terminals របស់​អ្នក​ពី​ទូរស័ព្ទ​របស់​អ្នក ដោយ​មាន​ជម្រើស​បញ្ជូន​បន្ត​ការ​ជូន​ដំណឹង​របស់ terminal។ វា​ត្រូវ​បាន​ផ្ដល់​ជូន​នៅ​លើ TestFlight ជា bmux BETA។ សូម​មើល [ឯកសារ iOS](https://bmux.com/docs/ios)។

### តើ bmux ដំណើរ​ការ​ជាមួយ coding agents អ្វីខ្លះ?

ទាំងអស់។ bmux គឺ​ជា terminal ដូច្នេះ agent ណាមួយ​ដែល​ដំណើរ​ការ​នៅ​ក្នុង terminal ដំណើរ​ការ​បាន​ភ្លាមៗ៖ Claude Code, Codex, OpenCode, Gemini CLI, Kiro, Aider, Goose, Amp, Cline, Cursor Agent និង​អ្វី​ផ្សេង​ទៀត​ដែល​អ្នក​អាច​ចាប់​ផ្ដើម​ពី command line។

### តើ bmux អាច​រៀបចំ agents និង subagents ច្រើន​បាន​ឬ​ទេ?

បាន។ នៅ​ពេល​ដែល agent មួយ​បង្កើត subagents ឬ​សមាជិក​ក្រុម bmux បំប្លែង​ពួក​វា​ទៅ​ជា native panes និង splits ជំនួស​ឱ្យ​ដំណើរ​ការ​ផ្ទៃ​ខាង​ក្រោយ​ដែល​លាក់​បាំង។ វា​គាំទ្រ [Claude Code teams](https://bmux.com/docs/agent-integrations/claude-code-teams) និង​ការ​រៀបចំ​ multi-model របស់ [oh-my-opencode](https://bmux.com/docs/agent-integrations/oh-my-opencode) ដូច្នេះ agent ទាំងអស់​នៅ​ក្នុង​ការ​ដំណើរ​ការ​មួយ​អាច​មើល​ឃើញ​និង​គ្រប់​គ្រង​បាន។

### តើ​ខ្ញុំ​អាច​ប្រើ bmux ជាមួយ​ម៉ាស៊ីន​ពី​ចម្ងាយ​បាន​ឬ​ទេ?

បាន។ បើក workspaces តាម​រយៈ SSH ហើយ​ភ្ជាប់​ទៅ​សម័យ tmux ពី​ចម្ងាយ ដូច្នេះ agents អាច​ដំណើរ​ការ​នៅ​លើ​ម៉ាស៊ីន​ពី​ចម្ងាយ​ខណៈ​ដែល​អ្នក​បញ្ជា​ពួក​វា​ពី bmux។ សូម​មើល [SSH និង​ពី​ចម្ងាយ](https://bmux.com/docs/ssh)។

### តើ​ការ​ជូន​ដំណឹង​ដំណើរ​ការ​យ៉ាង​ដូចម្ដេច?

នៅ​ពេល​ដែល​ដំណើរ​ការ​មួយ​ត្រូវ​ការ​ការ​យក​ចិត្ត​ទុក​ដាក់ bmux បង្ហាញ​រង្វង់​ជូន​ដំណឹង​ជុំ​វិញ panes ស្លាក​មិន​ទាន់​អាន​នៅ​ក្នុង sidebar popover ជូន​ដំណឹង និង​ការ​ជូន​ដំណឹង desktop macOS។ ការ​ទាំង​នេះ​បញ្ចេញ​ដោយ​ស្វ័យ​ប្រវត្តិ​តាម​រយៈ escape sequences ស្ដង់ដារ​របស់ terminal (OSC 9/99/777) ឬ​អ្នក​អាច​ធ្វើ​ឱ្យ​ពួក​វា​ដំណើរ​ការ​ជាមួយ [bmux CLI](https://bmux.com/docs/notifications#cli-usage) និង [agent hooks](https://bmux.com/docs/notifications#integration-examples)។ agent ណាមួយ​ដែល​គាំទ្រ hooks ឬ OSC ដំណើរ​ការ​បាន រួម​ទាំង Claude Code, Codex, OpenCode និង pi។

### តើ bmux អាច​សរសេរ​កម្មវិធី​បាន​ឬ​ទេ?

បាន។ រាល់​សកម្មភាព​ទាំងអស់​មាន​តាម​រយៈ bmux CLI និង Unix socket មួយ៖ បង្កើត workspaces បើក split panes ផ្ញើ input អាន​មាតិកា​អេក្រង់ ថត​រូប​អេក្រង់ និង​បញ្ជា​ browser ក្នុង​កម្មវិធី។ សូម​មើល [ឯកសារ​យោង CLI](https://bmux.com/docs/api) និង​ឯកសារ [browser automation](https://bmux.com/docs/browser-automation)។

### តើ browser ដែល​មាន​ស្រាប់​អាច​ធ្វើ​អ្វី​បាន​ខ្លះ?

bmux អាច​ បំបែក​ browser pane ពិត​ប្រាកដ​មួយ​នៅ​ជាប់​នឹង terminal របស់​អ្នក ហើយ​វា​អាច​សរសេរ​កម្មវិធី​បាន​ពេញលេញ៖ រុករក ថត snapshot នៃ DOM ចុច វាយ​អក្សរ វាយ​តម្លៃ JavaScript និង​អាន console និង​សកម្មភាព network តាម​រយៈ socket API ដូចគ្នា។ agents ប្រើ​វា​ដើម្បី​ផ្ទៀង​ផ្ទាត់​ការ​ផ្លាស់​ប្ដូរ web ផ្ទាល់​ខ្លួន​របស់​ពួក​វា​ដោយ​មិន​ចាំ​បាច់​ចេញ​ពី bmux។ សូម​មើល [browser automation](https://bmux.com/docs/browser-automation)។

### តើ bmux មាន skills ឬ​ទេ?

មាន។ Skills គឺ​ជា workflows ដែល​អាច​ប្រើ​ឡើង​វិញ​ដែល​អ្នក​អាច​ផ្ដល់​ឱ្យ agent ណាមួយ​ដែល​ដំណើរ​ការ​នៅ​ក្នុង bmux សម្រាប់​ការងារ​ដូច​ជា​ការ​បញ្ជា CLI ការ​ស្វ័យ​ប្រវត្តិ​កម្ម workspace ការ​កំណត់ និង browser surfaces។ រុករក​ការ​ប្រមូល​ផ្ដុំ​ដែល​បើក​ចំហ​នៅ [bmux-skills](https://github.com/manaflow-ai/bmux-skills) ឬ​អាន [ឯកសារ skills](https://bmux.com/docs/skills)។

### តើ​ខ្ញុំ​អាច​កែ​សម្រួល keyboard shortcuts បាន​ឬ​ទេ?

keybindings របស់ terminal ត្រូវ​បាន​អាន​ពី​ឯកសារ config របស់ Ghostty (`~/.config/ghostty/config`)។ shortcuts ជាក់​លាក់​របស់ bmux (workspaces, splits, browser, notifications) អាច​កែ​សម្រួល​បាន​នៅ​ក្នុង Settings។ សូម​មើល [shortcuts លំនាំ​ដើម](https://bmux.com/docs/keyboard-shortcuts) សម្រាប់​បញ្ជី​ពេញលេញ។

### តើ​ខ្ញុំ​អាច​កែ​សម្រួល bmux បាន​ឬ​ទេ?

បាន។ ការ​បង្ហាញ terminal ប្រើ config របស់ Ghostty របស់​អ្នក ដូច្នេះ themes, fonts, ពណ៌ និង cursor ត្រូវ​បាន​បន្ត​ដោយ​ផ្ទាល់។ ការ​កំណត់​ផ្ទាល់​ខ្លួន​របស់ bmux នៅ​ក្នុង `~/.config/bmux/bmux.json` គ្រប់​គ្រង sidebar, tab bar, split panes និង​ឥរិយាបថ ហើយ​រាល់ [keyboard shortcut](https://bmux.com/docs/keyboard-shortcuts) អាច​កែ​សម្រួល​បាន។ សូម​មើល [configuration](https://bmux.com/docs/configuration)។

### តើ​សម័យ​របស់​ខ្ញុំ​ត្រូវ​បាន​រក្សា​ទុក​ឬ​ទេ?

រក្សា​ទុក។ bmux ស្ដារ បង្អួច workspaces panes ថត​ការងារ និង scrollback របស់​អ្នក​នៅ​ពេល​អ្នក​បើក​ឡើង​វិញ ហើយ​ស្ថានភាព​នៅ​រស់​រាន​បន្ទាប់​ពី​ការ​បើក​កុំព្យូទ័រ​ឡើង​វិញ​ពេញលេញ មិន​មែន​គ្រាន់​តែ​ការ​បិទ​កម្មវិធី​ប៉ុណ្ណោះ​ទេ។ សម័យ agent ដូច​ជា Claude Code, Codex និង OpenCode ត្រឡប់​មក​វិញ​ផង​ដែរ។ សូម​មើល [session restore](https://bmux.com/docs/session-restore)។

### តើ​វា​ប្រៀប​ធៀប​នឹង tmux យ៉ាង​ដូចម្ដេច?

tmux គឺ​ជា terminal multiplexer ដែល​ដំណើរ​ការ​នៅ​ក្នុង terminal ណាមួយ។ bmux គឺ​ជា​កម្មវិធី native macOS ដែល​មាន GUI៖ vertical tabs, split panes, browser ដែល​បង្កប់ និង socket API ទាំងអស់​មាន​ស្រាប់ ដោយ​មិន​ចាំ​បាច់​មាន​ឯកសារ config ឬ prefix keys។ ទោះ​ជា​យ៉ាង​ណា​ក៏​ដោយ មនុស្ស​ជា​ច្រើន​ដំណើរ​ការ bmux ជាមួយ SSH និង tmux រួម​គ្នា​ដោយ​សប្បាយ​រីករាយ ហើយ bmux អាច​ភ្ជាប់​ទៅ​សម័យ tmux ពី​ចម្ងាយ​របស់​អ្នក​ដោយ native ([beta](https://bmux.com/docs/remote-tmux))។

### តើ bmux ឥត​គិត​ថ្លៃ​ឬ​ទេ?

មែន bmux ឥត​គិត​ថ្លៃ​ក្នុង​ការ​ប្រើ​ប្រាស់។ កូដ​ប្រភព​មាន​នៅ​លើ [GitHub](https://github.com/manaflow-ai/bmux)។

### តើ​ខ្ញុំ​អាច​គាំទ្រ bmux យ៉ាង​ដូចម្ដេច?

bmux ឥត​គិត​ថ្លៃ​និង open source ហើយ​នឹង​នៅ​តែ​បែប​នេះ​ជានិច្ច។ ប្រសិន​បើ​អ្នក​ចង់​គាំទ្រ​ការ​អភិវឌ្ឍ​និង​ទទួល​បាន​ការ​ចូល​ដំណើរ​ការ​មុន​គេ​ចំពោះ​អ្វី​ដែល​នឹង​មក​ដល់ រួម​ទាំង bmux AI, កម្មវិធី iOS និង Cloud VMs សូម​មើល [bmux Founders Edition](https://github.com/manaflow-ai/bmux#founders-edition)។

### ខ្ញុំ​មាន​សំណើ​មុខងារ ឬ​រក​ឃើញ​កំហុស?

យើង​ចង់​ស្ដាប់​វា។ បើក [issue](https://github.com/manaflow-ai/bmux/issues) ឬ [pull request](https://github.com/manaflow-ai/bmux/pulls) នៅ​លើ GitHub ឬ [អ៊ីមែល​មក​យើង](mailto:founders@manaflow.com?subject=bmux%20feature%20request)។
...
- បង្កើត និងចូលរួមនៅក្នុង [GitHub issues](https://github.com/manaflow-ai/bmux/issues) និង [discussions](https://github.com/manaflow-ai/bmux/discussions)
- ប្រាប់ពួកយើងពីអ្វីដែលអ្នកកំពុងបង្កើតជាមួយ bmux
...
<p>
  ...
  <img src="./docs/assets/wechat-community-qr.jpg" alt="កូដ QR WeChat សម្រាប់ចូលរួមសហគមន៍ bmux" width="240" />
</p>

## Founder's Edition

bmux គឺឥតគិតថ្លៃ បើកប្រភពកូដ និងនឹងនៅតែជានិច្ច។ ប្រសិនបើអ្នកចង់គាំទ្រការអភិវឌ្ឍន៍ និងទទួលបានសិទ្ធិចូលប្រើមុនគេចំពោះអ្វីដែលនឹងមកដល់បន្ទាប់៖

**[Get Founder's Edition](https://buy.stripe.com/3cI00j2Ld0it5OU33r5EY0q)**

- **សំណើមុខងារ/ការជួសជុលកំហុសដែលត្រូវផ្តល់អាទិភាព**
- **សិទ្ធិចូលប្រើមុនគេ៖ bmux AI ដែលផ្តល់ឱ្យអ្នកនូវបរិបទនៅលើគ្រប់ workspace, tab និង panel**
...
bmux គឺបើកប្រភពកូដក្រោម [GPL-3.0-or-later](LICENSE)។
