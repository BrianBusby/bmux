...
struct VerticalTabsSidebar: View {
    ...
    private func extensionSidebarSnapshot(workspaces: [Workspace]) -> BmuxSidebarProviderSnapshot {
        BmuxSidebarProviderSnapshot(
...
struct TabItemView: View, Equatable {
    ...
    private func makeWorkspaceSnapshot() -> SidebarWorkspaceSnapshotBuilder.Snapshot {
        ...
        return SidebarWorkspaceSnapshotBuilder.Snapshot(
            ...
            metadataBlocks: detailVisibility.showsMetadata ? SidebarWorkspaceSnapshotBuilder.metadataBlocks(
