...
/// leaving the Mac running for the bmux iOS app — and covers every screen with
/// the animated scene.
///
...
final class SleepyModeController {
    ...
    // bmux pattern for such controllers (TerminalController.shared,
    ...
    private func makeOverlayWindow(for screen: NSScreen) -> SleepyOverlayWindow {
        ...
        window.identifier = NSUserInterfaceItemIdentifier("bmux.sleepyMode")
    ...
    private func beginPowerAssertions() {
        let reason = "bmux Sleepy Mode" as CFString
