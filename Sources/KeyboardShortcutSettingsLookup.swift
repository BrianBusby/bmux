...
extension KeyboardShortcutSettings {
    ...
    /// override from bmux.json if present, otherwise the action's built-in
    ...
    static func settingsFileManagedSubtitle(for action: Action) -> String? {
        ...
        return String(localized: "settings.shortcuts.managedByFile", defaultValue: "Managed in bmux.json")
    }
