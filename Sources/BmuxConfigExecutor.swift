...
struct BmuxConfigExecutor {
    ...
    static func prepareShellInputIfAuthorized(
        ...
        confirm: Bool,
        actionID: String,
        target: BmuxConfigTerminalCommandTarget,
        configSourcePath: String?,
        globalConfigPath: String,
        displayTitle: String? = nil,
        icon: BmuxButtonIcon? = nil,
    ...
    private static func authorizeProjectActionIfNeeded(
        ...
        let isTrusted = BmuxActionTrust.shared.isTrusted(descriptor)
    ...
    private static func makeConfirmDialog(
        ...
        alert.messageText = (trimmedDisplayTitle?.isEmpty == false)
            ? trimmedDisplayTitle!
            : String(
                localized: "dialog.bmuxConfig.confirmCommand.title",
                defaultValue: "Run Project Action?"
            )
        let messageFormat = String(
            localized: "dialog.bmuxConfig.confirmCommand.messageWithCommand",
        ...
        alert.addButton(withTitle: String(
            localized: "dialog.bmuxConfig.confirmCommand.run",
            defaultValue: "Run Once"
        ))
        alert.addButton(withTitle: String(
            localized: "dialog.bmuxConfig.confirmCommand.trustAndRun",
            defaultValue: "Trust and Run"
        ))
        alert.addButton(withTitle: String(
            localized: "dialog.bmuxConfig.confirmCommand.cancel",
            defaultValue: "Cancel"
        ))
        return alert
    }
    ...
    private static func handleConfirmDialogResponse(
        ...
        case .alertSecondButtonReturn:
            BmuxActionTrust.shared.trust(descriptor)
            return true
        default:
            return false
        }
    ...
    private static func terminalTrustDescriptor(
        ...
        BmuxActionTrustDescriptor(
            ...
            projectRoot: configSourcePath.map { canonicalPath(BmuxButtonIcon.projectRoot(forConfigPath: $0)) },
    ...
    static func isTrustedSurfaceButton(
        ...
        workspaceCommand: BmuxResolvedCommand?,
        ...
        return BmuxActionTrust.shared.isTrusted(descriptor)
    }
