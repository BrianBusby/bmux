...
struct BmuxTopProcessArguments: Sendable {
    let arguments: [String]
    let environment: [String: String]
}

extension BmuxTopProcessSnapshot {
    static func processArgumentsAndEnvironment(for pid: Int) -> BmuxTopProcessArguments? {
    ...
    static func processArgumentsAndEnvironment(fromKernProcArgs bytes: [UInt8]) -> BmuxTopProcessArguments? {
