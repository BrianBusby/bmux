...
/// Classifies a terminal scroll event for bmux's historical precise-delta boost.
struct GhosttyTerminalScrollBoost {
    ...
    /// Creates a boost classifier from the AppKit scroll attributes bmux uses.
    init(
    ...
    /// Whether the event should receive bmux's historical 2x precise-delta boost.
