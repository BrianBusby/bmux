...
struct BmuxConfigUIDefinition: Codable, Sendable, Hashable {
    var newWorkspace: BmuxConfigButtonPlacement?
    var surfaceTabBar: BmuxSurfaceTabBarUIDefinition?
}

struct BmuxSurfaceTabBarUIDefinition: Codable, Sendable, Hashable {
    var buttons: [BmuxSurfaceTabBarButton]?
}

struct BmuxConfigButtonPlacement: Codable, Sendable, Hashable {
    var action: String?
    var icon: BmuxButtonIcon?
    var tooltip: String?
    var contextMenu: [BmuxConfigContextMenuItem]?
    var menuSectionOrder: BmuxNewWorkspaceMenuSectionOrder?
    ...
    init(
        ...
        tooltip: String? = nil,
        contextMenu: [BmuxConfigContextMenuItem]? = nil,
        menuSectionOrder: BmuxNewWorkspaceMenuSectionOrder? = nil
    ) {
        self.action = action
        self.icon = icon
    ...
    init(from decoder: Decoder) throws {
        ...
        icon = try container.decodeIfPresent(BmuxButtonIcon.self, forKey: .icon)
        tooltip = try Self.trimmedString(forKey: .tooltip, in: container, allowBlankAsNil: true)
        contextMenu = try container.decodeIfPresent([BmuxConfigContextMenuItem].self, forKey: .contextMenu)
            ?? container.decodeIfPresent([BmuxConfigContextMenuItem].self, forKey: .rightClick)
        menuSectionOrder = try container.decodeIfPresent(BmuxNewWorkspaceMenuSectionOrder.self, forKey: .menuSectionOrder)
            ?? container.decodeIfPresent(BmuxNewWorkspaceMenuSectionOrder.self, forKey: .sectionOrder)
    }
...
enum BmuxNewWorkspaceMenuSectionOrder: String, Codable, Sendable, Hashable {
    case customFirst
    case cloudFirst
...
struct BmuxConfigContextMenuActionItem: Codable, Sendable, Hashable {
    var action: String
    var title: String?
    var icon: BmuxButtonIcon?
    var tooltip: String?
    ...
    init(action: String, title: String? = nil, icon: BmuxButtonIcon? = nil, tooltip: String? = nil) {
        self.action = action
        self.title = title
        self.icon = icon
        self.tooltip = tooltip
...
enum BmuxConfigContextMenuItem: Codable, Sendable, Hashable {
    case action(BmuxConfigContextMenuActionItem)
    case separator
    ...
    init(from decoder: Decoder) throws {
        if let container = try? decoder.singleValueContainer(),
           let rawAction = try? container.decode(String.self) {
            ...
            self = .action(BmuxConfigContextMenuActionItem(action: trimmed))
            return
        }
        ...
        self = .action(try BmuxConfigContextMenuActionItem(from: decoder))
    }
...
struct BmuxResolvedConfigMenuAction: Identifiable, Sendable, Hashable {
    var id: String
    var title: String
    var icon: BmuxButtonIcon?
    var iconSourcePath: String?
    var tooltip: String?
    var action: BmuxResolvedConfigAction
}

enum BmuxResolvedConfigContextMenuItem: Identifiable, Sendable, Hashable {
    case action(BmuxResolvedConfigMenuAction)
...
enum BmuxRestartBehavior: String, Codable, Sendable {
    case new
    case recreate
    case ignore
    case confirm
