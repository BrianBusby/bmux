...
enum RemoteLoopbackRuntimeBridge {
    static let runtimeBridgeScriptSource: String = {
        ...
        (() => {
          ...
          if (window.__bmuxRemoteLoopbackRuntimeBridgeInstalled) return true;
          window.__bmuxRemoteLoopbackRuntimeBridgeInstalled = true;
          ...
          Object.defineProperty(window, '__bmuxRewriteRemoteLoopbackURL', {
          ...
          if (typeof NativeWebSocket === 'function') {
            const BmuxWebSocket = function(url, protocols) {
            ...
            BmuxWebSocket.prototype = NativeWebSocket.prototype;
            Object.setPrototypeOf(BmuxWebSocket, NativeWebSocket);
            window.WebSocket = BmuxWebSocket;
          }

          const NativeEventSource = window.EventSource;
          if (typeof NativeEventSource === 'function') {
            const BmuxEventSource = function(url, eventSourceInitDict) {
              const rewrittenURL = rewriteLoopbackURL(url);
            ...
            BmuxEventSource.prototype = NativeEventSource.prototype;
            Object.setPrototypeOf(BmuxEventSource, NativeEventSource);
            window.EventSource = BmuxEventSource;
          }
