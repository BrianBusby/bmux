...
/// Pure resolution logic for `bmux://workspace/...` navigation deep links.
///
...
struct BmuxNavigationTargetResolver {
    typealias SurfaceDescriptor = BmuxNavigationSurfaceDescriptor
    typealias WorkspaceDescriptor = BmuxNavigationWorkspaceDescriptor
    typealias Resolution = BmuxNavigationResolution
    ...
    func resolve(_ target: BmuxNavigationURLRequest.Target) -> Resolution? {
        switch target {
