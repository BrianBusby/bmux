...
struct SidebarWorkspaceWorkingIndicator: View {
    var size: CGFloat = 44
    ...
    private var motion: SidebarWorkspaceWorkingIndicatorMotion {
        SidebarWorkspaceWorkingIndicatorMotion(contactSeparationTurns: contactSeparationTurns)
    }
