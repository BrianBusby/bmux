...
actor SearchIndex {
    ...
    nonisolated static func open(databaseURL: URL = .bmuxSearchDatabaseURL) async throws -> SearchIndex {
    ...
    init(databaseURL: URL = .bmuxSearchDatabaseURL) throws {
...
extension URL {
    static var bmuxSearchDatabaseURL: URL {
