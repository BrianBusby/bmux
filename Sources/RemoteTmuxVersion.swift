...
/// confirmation), and the `@bmux_agent` / `@bmux_git` status channels. `-B`
...
/// bmux asserts the version up front and surfaces a clear error.
struct RemoteTmuxVersion: Equatable, Comparable, Sendable {
    ...
    /// The minimum version `bmux ssh-tmux` supports.
