...
enum SleepyArt {
    /// Shared face anchors for the grid mascots (bmux/cat/ghost).
    ...
    /// Detailed beveled right-pointing bmux chevron (11x15): highlight (H) on the
    /// leading edge, main (C) body, shadow (c) trailing edge. Doubles as the left
    /// eye of the logoFace mascot.
    static let bmuxLogo: [String] = [
        "HCCc.......",
        ".HCCc......",
        "..HCCc.....",
        "...HCCc....",
