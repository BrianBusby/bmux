...
struct BmuxConfigActionDefinition: Codable, Sendable, Hashable {
    ...
    init(
        action: BmuxSurfaceTabBarButtonAction? = nil,
        title: String? = nil,
        subtitle: String? = nil,
        keywords: [String]? = nil,
        palette: Bool? = nil,
    ...
    init(from decoder: Decoder) throws {
        ...
        case "builtin":
            ...
            guard let builtIn = BmuxSurfaceTabBarBuiltInAction(configID: raw) else {
        ...
        case "agent":
            let agent = try container.decode(BmuxConfigAgentKind.self, forKey: .agent)
