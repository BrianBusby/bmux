...
extension BrowserHistoryStore {
    static func uiTestSeedEntriesIfConfigured() -> [Entry]? {
        ...
        guard env["BMUX_UI_TEST_MODE"] == "1",
              let rawSeed = env["BMUX_UI_TEST_BROWSER_HISTORY_JSON"],
...
extension Notification.Name {
    static let commandPaletteVisibilityDidChange = Notification.Name("bmux.commandPaletteVisibilityDidChange")
}
