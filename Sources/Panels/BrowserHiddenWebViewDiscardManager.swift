...
final class BrowserHiddenWebViewDiscardManager {
    ...
    /// (https://github.com/manaflow-ai/bmux/issues/5261).
    ...
    func noteSystemWillSleep() {
        ...
        if hadScheduledDiscard {
            bmuxDebugLog("browser.discard.sleep canceledArmedTimer=1")
        }
#endif
    }
...
#if DEBUG
        bmuxDebugLog("browser.discard.wake rearmed=\(hasScheduledDiscard ? 1 : 0)")
#endif
    }
