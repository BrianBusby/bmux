...
/// Context-menu link resolution for `BmuxWebView`.
///
...
extension BmuxWebView {
    ...
    /// stored property lives in `BmuxWebView.swift` because extensions cannot
    ...
    private static let contextMenuLinkCaptureMessageHandlerName = "bmuxContextMenuLinkCapture"
...
private final class ContextMenuLinkCaptureMessageHandler: NSObject, WKScriptMessageHandler {
    func userContentController(
        ...
        guard let webView = message.webView as? BmuxWebView else { return }
