    ...
    var body: some View {
        if panel.renderedPDFDocumentURL != nil {
            Button(action: {
                ...
                BmuxSystemSymbolImage(systemName: "square.and.arrow.down", pointSize: iconPointSize, weight: .medium)
            ...
            Button(action: {
                ...
                BmuxSystemSymbolImage(systemName: "printer", pointSize: iconPointSize, weight: .medium)
                    .frame(width: hitSize, height: hitSize, alignment: .center)
                    .contentShape(Rectangle())
            }
            .buttonStyle(OmnibarAddressButtonStyle())
