...
final class TerminalPanel: Panel, ObservableObject {
    ...
    @Published var promptNavigationHasBookmarks = false
    @Published var promptNavigationCanMoveBackward = false
    @Published var promptNavigationCanMoveForward = false
    @Published var promptNavigationTextBoxPulseSeed: UInt64 = 0
    var promptNavigationBookmarks: [PromptNavigationBookmark] = []
    var promptNavigationSelectedIndex: Int?
    let maxPromptNavigationBookmarks = 200
