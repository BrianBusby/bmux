...
private struct PDFPreviewChromeDebugSample: View {
    ...
    var body: some View {
        FilePreviewPDFZoomChromeView(
            ...
            fileURL: URL(fileURLWithPath: "/tmp/bmux-pdf-chrome-debug.pdf"),
...
final class PDFPreviewChromeDebugWindowController: ReleasingWindowController {
    ...
    private static let zoomOutItemID = NSToolbarItem.Identifier("bmux.pdfPreviewChromeDebug.zoomOut")
    private static let actualSizeItemID = NSToolbarItem.Identifier("bmux.pdfPreviewChromeDebug.actualSize")
    private static let zoomInItemID = NSToolbarItem.Identifier("bmux.pdfPreviewChromeDebug.zoomIn")
    private static let zoomToFitItemID = NSToolbarItem.Identifier("bmux.pdfPreviewChromeDebug.zoomToFit")
    private static let rotateLeftItemID = NSToolbarItem.Identifier("bmux.pdfPreviewChromeDebug.rotateLeft")
    private static let rotateRightItemID = NSToolbarItem.Identifier("bmux.pdfPreviewChromeDebug.rotateRight")
    ...
    override func makeWindow() -> NSWindow {
        ...
        window.identifier = NSUserInterfaceItemIdentifier("bmux.pdfPreviewChromeDebug")
        window.center()
    ...
    private func installToolbar(on window: NSWindow) {
        let toolbar = NSToolbar(identifier: NSToolbar.Identifier("bmux.pdfPreviewChromeDebug.toolbar"))
