...
final class BonsplitTabBarDebugWindowController: ReleasingWindowController {
    ...
    override func makeWindow() -> NSWindow {
        ...
        window.identifier = NSUserInterfaceItemIdentifier("bmux.bonsplitTabBarDebug")
        window.center()
        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            HStack(spacing: 10) {
                ...
                Button(String(localized: "debug.bonsplitTabBarDebug.copyConfig", defaultValue: "Copy Config")) {
                    ...
                    bmuxDebugLog("bonsplit.tabbarDebug.copyConfig \(BonsplitTabBarDebugSettings.currentTuningDescription())")
                }
            }
