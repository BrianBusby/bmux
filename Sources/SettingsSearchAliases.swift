...
enum SettingsSearchAliasIndex {
    static func sectionAliases(for target: SettingsNavigationTarget) -> String {
        ...
        case .browser:
            return localized("settings.search.alias.section.browser", defaultValue: "web webview address bar omnibar links urls embedded chrome browser")
        case .browserImport:
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:supported-file-previews": localized("settings.search.alias.setting.app.supported-file-previews", defaultValue: "app.openSupportedFilesInBmux cmd click file preview pdf image video audio quicklook quick look editor external"),
        ...
        "app:markdown-viewer": localized("settings.search.alias.setting.app.markdown-viewer", defaultValue: "app.openMarkdownInBmuxViewer md markdown mdx viewer preview readme"),
        ...
        "sidebarAppearance:open-pr-links": localized("settings.search.alias.setting.app.open-pr-links", defaultValue: "sidebar.openPullRequestLinksInBmuxBrowser pr links github browser default external embedded"),
        "sidebarAppearance:open-port-links": localized("settings.search.alias.setting.app.open-port-links", defaultValue: "sidebar.openPortLinksInBmuxBrowser ports localhost links browser default external embedded"),
        ...
        "automation:port-base": localized("settings.search.alias.setting.automation.port-base", defaultValue: "automation.portBase bmux_port start first base env environment variable"),
        "automation:port-range": localized("settings.search.alias.setting.automation.port-range", defaultValue: "automation.portRange bmux_port_end range size count env ports"),
        ...
        "browser:terminal-links": localized("settings.search.alias.setting.browser.terminal-links", defaultValue: "browser.openTerminalLinksInBmuxBrowser click url terminal links open in browser href"),
        "browser:intercept-open": localized("settings.search.alias.setting.browser.intercept-open", defaultValue: "browser.interceptTerminalOpenCommandInBmuxBrowser open command http https url terminal intercept"),
        ...
        "browser:external-patterns": localized("settings.search.alias.setting.browser.external-patterns", defaultValue: "browser.urlsToAlwaysOpenExternally denylist blocklist regex rules external chrome browser"),
        ...
        "keyboardShortcuts:shortcut-chords": localized("settings.search.alias.setting.keyboardShortcuts.shortcut-chords", defaultValue: "tmux prefix ctrl-b control-b multi key sequence chord bmux json"),
        ...
        "keyboardShortcuts:shortcuts": localized("settings.search.alias.setting.keyboardShortcuts.shortcuts", defaultValue: "hotkeys keybindings key bindings commands keyboard accelerators shortcuts bmux json"),
        ...
        "settingsJSON:open-file": localized("settings.search.alias.setting.settingsJSON.open-file", defaultValue: "open config file json jsonc config editor ~/.config bmux preferences"),
        "settingsJSON:documentation": localized("settings.search.alias.setting.settingsJSON.documentation", defaultValue: "docs documentation schema reference bmux json keys configuration"),
