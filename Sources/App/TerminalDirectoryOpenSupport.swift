...
final class VSCodeServeWebController {
    ...
    private let queue = DispatchQueue(label: "bmux.vscode.serveWeb")
    private let launchQueue = DispatchQueue(label: "bmux.vscode.serveWeb.launch")
    ...
    private static func makeConnectionTokenFile() -> URL? {
        ...
        let tokenFileName = "bmux-vscode-token-\(UUID().uuidString)"
