...
enum BmuxHelpResource {
    ...
    var url: URL {
        switch self {
        case .gettingStarted:
            return URL(string: "https://bmux.com/docs/getting-started")!
        case .concepts:
            return URL(string: "https://bmux.com/docs/concepts")!
        case .configuration:
            return URL(string: "https://bmux.com/docs/configuration")!
        case .customCommands:
            return URL(string: "https://bmux.com/docs/custom-commands")!
        case .dock:
            return URL(string: "https://bmux.com/docs/dock")!
        case .keyboardShortcuts:
            return URL(string: "https://bmux.com/docs/keyboard-shortcuts")!
        case .apiReference:
            return URL(string: "https://bmux.com/docs/api")!
        case .browserAutomation:
            return URL(string: "https://bmux.com/docs/browser-automation")!
        case .notifications:
            return URL(string: "https://bmux.com/docs/notifications")!
        case .ssh:
            return URL(string: "https://bmux.com/docs/ssh")!
        case .skills:
            return URL(string: "https://bmux.com/docs/skills")!
        case .claudeCodeTeams:
            return URL(string: "https://bmux.com/docs/agent-integrations/claude-code-teams")!
        case .ohMyOpenCode:
            return URL(string: "https://bmux.com/docs/agent-integrations/oh-my-opencode")!
        case .ohMyCodex:
            return URL(string: "https://bmux.com/docs/agent-integrations/oh-my-codex")!
        case .ohMyClaudeCode:
            return URL(string: "https://bmux.com/docs/agent-integrations/oh-my-claudecode")!
        case .changelog:
            return URL(string: "https://bmux.com/docs/changelog")!
        case .githubIssues:
            return URL(string: "https://github.com/manaflow-ai/bmux/issues")!
        case .discord:
