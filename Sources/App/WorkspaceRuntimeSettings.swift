...
enum TerminalScrollBarSettings {
    ...
    static let didChangeNotification = Notification.Name("bmux.terminalScrollBarSettingsDidChange")
...
enum TerminalCopyOnSelectSettings {
    ...
    static let didChangeNotification = Notification.Name("bmux.terminalCopyOnSelectSettingsDidChange")
...
enum AgentSessionAutoResumeSettings {
    ...
    static let didChangeNotification = Notification.Name("bmux.agentSessionAutoResumeSettingsDidChange")
...
enum AgentHibernationSettings {
    ...
    static let didChangeNotification = Notification.Name("bmux.agentHibernationSettingsDidChange")
...
enum RendererRealizationSettings {
    ...
    static let didChangeNotification = Notification.Name("bmux.rendererRealizationSettingsDidChange")
...
enum UITestLaunchManifest {
    static let argumentName = "-bmuxUITestLaunchManifest"
