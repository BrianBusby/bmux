...
/// the `bmux hooks` CLI maintains, yielding terminal bindings and transcript
...
struct AgentChatHookSessionStore: Sendable {
    ...
    struct Entry: Sendable {
        ...
        /// Owning bmux workspace UUID string.
        let workspaceID: String?
        /// Hosting bmux terminal surface UUID string.
