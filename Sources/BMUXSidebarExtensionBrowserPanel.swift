...
@MainActor
final class BMUXSidebarExtensionBrowserPanel: NSObject, Panel, ObservableObject {
    let id = UUID()
    ...
    init(title: String) {
        self.title = title
        self.browserViewController = BMUXSidebarExtensionBrowserPresenter.makeViewController(title: title)
        super.init()
    }
...
struct BMUXSidebarExtensionBrowserPanelView: NSViewControllerRepresentable {
    let panel: BMUXSidebarExtensionBrowserPanel
    let onRequestPanelFocus: () -> Void

    func makeNSViewController(context: Context) -> NSViewController {
        BMUXSidebarExtensionBrowserContainerViewController(
    ...
    func updateNSViewController(_ nsViewController: NSViewController, context: Context) {
        guard let container = nsViewController as? BMUXSidebarExtensionBrowserContainerViewController else {
            return
        }
    ...
    static func dismantleNSViewController(
        ...
        (nsViewController as? BMUXSidebarExtensionBrowserContainerViewController)?.detachBrowserForTransientReparent()
    }
}

@MainActor
private final class BMUXSidebarExtensionBrowserContainerViewController: NSViewController {
