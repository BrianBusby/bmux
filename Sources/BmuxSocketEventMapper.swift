...
enum BmuxSocketEventMapper {
    ...
    private static func publishV1(command: String, response: String) {
        ...
        case "send", "send_surface":
            BmuxEventBus.shared.publish(name: "surface.input_sent", category: "surface", source: "socket.v1", payload: payload)
        case "send_key", "send_key_surface":
            BmuxEventBus.shared.publish(name: "surface.key_sent", category: "surface", source: "socket.v1", payload: payload)
        case "notify_surface":
            var payloadWithSurface = payload
            let surfaceId = firstUUID(in: args)
            payloadWithSurface["surface_id"] = surfaceId ?? NSNull()
            BmuxEventBus.shared.publish(
        ...
        case "notify", "notify_target", "notify_target_async":
            BmuxEventBus.shared.publish(name: "notification.requested", category: "notification", source: "socket.v1", workspaceId: firstUUID(in: args), payload: payload)
        case "clear_notifications":
            BmuxEventBus.shared.publish(name: "notification.clear_requested", category: "notification", source: "socket.v1", workspaceId: firstUUID(in: args), payload: payload)
        case "set_status", "report_meta", "report_meta_block":
            BmuxEventBus.shared.publish(name: "sidebar.metadata.updated", category: "sidebar", source: "socket.v1", workspaceId: firstUUID(in: args), payload: payload)
        case "clear_status", "clear_meta", "clear_meta_block":
            BmuxEventBus.shared.publish(name: "sidebar.metadata.cleared", category: "sidebar", source: "socket.v1", workspaceId: firstUUID(in: args), payload: payload)
        case "set_progress":
            BmuxEventBus.shared.publish(name: "sidebar.progress.updated", category: "sidebar", source: "socket.v1", workspaceId: firstUUID(in: args), payload: payload)
        case "clear_progress":
            BmuxEventBus.shared.publish(name: "sidebar.progress.cleared", category: "sidebar", source: "socket.v1", workspaceId: firstUUID(in: args), payload: payload)
        case "log":
            BmuxEventBus.shared.publish(name: "sidebar.log.appended", category: "sidebar", source: "socket.v1", workspaceId: firstUUID(in: args), payload: payload)
        case "clear_log":
            BmuxEventBus.shared.publish(name: "sidebar.log.cleared", category: "sidebar", source: "socket.v1", workspaceId: firstUUID(in: args), payload: payload)
        case "reset_sidebar":
            BmuxEventBus.shared.publish(name: "sidebar.reset", category: "sidebar", source: "socket.v1", workspaceId: firstUUID(in: args), payload: payload)
        case "reload_config":
            BmuxEventBus.shared.publish(name: "config.reloaded", category: "config", source: "socket.v1", payload: payload)
        case "set_app_focus":
            BmuxEventBus.shared.publish(name: "app.focus_override.changed", category: "app", source: "socket.v1", payload: payload)
        case "simulate_app_active":
            BmuxEventBus.shared.publish(name: "app.simulated_active", category: "app", source: "socket.v1", payload: payload)
        default:
            break
        }
    }
