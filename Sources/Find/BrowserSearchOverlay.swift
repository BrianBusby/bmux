    ...
    var body: some View {
        GeometryReader { geo in
            HStack(spacing: 4) {
                ...
                Button(action: {
                    #if DEBUG
                    bmuxDebugLog("browser.findbar.next panel=\(panelId.uuidString.prefix(5))")
                    #endif
                    onNext()
                }) {
                ...
                Button(action: {
                    #if DEBUG
                    bmuxDebugLog("browser.findbar.prev panel=\(panelId.uuidString.prefix(5))")
                    #endif
                    onPrevious()
                }) {
                ...
                Button(action: {
                    #if DEBUG
                    bmuxDebugLog("browser.findbar.close panel=\(panelId.uuidString.prefix(5))")
                    #endif
                    onClose()
                }) {
            ...
            .onAppear {
#if DEBUG
                bmuxDebugLog("browser.findbar.appear panel=\(panelId.uuidString.prefix(5))")
#endif
