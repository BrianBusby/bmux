...
private struct WorkspaceResourceHeaderView: View {
...
struct WorkspaceContentView: View {
    ...
    private func openHeaderResource(_ item: SidebarWorkspaceSnapshotBuilder.ResourceLinkPresentation.HeaderItem) {
