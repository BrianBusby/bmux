...
enum SettingsNavigationTarget: String, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .settingsJSON:
            return String(localized: "settings.section.settingsJSON", defaultValue: "bmux.json")
        case .reset:
...
enum SettingsNavigationRequest {
    static let notificationName = Notification.Name("bmux.settings.navigate")
...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.account, "pro", String(localized: "settings.account.pro.title", defaultValue: "bmux Pro"), "pro upgrade subscription billing plan pricing cloud"),
        ...
        setting(.app, "supported-file-previews", String(localized: "settings.app.openSupportedFilesInBmux", defaultValue: "Open Supported Files in bmux"), "cmd click file preview pdf image audio video quick look editor"),
        ...
        setting(.app, "markdown-viewer", String(localized: "settings.app.openMarkdownInBmuxViewer", defaultValue: "Open Markdown in bmux Viewer"), "md markdown viewer"),
        ...
        setting(.sidebarAppearance, "open-pr-links", String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in bmux Browser"), "pull request link browser"),
        setting(.sidebarAppearance, "open-port-links", String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in bmux Browser"), "port link browser"),
        ...
        setting(.automation, "port-base", String(localized: "settings.automation.portBase", defaultValue: "Port Base"), "BMUX_PORT start"),
        setting(.automation, "port-range", String(localized: "settings.automation.portRange", defaultValue: "Port Range Size"), "BMUX_PORT_END workspace ports"),
        ...
        setting(.browser, "enable-browser", String(localized: "settings.browser.enabled", defaultValue: "Enable bmux Browser"), "webview tabs links"),
        ...
        setting(.browser, "terminal-links", String(localized: "settings.browser.openTerminalLinks", defaultValue: "Open Terminal Links in bmux Browser"), "click links browser"),
        ...
        setting(.browser, "external-patterns", String(localized: "settings.browser.externalPatterns", defaultValue: "URLs to Always Open Externally"), "regex url rules chrome external browser"),
        ...
        setting(.settingsJSON, "open-file", String(localized: "settings.settingsJSON.openFile", defaultValue: "Open bmux.json"), "config json file editor dotfiles"),
        setting(.settingsJSON, "documentation", String(localized: "settings.settingsJSON.documentation", defaultValue: "Documentation"), "bmux json schema reference docs"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.openSupportedFilesInBmux": settingID(for: .app, idSuffix: "supported-file-previews"),
        "app.openMarkdownInBmuxViewer": settingID(for: .app, idSuffix: "markdown-viewer"),
        ...
        "sidebar.openPullRequestLinksInBmuxBrowser": settingID(for: .sidebarAppearance, idSuffix: "open-pr-links"),
        "sidebar.openPortLinksInBmuxBrowser": settingID(for: .sidebarAppearance, idSuffix: "open-port-links"),
        ...
        "browser.openTerminalLinksInBmuxBrowser": settingID(for: .browser, idSuffix: "terminal-links"),
        "browser.interceptTerminalOpenCommandInBmuxBrowser": settingID(for: .browser, idSuffix: "intercept-open"),
