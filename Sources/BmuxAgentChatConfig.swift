...
struct BmuxAgentChatConfigDefinition: Codable, Sendable, Hashable {
    var url: String?
...
enum BmuxAgentChatConfigurationSource: Sendable, Hashable {
...
struct BmuxAgentChatConfiguration: Sendable, Hashable {
    static let defaultURLString = "http://127.0.0.1:7739"
    static let `default` = BmuxAgentChatConfiguration(
    ...
    var url: URL
    var startCommand: String?
    var source: BmuxAgentChatConfigurationSource
    ...
    static func resolved(
        local: BmuxAgentChatConfigDefinition?,
        global: BmuxAgentChatConfigDefinition?
    ) -> BmuxAgentChatConfiguration {
        resolved(
            local: local,
            global: global,
            localSourcePath: nil,
    ...
    static func resolved(
        ...
        let definition: BmuxAgentChatConfigDefinition?
        let source: BmuxAgentChatConfigurationSource
        ...
        return BmuxAgentChatConfiguration(
