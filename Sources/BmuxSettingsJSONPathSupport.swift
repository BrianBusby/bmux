...
typealias RightSidebarWidthSettings = BmuxSettings.RightSidebarWidthSettings
...
enum AutomationSettings {
    static let portBaseKey = "bmuxPortBase"
    static let portRangeKey = "bmuxPortRange"
...
enum AppSettingsFileMapping {
    ...
    static let booleanSettings: [SettingsFileBooleanMapping] = [
        ...
        .init(
            jsonKey: "openSupportedFilesInBmux",
            defaultsKey: app.openSupportedFilesInBmux.userDefaultsKey
        ),
        .init(
            jsonKey: "openMarkdownInBmuxViewer",
            defaultsKey: app.openMarkdownInBmuxViewer.userDefaultsKey
        ),
...
enum BrowserSettingsFileMapping {
    static let booleanSettings: [SettingsFileBooleanMapping] = [
        ...
        .init(
            jsonKey: "openTerminalLinksInBmuxBrowser",
            defaultsKey: BrowserLinkOpenSettings.openTerminalLinksInBmuxBrowserKey
        ),
        .init(
            jsonKey: "interceptTerminalOpenCommandInBmuxBrowser",
            defaultsKey: BrowserLinkOpenSettings.interceptTerminalOpenCommandInBmuxBrowserKey
        ),
...
extension BmuxSettingsFileStore {
    // Keep this in sync with the parser below and the web schema/docs. Settings UI rows
    // validate against this set so new persisted settings need an explicit bmux.json review.
    static let supportedSettingsJSONPaths: Set<String> = [
        ...
        "sidebar.openPortLinksInBmuxBrowser",
        "sidebar.showSSH",
        "sidebar.showPorts",
        "sidebar.showLog",
        ...
        "browser.openTerminalLinksInBmuxBrowser",
        "browser.interceptTerminalOpenCommandInBmuxBrowser",
