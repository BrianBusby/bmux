...
/// Regression coverage for remote-tmux (`bmux ssh-tmux`) new-tab cwd inheritance.
///
/// In local bmux a new tab inherits the active tab's working directory; the
...
/// focused tab's directory. bmux appends that directory onto the placement
