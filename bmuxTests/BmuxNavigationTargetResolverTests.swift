...
/// Pure resolution rules for `bmux://workspace/...` deep links: runtime ids
...
struct BmuxNavigationTargetResolverTests {
    private typealias Resolver = BmuxNavigationTargetResolver
