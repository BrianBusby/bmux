...
final class AppearanceSettingsTests: XCTestCase {
    func testBundleIconPersistenceAllowsStableReleaseBundle() {
        XCTAssertTrue(
            AppBundleIconPersistencePolicy.shouldPersist(
                ...
                appBundleLastPathComponent: "bmux.app",
    ...
    func testBundleIconPersistenceSkipsNightlyBundles() {
        XCTAssertFalse(
            AppBundleIconPersistencePolicy.shouldPersist(
                ...
                appBundleLastPathComponent: "bmux NIGHTLY.app",
                persistenceDisabled: false
            )
        )
        XCTAssertFalse(
            AppBundleIconPersistencePolicy.shouldPersist(
                bundleIdentifier: "com.bmuxterm.app.nightly.issue-4350",
                appBundleLastPathComponent: "bmux NIGHTLY issue-4350.app",
                persistenceDisabled: false
            )
        )
    }
    ...
    func testBundleIconPersistenceSkipsDebugBundles() {
        XCTAssertFalse(
            AppBundleIconPersistencePolicy.shouldPersist(
                ...
                appBundleLastPathComponent: "bmux DEV.app",
                persistenceDisabled: false
            )
        )
        XCTAssertFalse(
            AppBundleIconPersistencePolicy.shouldPersist(
                bundleIdentifier: "com.bmuxterm.app.debug.issue-4350",
                appBundleLastPathComponent: "bmux DEV issue-4350.app",
                persistenceDisabled: false
            )
        )
    }
    ...
    func testAppConfigReloadRefreshAppliesSurfaceColorSchemeForPreviewReload() throws {
        ...
        XCTAssertEqual(events, [
            "color-scheme",
            "reload:\(GhosttySurfaceConfigurationRefresh.bmuxThemeReloadPreviewSource)",
            "host-background",
            "force-refresh:\(GhosttySurfaceConfigurationRefresh.forceRefreshReason)"
        ])
    }

    func testBmuxThemeFinalReloadUsesFinalSource() {
        XCTAssertEqual(
            GhosttySurfaceConfigurationRefresh.bmuxThemeReloadSource(phase: "final"),
            GhosttySurfaceConfigurationRefresh.bmuxThemeReloadFinalSource
        )
    }

    func testBmuxThemePreviewReloadIsDebounced() {
        XCTAssertEqual(
            GhosttySurfaceConfigurationRefresh.bmuxThemeReloadSource(phase: "preview"),
            GhosttySurfaceConfigurationRefresh.bmuxThemeReloadPreviewSource
        )
        XCTAssertTrue(
            GhosttySurfaceConfigurationRefresh.shouldDebounceBmuxThemeReload(
                source: GhosttySurfaceConfigurationRefresh.bmuxThemeReloadPreviewSource
            )
        )
        XCTAssertTrue(
            GhosttySurfaceConfigurationRefresh.shouldDebounceBmuxThemeReload(
                source: GhosttySurfaceConfigurationRefresh.bmuxThemeReloadLegacySource
            )
        )
        XCTAssertFalse(
            GhosttySurfaceConfigurationRefresh.shouldDebounceBmuxThemeReload(
