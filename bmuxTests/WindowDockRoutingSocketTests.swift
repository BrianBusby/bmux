...
/// See https://github.com/manaflow-ai/bmux/issues/7142.
...
struct WindowDockRoutingSocketTests {
    ...
    func dockPaneRoutingAndFocusedCloseStayInDock() async throws {
        ...
        try await withDockEnabled {
            ...
            activeWindow.identifier = NSUserInterfaceItemIdentifier("bmux.main.\(activeWindowId.uuidString)")
            ...
            dockWindow.identifier = NSUserInterfaceItemIdentifier("bmux.main.\(dockWindowId.uuidString)")
