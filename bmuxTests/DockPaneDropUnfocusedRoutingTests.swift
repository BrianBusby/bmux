...
struct DockPaneDropUnfocusedRoutingTests {
    ...
    func dropMouseUpUsesSameTerminalPortalRouteAsHover() async throws {
        try await AppContextSerialGate.withExclusiveAppContext {
            ...
            let filePasteboard = NSPasteboard(name: NSPasteboard.Name("bmux.test.issue-7529.file.\(UUID().uuidString)"))
    ...
    func nilExitClearsOnlyTargetViewActiveDragSequence() async throws {
        try await AppContextSerialGate.withExclusiveAppContext {
            ...
            let firstPasteboard = NSPasteboard(name: NSPasteboard.Name("bmux.test.issue-7529.first.\(UUID().uuidString)"))
            let secondPasteboard = NSPasteboard(name: NSPasteboard.Name("bmux.test.issue-7529.second.\(UUID().uuidString)"))
    ...
    func acceptedUnfocusedDockPaneDropMovesMainSurfaceIntoDock() async throws {
        try await AppContextSerialGate.withExclusiveAppContext {
            ...
            let pasteboard = NSPasteboard(name: NSPasteboard.Name("bmux.test.issue-7529.\(UUID().uuidString)"))
