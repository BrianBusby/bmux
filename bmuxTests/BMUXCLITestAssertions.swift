...
extension BMUXCLIErrorOutputRegressionTests {
    ...
    final class BMUXTestExpectation {
    ...
    func expectation(description: String) -> BMUXTestExpectation {
        BMUXTestExpectation(description: description)
    }

    func wait(for expectations: [BMUXTestExpectation], timeout: TimeInterval) {
