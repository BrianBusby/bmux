...
// compiled into both the `bmux-cli` target and this test target — so the pure
// classification decision can be unit-tested directly, without `@testable`
// importing the `bmux_cli` executable module (whose symbols the app-hosted
...
///
/// https://github.com/manaflow-ai/bmux/issues/4985
...
struct FeedEventClassificationTests {
    ...
    /// telemetry. Otherwise "Approve for me" gets bypassed by bmux's Feed UI.
