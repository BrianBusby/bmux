...
/// Regression coverage for friendly `bmux ssh-tmux` failures when the remote
/// host has no tmux installed (https://github.com/manaflow-ai/bmux/issues/7368).
@Suite struct RemoteTmuxMissingTmuxTests {
    @Test(arguments: [
        RemoteTmuxCommandFailureShape(exitCode: 127, stderr: "bmux-remote-tmux: line 0: exec: tmux: not found"),
        RemoteTmuxCommandFailureShape(exitCode: 127, stderr: "bmux-remote-tmux: 1: exec: tmux: not found"),
        RemoteTmuxCommandFailureShape(exitCode: 127, stderr: "bmux-remote-tmux: tmux not found"),
    ...
    @Test func resolverExecutesMissingTmuxBranchAndFoundPathControl() throws {
        ...
        #expect(missing.stderr == "bmux-remote-tmux: tmux not found\n")
    ...
    @Test func discoverMirrorSessionsSurfacesActionableTmuxMissing() async throws {
        let stderr = "bmux-remote-tmux: line 0: exec: tmux: not found"
...
@Suite struct RemoteTmuxMissingTmuxPostFixTests {
    ...
    @Test(arguments: [
        RemoteTmuxCommandFailureShape(exitCode: 0, stderr: "bmux-remote-tmux: tmux not found"),
        RemoteTmuxCommandFailureShape(exitCode: 1, stderr: "bmux-remote-tmux: tmux not found"),
        ...
        RemoteTmuxCommandFailureShape(exitCode: 127, stderr: "bmux-remote-tmux: line 0: exec: htop: not found"),
    ])
    ...
    @Test func resolverSentinelMatchesClassifier() {
        #expect(RemoteTmuxHost.tmuxNotFoundSentinel == "bmux-remote-tmux: tmux not found")
