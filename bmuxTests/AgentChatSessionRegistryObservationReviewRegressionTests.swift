...
struct AgentChatSessionRegistryObservationReviewRegressionTests {
    ...
    @Test func mobileChatObserverIgnoresInheritedLaunchKindOnChildTool() throws {
        ...
        let details: (Int) -> BmuxTopProcessArguments? = { pid in
            switch pid {
            case 101:
                BmuxTopProcessArguments(
                    arguments: ["claude"],
    ...
    @Test func mobileChatObserverDetectsHostedClaudeUnderScopedShellRoot() throws {
        ...
        let details: (Int) -> BmuxTopProcessArguments? = { pid in
            switch pid {
            case 101:
                BmuxTopProcessArguments(arguments: ["-zsh"], environment: [:])
            case 202:
                BmuxTopProcessArguments(
                    arguments: [
                        "node",
                        "/Users/example/.bmux-agent-wrapper/subrouter.js",
                    ],
                    environment: [
                        "BMUX_AGENT_LAUNCH_KIND": "claude",
                        "CLAUDE_CODE_SESSION_ID": sessionID,
    ...
    @Test func mobileChatObserverUsesPendingAliasForClaudeForkResumeParent() throws {
        ...
        let details: (Int) -> BmuxTopProcessArguments? = { pid in
            ...
            return BmuxTopProcessArguments(
                ...
                environment: ["CLAUDE_CODE_SESSION_ID": parentSessionID, "BMUX_AGENT_LAUNCH_CWD": "/Users/example/project"]
            )
        }
        ...
        let scan = Task.detached {
            ...
            return AgentChatSessionRegistry.scanObservedAgentSessions(
                ...
                processArgumentsAndEnvironment: { _ in
                    ...
                    return BmuxTopProcessArguments(arguments: ["claude.exe"], environment: [:])
                },
                codexRolloutPath: { _ in nil }
            )
        }
