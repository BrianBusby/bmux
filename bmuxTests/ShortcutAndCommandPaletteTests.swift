...
import struct BmuxSettings.QuitConfirmationStore
import struct BmuxSettings.CommandPaletteSettingsStore
import enum BmuxSettings.ConfirmQuitMode
import struct BmuxSettings.SettingCatalog
import struct BmuxSettings.UserDefaultsSettingsClient
...
final class CommandPaletteRenameSelectionSettingsTests: XCTestCase {
    private let suiteName = "bmux.tests.commandPaletteRenameSelection.\(UUID().uuidString)"
...
final class RightSidebarModeShortcutHintTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        KeyboardShortcutSettings.settingsFileStore = KeyboardShortcutSettingsFileStore(
            primaryPath: directoryURL.appendingPathComponent("bmux.json", isDirectory: false).path,
            fallbackPath: nil,
            startWatching: false
        )
    ...
    func testAlwaysShowHintsIsOnlyEnabledForUITests() {
        ...
        XCTAssertTrue(
            ShortcutHintDebugSettings(
                environment: ["BMUX_UI_TEST_SHORTCUT_HINTS_ALWAYS_SHOW": "1"]
            ).alwaysShowHints
        )
    }
...
final class BuildFlavorTests: XCTestCase {
    func testDetectsDevFromBundleName() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "bmux DEV noqdlg", bundleIdentifier: "com.bmuxterm.app"),
            .dev
        )
    }
    ...
    func testDetectsDevBeforeTagTextCanLookNightly() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "bmux DEV nightly", bundleIdentifier: "com.bmuxterm.app"),
            .dev
        )
    }
    ...
    func testDetectsNightlyFromBundleIdentifier() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "bmux", bundleIdentifier: "com.bmuxterm.app.nightly"),
            .nightly
        )
    }
    ...
    func testDetectsStableByDefault() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "bmux", bundleIdentifier: "com.bmuxterm.app"),
            .stable
        )
    }
}
