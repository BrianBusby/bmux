...
struct PaneMemoryGuardrailTests {
    ...
    func processTreeMemorySummationByTTY() {
        ...
        func proc(_ pid: Int, ppid: Int, mem: Int64, pgid: Int, tpgid: Int) -> BmuxTopProcessInfo {
            BmuxTopProcessInfo(
                pid: pid, parentPID: ppid, name: "pytest", path: nil, ttyDevice: tty,
                bmuxWorkspaceID: nil, bmuxSurfaceID: nil, bmuxAttributionReason: nil,
    ...
    @Test
    func processTreeMemoryIncludesForegroundDescendantWithoutTTYOrBMUXScope() {
        let ws = UUID(), pane = UUID()
        func proc(
            _ pid: Int,
            ppid: Int,
            ...
            BmuxTopProcessInfo(
                ...
                bmuxWorkspaceID: nil, bmuxSurfaceID: surface, bmuxAttributionReason: nil,
    ...
    func processTreeMemoryIncludesScopedDaemonWithoutTTYOrParentLink() {
        ...
        func proc(
            ...
            BmuxTopProcessInfo(
                pid: pid, parentPID: ppid, name: name, path: nil, ttyDevice: tty,
                bmuxWorkspaceID: surface == nil ? nil : ws, bmuxSurfaceID: surface, bmuxAttributionReason: nil,
                processGroupID: pgid, terminalProcessGroupID: pgid, cpuPercent: 0,
                memoryBytes: mem, memorySource: .physicalFootprint,
                residentBytes: mem, residentMemorySource: .residentSize,
                virtualBytes: 0, threadCount: 1
