...
final class FilePreviewReviewFeedbackTests: XCTestCase {
    func testAppBundleExportsFilePreviewDragType() {
        ...
        XCTAssertTrue(
            exported.contains("com.bmux.filepreview.transfer"),
    ...
    // Regression test for manaflow-ai/bmux#4576: drag-selecting deep into a large file pegged the
