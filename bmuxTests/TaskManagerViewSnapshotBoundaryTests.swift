...
/// Regression coverage for https://github.com/manaflow-ai/bmux/issues/4529.
///
/// PR https://github.com/manaflow-ai/bmux/pull/4437 migrated
/// `BmuxTaskManagerModel` to `@Observable` and the Task Manager view body
...
/// https://github.com/manaflow-ai/bmux/issues/2586): any view rendered
...
final class TaskManagerViewSnapshotBoundaryTests: XCTestCase {
    func testTaskManagerRowViewEqualityIgnoresClosureIdentity() {
        ...
        let leftView = BmuxTaskManagerRowView(
            row: row,
            onViewWorkspace: {},
            onViewTerminal: {},
            onKillProcess: {},
        ...
        let rightView = BmuxTaskManagerRowView(
            row: row,
            onViewWorkspace: { _ = 1 },
            onViewTerminal: { _ = 2 },
            onKillProcess: { _ = 3 },
    ...
    func testTaskManagerRowViewEqualityDetectsRowChanges() {
        ...
        let left = BmuxTaskManagerRowView(
            row: baseRow,
            onViewWorkspace: {},
            onViewTerminal: {},
            onKillProcess: {},
        ...
        let right = BmuxTaskManagerRowView(
            row: bumpedRow,
            onViewWorkspace: {},
            onViewTerminal: {},
            onKillProcess: {},
    ...
    private static func makeRow(memoryBytes: Int64 = 1_024) -> BmuxTaskManagerRow {
        BmuxTaskManagerRow(
            id: "test-row",
            kind: .process,
            level: 0,
