...
// https://github.com/manaflow-ai/bmux/pull/7228
...
extension CLINotifyProcessIntegrationRegressionTests {
    ...
    /// back to the LIVE `BMUX_WORKSPACE_ID`, never to the currently-focused tab.
    ...
    func testClaudeNotificationFallsBackToLiveWorkspaceInsteadOfFocusedTab() throws {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-claude-misroute-fallback-\(UUID().uuidString)", isDirectory: true)
        ...
        let result = runProcess(
            ...
            environment: [
                ...
                "BMUX_WORKSPACE_ID": liveWorkspaceId,
                "BMUX_SURFACE_ID": liveSurfaceId,
                "BMUX_CLAUDE_HOOK_STATE_PATH": stateURL.path,
        ...
        XCTAssertTrue(
            ...
            "Expected notification to route to the live BMUX_WORKSPACE_ID, saw \(state.commands)"
        )
    ...
    func testClaudeNotificationDoesNotGuessOnAmbiguousTTY() throws {
        ...
        let state = MockSocketServerState()
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-claude-ambiguous-tty-\(UUID().uuidString)", isDirectory: true)
        let staleWorkspaceId = "11111111-1111-1111-1111-111111111111"
        ...
        let result = runProcess(
            ...
            environment: [
                ...
                "PATH": "/usr/bin:/bin:/usr/sbin:/sbin",
                "BMUX_SOCKET_PATH": socketPath,
                "BMUX_WORKSPACE_ID": staleWorkspaceId,
                "BMUX_SURFACE_ID": "77777777-7777-7777-7777-777777777777",
                "BMUX_CLI_TTY_NAME": ttyName,
                "BMUX_CLAUDE_HOOK_STATE_PATH": root.appendingPathComponent("claude-hook-sessions.json").path,
                "BMUX_CLI_SENTRY_DISABLED": "1",
                "BMUX_CLAUDE_HOOK_SENTRY_DISABLED": "1",
            ],
    ...
    func testClaudeNotificationHonorsExplicitWorkspaceHandleRef() throws {
        ...
        let state = MockSocketServerState()
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-claude-explicit-workspace-ref-\(UUID().uuidString)", isDirectory: true)
    ...
    func testClaudeHookSelfHealsCrossWorkspaceActivePointer() throws {
        ...
        let state = MockSocketServerState()
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-claude-selfheal-\(UUID().uuidString)", isDirectory: true)
        ...
        let result = runProcess(
            ...
            environment: [
                ...
                "PATH": "/usr/bin:/bin:/usr/sbin:/sbin",
                "BMUX_SOCKET_PATH": socketPath,
                "BMUX_WORKSPACE_ID": ownWorkspaceId,
                "BMUX_SURFACE_ID": ownSurfaceId,
                "BMUX_CLAUDE_HOOK_STATE_PATH": stateURL.path,
                "BMUX_CLI_SENTRY_DISABLED": "1",
                "BMUX_CLAUDE_HOOK_SENTRY_DISABLED": "1",
            ],
