...
@Suite struct BrowserHistorySuggestionCacheTests {
    private func makeStore() -> (store: BrowserHistoryStore, fileURL: URL) {
        let fileURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-history-suggest-\(UUID().uuidString).json")
    ...
    @Test func suggestionsMatchHostAndTitleAfterCaching() {
        ...
        store.recordVisit(url: URL(string: "https://github.com/manaflow-ai/bmux/issues"), title: "bmux issues")
        ...
        #expect(results.contains("https://github.com/manaflow-ai/bmux/issues"))
