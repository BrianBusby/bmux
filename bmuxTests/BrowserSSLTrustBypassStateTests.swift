...
struct BrowserSSLTrustBypassStateTests {
    ...
    func errorPageRetryURLAllowsOnlyWebURLs() throws {
        ...
        #expect(BrowserErrorPage.retryURL(from: "bmux-browser-action://bypass-ssl?token=abc") == nil)
    ...
    func pendingBypassReplaysOriginalRequestOnceAndMarksHostBypassed() throws {
        ...
        #expect(actionURL.scheme == "bmux-browser-action")
    ...
    func pendingBypassRejectsMissingForgedAndExpiredTokens() throws {
        ...
        let missingTokenURL = try #require(URL(string: "bmux-browser-action://bypass-ssl"))
        let forgedTokenURL = try #require(URL(string: "bmux-browser-action://bypass-ssl?token=not-issued"))
