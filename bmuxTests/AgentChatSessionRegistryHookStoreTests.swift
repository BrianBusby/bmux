...
struct AgentChatSessionRegistryHookStoreTests {
    @Test func mobileChatObserverDetectsBmuxLaunchedOpaqueClaudeWrapper() throws {
            ...
            processArgumentsAndEnvironment: { pid in
                ...
                return BmuxTopProcessArguments(
                    ...
                    environment: [
                        ...
                        "BMUX_AGENT_LAUNCH_CWD": "/Users/example/opaque-project",
                    ]
                )
            },
        ...
        let observed = AgentChatSessionRegistry.scanObservedAgentSessions(
            ...
            processArgumentsAndEnvironment: { pid in
                ...
                return BmuxTopProcessArguments(
                    ...
                    environment: [
                        "CLAUDE_CODE_SESSION_ID": sessionID,
                        "BMUX_AGENT_LAUNCH_CWD": "/Users/example/not-authoritative",
                    ]
                )
            },
            codexRolloutPath: { _ in nil }
    ...
    private func writeClaudeHookStore(
        ...
        let directory = home.appendingPathComponent(".bmuxterm", isDirectory: true)
