...
/// Regression coverage for https://github.com/manaflow-ai/bmux/issues/5227.
///
/// In a bmux window every keyDown is funneled through the swizzled
...
struct EditableTextViewArrowKeyForwardingTests {
    ...
    func doesNotStealCommandOptionArrowFromPaneFocusShortcut(keyCode: UInt16) {
        // Cmd+Option+Arrow is reserved for bmux pane-focus shortcuts and must
