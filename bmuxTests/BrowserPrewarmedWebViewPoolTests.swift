...
private final class PrewarmPoolHarness {
    ...
    private(set) var madeWebViews: [BmuxWebView] = []
    ...
    init(expirySleep: @escaping @Sendable (Duration) async throws -> Void = { _ in
        ...
        var recordWebView: (@MainActor (BmuxWebView) -> Void)!
...
private let pricingURL = URL(string: "https://bmux.com/app-pricing?appearance=dark")!
private let otherURL = URL(string: "https://bmux.com/docs")!
