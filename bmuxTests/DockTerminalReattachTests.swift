...
extension DockSocketLifecycleTests {
    ...
    func dockTransferKeepsResumedAgentCwdRescueStateWhileNotProvenDead() throws {
        ...
        let sessionDirectory = "/tmp/bmux-dock-transfer-session"
    ...
    func dockDetachDropsAgentMetadataWhoseRecordedProcessesAllExited() throws {
        ...
        let sessionDirectory = "/tmp/bmux-dock-dead-agent-session"
        let agent = SessionRestorableAgentSnapshot(
            kind: .claude,
            sessionId: sessionId,
            workingDirectory: sessionDirectory,
    ...
    func dockDetachDropsAgentMetadataWhenLivePidIsReusedIdentity() throws {
        ...
        let agent = SessionRestorableAgentSnapshot(
            kind: .claude,
            sessionId: sessionId,
            workingDirectory: "/tmp/bmux-dock-reused-pid-session",
            launchCommand: nil
        )
    ...
    func dockDetachKeepsAgentMetadataWhileRecordedIdentityStillRuns() throws {
        ...
        let agent = SessionRestorableAgentSnapshot(
            kind: .claude,
            sessionId: sessionId,
            workingDirectory: "/tmp/bmux-dock-live-agent-session",
            launchCommand: nil
        )
