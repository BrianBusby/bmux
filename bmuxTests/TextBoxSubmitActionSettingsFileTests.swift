...
struct TextBoxSubmitActionSettingsFileTests {
    private let backupsKey = "bmux.settingsFile.backups.v1"
    private let importedKey = "bmux.settingsFile.importedManagedDefaults.v1"
    ...
    private func makeTemporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory.appendingPathComponent(
            "bmux-textbox-submit-actions-\(UUID().uuidString)",
            isDirectory: true
        )
