...
#       [--audience internal|external] [--bundle-id dev.bmux.app.beta] \
...
BUILD_NUMBER=""
AUDIENCE="internal"
BUNDLE_ID="${IOS_BETA_BUNDLE_ID:-dev.bmux.app.beta}"
...
NOTES_FILE="$(mktemp "${TMPDIR:-/tmp}/bmux-testflight-notes.XXXXXX")"
