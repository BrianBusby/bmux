...
public struct BMUXMobileRuntime: Sendable, MobileSyncRuntime {
    ...
    public init(
        ...
        pairingAttemptTimeoutNanoseconds: UInt64 = BMUXMobileRuntime.defaultPairingAttemptTimeoutNanoseconds,
...
struct MobileShellDevStackAuthTokenProvider {
    ...
    static let environmentKey = "BMUX_MOBILE_DEV_STACK_AUTH_TOKEN"
