...
/// Adapts the auth runtime's ``BmuxAuthRuntime/TokenProviding`` to the analytics
/// package's ``BmuxMobileAnalytics/AnalyticsTokenProviding``.
///
/// The analytics package must not depend on `BmuxAuthRuntime`, so this bridge
