...
///
/// Builds the de-singletonized ``BmuxMobileAnalytics/AnalyticsEmitter`` once at
...
public struct MobileAnalyticsComposition {
    ...
    ///
    /// - Parameters:
    ///   - apiBaseURL: The bmux web API base URL (no trailing slash), from
    ...
    /// ``BmuxMobileAnalytics/AnalyticsEmitter``.
