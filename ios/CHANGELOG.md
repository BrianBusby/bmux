...
Single source of truth for what each bmux iOS TestFlight build changed. Every
...
- **Internal** (`ship ios`, the `bmux beta` group): terse, dev-facing, per-build.
...
- Mobile terminal foundation: faithful render-grid replay over the bmux SPM core (#5079).
...
- Mobile terminal: drive your Mac's bmux terminals from your phone.
