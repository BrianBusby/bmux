...
@main
struct bmuxApp: App {
    @UIApplicationDelegateAdaptor(BmuxAppDelegate.self) private var appDelegate
    ...
    private static let root: AppCompositionRoot = {
        ...
        let runtime = BMUXMobileRuntime(
            ...
            stackAccessTokenProvider: BMUXMobileRuntime.stackAccessTokenProvider(from: auth.coordinator),
            stackAccessTokenForStatusProvider: BMUXMobileRuntime.stackAccessTokenForStatusProvider(from: auth.coordinator),
            stackAccessTokenForceRefresher: BMUXMobileRuntime.stackAccessTokenForceRefresher(from: auth.coordinator)
        )
