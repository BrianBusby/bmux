...
/// Holds the de-singletonized graph the `bmuxApp` builds once at launch.
///
...
final class AppCompositionRoot {
    ...
    init(
        ...
        // (`BMUX_UITEST_MOCK_DATA`/XCUITest) or a dogfood auto-pair attach URL is
    ...
    /// the injected ``BmuxMobileAnalytics/AnalyticsSessionizer`` and persisted
    /// ``BmuxMobileAnalytics/AnalyticsSessionStore``, emitting `ios_session_started`
