...
Install bmux agent skills into the Codex skills directory.
...
Examples:
  ...
  curl -fsSL https://raw.githubusercontent.com/manaflow-ai/bmux/main/skills.sh | bash
EOF
}
...
if [[ -z "$source_dir" ]]; then
  ...
  tmp_dir="$(mktemp -d "${TMPDIR:-/tmp}/bmux-skills.XXXXXX")"
  archive_url="https://codeload.github.com/manaflow-ai/bmux/tar.gz/${ref}"
