...
export type PushPayload = {
   ...
   * `bmux.notificationId` so cross-device dismiss-sync can target the exact
...
const DEV_TAGGED_BUNDLE_ID = /^dev\.bmux\.ios\.[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?$/;
const PROD_BUNDLE_IDS = new Set(["com.bmuxterm.app", "dev.bmux.app.beta"]);
