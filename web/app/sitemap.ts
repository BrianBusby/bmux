...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const paths: Array<{
    ...
    { path: "/blog/bmux-home", lastModified: "2026-06-23", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/bmux-history", lastModified: "2026-06-02", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/bmux-finder", lastModified: "2026-05-22", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/bmux-vault", lastModified: "2026-07-03", changeFrequency: "monthly" as const, priority: 0.7 },
    ...
    { path: "/blog/introducing-bmux", lastModified: "2026-02-12", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/zen-of-bmux", lastModified: "2026-02-27", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/bmux-claude-teams", lastModified: "2026-03-30", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/bmux-omo", lastModified: "2026-03-30", changeFrequency: "monthly" as const, priority: 0.7 },
    { path: "/blog/bmux-ssh", lastModified: "2026-07-03", changeFrequency: "monthly" as const, priority: 0.7 },
