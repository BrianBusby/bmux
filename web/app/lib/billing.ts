export const CHECKOUT_EXTERNAL_BROWSER_PARAM = "bmux_external_browser";
export const CHECKOUT_NATIVE_SCHEME_PARAM = "bmux_scheme";
...
const DEFAULT_APP_PRICING_CHECKOUT_URL = "https://bmux.com/api/billing/checkout";
...
function configuredAppPricingCheckoutURL(requestOrigin: string | null): string {
  const configured = process.env.BMUX_APP_PRICING_CHECKOUT_URL?.trim();
