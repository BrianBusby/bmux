/**
 * Single source of truth for bmux download links.
 *
 * `DOWNLOAD_URL` is the actual release asset. bmux ships only a macOS build,
...
export const DOWNLOAD_URL =
  "https://github.com/manaflow-ai/bmux/releases/latest/download/bmux-macos.dmg";
...
export const WAITLIST_EARLY_ACCESS_FLAGS: Record<WaitlistPlatform, string> = {
  linux: "bmux-for-linux",
  android: "bmux-for-android",
  windows: "bmux-for-windows",
};
