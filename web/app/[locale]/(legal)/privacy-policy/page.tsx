...
export const metadata: Metadata = {
  title: "Privacy Policy — bmux",
  description: "Privacy policy for bmux",
  alternates: { canonical: "https://bmux.com/privacy-policy" },
};
  ...
  return (
    <>
      ...
      <p>
        ...
        <a href="https://bmux.com">bmux.com</a>.
        &ldquo;Application&rdquo; refers to the bmux desktop application for
