...
export const metadata: Metadata = {
  title: "EULA — bmux",
  description: "End-User License Agreement for bmux",
  alternates: { canonical: "https://bmux.com/eula" },
};
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <strong>&ldquo;Application&rdquo;</strong> means the bmux desktop
