...
const STORAGE_KEY = "bmuxHeroPhonePos";
...
export function HeroPhone() {
  ...
  const img = (
    <Image
      src={phoneImage}
      alt="bmux iOS app mirroring a live agent terminal"
  ...
  return (
    ...
    >
      <Link href="/ios" aria-label="bmux iOS" className="pointer-events-auto block">
        {img}
      </Link>
    </div>
  );
