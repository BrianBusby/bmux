...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    ...
    keywords: [
      "bmux", "Show HN", "Hacker News", "terminal", "macOS", "Ghostty",
  ...
  return (
    <>
      ...
      <p>
        {t.rich("cta", {
          link: (chunks) => (
            <a href="https://github.com/manaflow-ai/bmux">{chunks}</a>
          ),
        })}
      </p>
      ...
      <div className="my-6">
        <Image
          src={starHistory}
          alt="bmux GitHub star history showing growth from near 0 to 900+ stars after the Show HN launch"
          placeholder="blur"
