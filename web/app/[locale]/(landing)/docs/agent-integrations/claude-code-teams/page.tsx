...
export default function ClaudeCodeTeamsPage() {
  ...
  return (
    <>
      ...
      <CodeBlock lang="bash">{`bmux claude-teams
bmux claude-teams --continue
bmux claude-teams --model sonnet`}</CodeBlock>
      <p>{t("usageDesc")}</p>
      ...
      <table>
        ...
        <tbody>
          <tr><td><code>~/.bmuxterm/claude-teams-bin/</code></td><td>{t("dirShim")}</td></tr>
