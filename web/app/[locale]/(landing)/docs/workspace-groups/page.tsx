...
bmux workspace-group set-color <group-id> --hex "#7A4FD8"
bmux workspace-group set-icon  <group-id> --symbol ladybug.fill
bmux workspace-group move <group-id> (--to-index <n> | --before <group-id> | --after <group-id>)
bmux workspace-group focus <group-id>`}</CodeBlock>
      <p>{t("cliCreateNote")}</p>
      <p>{t("cliFlagsNote")}</p>

      <DocsHeading level={3} id="examples">{t("cliExamplesTitle")}</DocsHeading>
      <p>{t("cliExampleGroup")}</p>
      <CodeBlock lang="bash">{`bmux workspace-group create --name manaflow`}</CodeBlock>
      <p>{t("cliExampleNew")}</p>
      <CodeBlock lang="bash">{`bmux workspace-group new-workspace workspace_group:1`}</CodeBlock>
      <p>{t("cliExampleList")}</p>
      <CodeBlock lang="bash">{`bmux workspace-group list`}</CodeBlock>
