// Pure construction of the bmux Founder's Edition welcome email payload.
//
...
export const EMAIL_SUBJECT = "bmux Founder's Edition";
...
function buildBody(name: string): string {
  return [
    `Hi ${name}!`,
    "",
    "Thank you for being one of the first ever customers of bmux :)",
    "",
    ...
    "",
    "bmux iOS Beta is out for bmux Founder's Edition! If you have a different " +
