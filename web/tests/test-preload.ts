...
// fires, but `env.BMUX_PUSH_RATE_LIMIT_ID` froze to `undefined` whenever another
...
process.env.BMUX_PUSH_RATE_LIMIT_ID ??= "bmux-push-test";
process.env.RESEND_API_KEY ??= "re_test";
process.env.BMUX_FEEDBACK_FROM_EMAIL ??= "founders@manaflow.com";
process.env.BMUX_FEEDBACK_RATE_LIMIT_ID ??= "feedback-test";
