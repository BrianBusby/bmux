...
export const shortcutCategories: ShortcutCategory[] = [
  {
    ...
    shortcuts: [
      ...
      { id: "reloadConfiguration", combos: [["⌘", "⇧", ","]], description: { en: "Reload configuration", ja: "構成を再読み込み" } },
      {
        ...
        combos: [["⌃", "⌥", "⌘", "."]],
        description: { en: "Show/hide all bmux windows", ja: "すべてのbmuxウインドウを表示/非表示" },
      ...
      { id: "quit", combos: [["⌘", "Q"]], description: { en: "Quit bmux", ja: "bmuxを終了" } },
    ],
  },
  {
    id: "workspaces",
    ...
    shortcuts: [
      ...
      { id: "prevSidebarTab", combos: [["⌃", "⌘", "["]], description: { en: "Previous workspace", ja: "前のワークスペース" } },
      {
        ...
        note: {
          en: "bmux uses Cmd+[ and Cmd+] for focus history by default. Unbind Focus Back/Forward in Settings to let browser or terminal shortcuts handle those keys.",
          ja: "bmux は標準で Cmd+[ と Cmd+] をフォーカス履歴に使います。ブラウザまたはターミナル側で使うには、設定で Focus Back/Forward の割り当てを解除します。",
        },
      },
      {
