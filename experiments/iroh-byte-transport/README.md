...
This is a deliberately small Rust experiment for the bmux mobile Iroh path. It is not linked into the iOS app. It proves the byte-stream shape we need before we decide whether the production bridge is an FFI library, a local helper, or a later Swift-native Iroh package.
