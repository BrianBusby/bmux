...
final class MenuKeyEquivalentRoutingUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        gotoSplitPath = "/tmp/bmux-ui-test-goto-split-\(UUID().uuidString).json"
        keyequivPath = "/tmp/bmux-ui-test-keyequiv-\(UUID().uuidString).json"
    ...
    func testBrowserFocusModeRoutesPageShortcutsAndDoubleEscapeExits() {
        ...
        XCTAssertTrue(
            ...
            "Expected Cmd+N to resume normal bmux routing after focus mode exit. data=\(loadKeyequiv())"
        )
    }
    ...
    private func launchWithBrowserSetup(browserURL: String? = nil) -> XCUIApplication {
        ...
        app.launchEnvironment["BMUX_UI_TEST_GOTO_SPLIT_SETUP"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_GOTO_SPLIT_PATH"] = gotoSplitPath
        app.launchEnvironment["BMUX_UI_TEST_KEYEQUIV_PATH"] = keyequivPath
        if let browserURL {
            app.launchEnvironment["BMUX_UI_TEST_GOTO_SPLIT_BROWSER_URL"] = browserURL
        }
    ...
    private func launchAndEnsureForeground(_ app: XCUIApplication) {
        ...
        // the foreground so subsequent typeKey() input is routed to bmux and not
        ...
        if app.state == .runningBackground {
            ...
            XCTExpectFailure("App could not be foregrounded on this runner", options: options) {
                XCTFail("bmux stayed backgrounded after activate(); key input may not reach it. state=\(app.state.rawValue)")
            }
            return
        }
...
final class SplitCloseRightBlankRegressionUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/bmux-ui-test-split-close-right-\(UUID().uuidString).json"
        socketPath = "/tmp/bmux-ui-test-socket-\(UUID().uuidString).sock"
        diagnosticsPath = "/tmp/bmux-ui-test-diagnostics-\(UUID().uuidString).json"
        ...
        let leaf = "bmux-ui-test-split-close-right-shots-\(UUID().uuidString)"
    ...
    func testClosingBothRightSplitsDoesNotLeaveBlankPane() {
        let app = XCUIApplication()
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_SETUP"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["BMUX_SOCKET_PATH"] = socketPath
        app.launchEnvironment["BMUX_UI_TEST_DIAGNOSTICS_PATH"] = diagnosticsPath
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsViaShortcuts() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_SETUP"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] = "1"
        // The regression can be a single compositor frame; capture enough post-close frames to
        // deterministically catch it.
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_ITERATIONS"] = "12"
        // Close quickly (closer to how a user can click two close buttons back-to-back).
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "32"
        // Repro order that still flashes for users: split left/right first, then split top/down.
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd"
        app.launch()
        app.activate()
    ...
    func testReproStretchAfterClosingSingleRightSplit() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_ITERATIONS"] = "16"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "36"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_single"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingBottomSplitsViaShortcuts() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "32"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_bottom"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsTopFirstWithGap() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_ITERATIONS"] = "14"
        // Reproduce manual close cadence: close top-right, observe one frame, then close bottom-right.
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "120"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "40"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsBottomFirstViaShortcuts() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "120"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "40"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd_bottom_first"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsWithoutFocusingRightPanes() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "36"
        app.launchEnvironment["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd_unfocused"
        app.launch()
        app.activate()
    ...
    private func assertPaneRendersAndUpdates(
        ...
        app.typeText("yes BMUX_AFTER_CLOSE_\(label)_\(token) | head -n 30\n")
