...
/// (`Sources/bmuxApp.swift`, the `Settings…` window) and in the
/// migrated `BmuxSettingsUI.TerminalSection`:
...
final class SettingsTerminalBehaviorUITests: SettingsUITestCase {
    ...
    private enum Subtitle {
        ...
        static let copyOff = "bmux does not add system-clipboard copy on selection"
