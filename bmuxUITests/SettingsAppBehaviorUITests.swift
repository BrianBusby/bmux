...
///     does not have (BMUX_UI_TEST_MODE skips session restore).
...
///   - Open Supported Files / Open Markdown (openSupportedFilesInBmux,
///     openMarkdownInBmuxViewer): effect triggers on Cmd-click of a file
