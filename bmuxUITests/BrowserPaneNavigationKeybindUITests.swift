...
final class BrowserPaneNavigationKeybindUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/bmux-ui-test-goto-split-\(UUID().uuidString).json"
        try? FileManager.default.removeItem(atPath: dataPath)
        diagnosticsPath = "/tmp/bmux-ui-test-goto-split-\(UUID().uuidString).diagnostics.json"
    ...
    func testCmdCtrlHMovesLeftWhenWebViewFocused() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_FOCUS_SHORTCUTS"] = "1"
    ...
    func testCmdCtrlHMovesLeftWhenWebViewFocusedUsingGhosttyConfigKeybind() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_FOCUS_SHORTCUTS"] = "1"
        configureSocketLaunch(app)
        app.launchEnvironment["BMUX_UI_TEST_GOTO_SPLIT_USE_GHOSTTY_CONFIG"] = "1"
        launchAndEnsureForeground(app)
    ...
    func testEscapeRestoresFocusedPageInputAfterCmdL() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["BMUX_UI_TEST_FOCUS_SHORTCUTS"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_GOTO_SPLIT_INPUT_SETUP"] = "1"
        launchAndEnsureForeground(app)
    ...
    private func configureSocketLaunch(_ app: XCUIApplication) {
        ...
        app.launchEnvironment["BMUX_UI_TEST_TARGET_DISPLAY_ID"] = ProcessInfo.processInfo.environment["BMUX_UI_TEST_TARGET_DISPLAY_ID"]
    }
