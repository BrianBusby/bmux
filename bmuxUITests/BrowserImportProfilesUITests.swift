...
final class BrowserImportProfilesUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        capturePath = "/tmp/bmux-ui-test-browser-import-\(UUID().uuidString).json"
        settingsOpenCapturePath = "/tmp/bmux-ui-test-settings-open-\(UUID().uuidString).json"
    ...
    private func launchApp() -> XCUIApplication {
        ...
        app.launchEnvironment["BMUX_UI_TEST_BROWSER_IMPORT_FIXTURE"] = #"{"browserName":"Helium","profiles":["You","austin"]}"#
        app.launchEnvironment["BMUX_UI_TEST_BROWSER_IMPORT_DESTINATIONS"] = #"["Default"]"#
        app.launchEnvironment["BMUX_UI_TEST_BROWSER_IMPORT_MODE"] = "capture-only"
        app.launchEnvironment["BMUX_UI_TEST_BROWSER_IMPORT_CAPTURE_PATH"] = capturePath
        app.launchEnvironment["BMUX_UI_TEST_BROWSER_IMPORT_HINT_VARIANT"] = "inlineStrip"
        app.launchEnvironment["BMUX_UI_TEST_BROWSER_IMPORT_HINT_SHOW"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_BROWSER_IMPORT_HINT_DISMISSED"] = "0"
        app.launchEnvironment["BMUX_UI_TEST_BROWSER_IMPORT_HINT_OPEN_BLANK_BROWSER"] = "1"
    ...
    private func launchAppForBlankImportHint() -> XCUIApplication {
        ...
        app.launchEnvironment["BMUX_UI_TEST_BROWSER_IMPORT_HINT_DISMISSED"] = "0"
        app.launchEnvironment["BMUX_UI_TEST_BROWSER_IMPORT_HINT_OPEN_BLANK_BROWSER"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_SETTINGS_OPEN_CAPTURE_PATH"] = settingsOpenCapturePath
        launchAndActivate(app)
