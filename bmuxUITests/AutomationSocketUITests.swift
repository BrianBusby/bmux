...
final class AutomationSocketUITests: XCTestCase {
    ...
    private let defaultsDomain = "com.bmuxterm.app.debug"
    ...
    override func setUp() {
        ...
        diagnosticsPath = "/tmp/bmux-ui-test-automation-socket-\(UUID().uuidString).json"
    ...
    func testSocketToggleDisablesAndEnables() {
        let app = configuredApp(mode: "bmuxOnly")
        app.launch()
        XCTAssertTrue(
    ...
    private func makeSkillFixtureRoot(skillNames: [String]) throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-ui-textbox-skills-\(UUID().uuidString)", isDirectory: true)
