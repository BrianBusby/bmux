...
final class UpdatePillUITests: XCTestCase {
    ...
    func testUpdatePillShowsForAvailableUpdate() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_UPDATE_STATE"] = "available"
        app.launchEnvironment["BMUX_UI_TEST_UPDATE_VERSION"] = "9.9.9"
    ...
    func testDetectedBackgroundUpdateShowsPillWithoutManualCheck() {
        ...
        let app = XCUIApplication()
        app.launchEnvironment["BMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_DETECTED_UPDATE_VERSION"] = "9.9.9"
        launchAndActivate(app)
    ...
    func testDetectedBackgroundUpdateFirstClickOpensPopover() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_DETECTED_UPDATE_VERSION"] = "9.9.9"
        app.launchEnvironment["BMUX_UI_TEST_FEED_URL"] = "https://bmux.test/appcast.xml"
        app.launchEnvironment["BMUX_UI_TEST_FEED_MODE"] = "none"
        launchAndActivate(app)
    ...
    func testUpdatePillShowsForNoUpdateThenDismisses() {
        ...
        let timingPath = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-ui-test-timing-\(UUID().uuidString).json")
        let app = XCUIApplication()
        app.launchEnvironment["BMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_UPDATE_STATE"] = "notFound"
        app.launchEnvironment["BMUX_UI_TEST_TIMING_PATH"] = timingPath.path
        launchAndActivate(app)
    ...
    func testCheckForUpdatesShowsLoadingThenNoUpdateInSidebarFooter() {
        ...
        let app = launchAppWithMockFeed(
            ...
            version: "9.9.9",
            extraEnvironment: [
                "BMUX_UI_TEST_MOCK_FEED_DELAY_MS": "7000",
            ]
        )
    ...
    func testNoSparklePermissionDialogIsShown() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_RESET_SPARKLE_PERMISSION"] = "1"
        launchAndActivate(app)
    ...
    func testUpdatePillShowsDownloadingState() {
        ...
        let app = XCUIApplication()
        app.launchEnvironment["BMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_UPDATE_STATE"] = "downloading"
        launchAndActivate(app)
    ...
    func testUpdatePillShowsExtractingState() {
        ...
        let app = XCUIApplication()
        app.launchEnvironment["BMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_UPDATE_STATE"] = "extracting"
        launchAndActivate(app)
    ...
    func testUpdatePillShowsInstallingStateAndRestartPopover() {
        ...
        let app = XCUIApplication()
        app.launchEnvironment["BMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_UPDATE_STATE"] = "installing"
        launchAndActivate(app)
    ...
    func testUpdatePillShowsErrorStateWithRetryAndDetails() {
        ...
        let app = XCUIApplication()
        app.launchEnvironment["BMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_UPDATE_STATE"] = "error"
        launchAndActivate(app)
    ...
    private func launchAppWithMockFeed(
        ...
        app.launchEnvironment["BMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_FEED_URL"] = "https://bmux.test/appcast.xml"
        app.launchEnvironment["BMUX_UI_TEST_FEED_MODE"] = mode
        app.launchEnvironment["BMUX_UI_TEST_UPDATE_VERSION"] = version
        app.launchEnvironment["BMUX_UI_TEST_AUTO_ALLOW_PERMISSION"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_TRIGGER_UPDATE_CHECK"] = "1"
        if let timingPath {
            app.launchEnvironment["BMUX_UI_TEST_TIMING_PATH"] = timingPath.path
        }
...
final class TitlebarShortcutHintsUITests: XCTestCase {
    ...
    private func launchApp(alwaysShowShortcutHints: Bool = false) -> (XCUIApplication, String) {
        let app = XCUIApplication()
        let dataPath = "/tmp/bmux-ui-test-titlebar-shortcut-hints-\(UUID().uuidString).json"
        try? FileManager.default.removeItem(atPath: dataPath)
        app.launchEnvironment["BMUX_UI_TEST_MODE"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_BONSPLIT_TAB_DRAG_SETUP"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_BONSPLIT_TAB_DRAG_PATH"] = dataPath
        if alwaysShowShortcutHints {
            app.launchEnvironment["BMUX_UI_TEST_SHORTCUT_HINTS_ALWAYS_SHOW"] = "1"
        }
