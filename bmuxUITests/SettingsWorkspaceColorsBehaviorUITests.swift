...
/// `Packages/macOS/BmuxSettingsUI/.../Sections/WorkspaceColorsSection.swift`
/// and `Packages/macOS/BmuxSettings/.../Keys/WorkspaceColorsCatalogSection.swift`):
///
...
//   bmux.json, neither reachable from XCUITest without a seam. Verifying
