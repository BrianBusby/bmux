...
final class BrowserOmnibarSuggestionsUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/bmux-ui-test-omnibar-suggestions-\(UUID().uuidString).json"
    ...
    func testOmnibarSuggestionsAlignToPillAndCtrlNP() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_DISABLE_REMOTE_SUGGESTIONS"] = "1"
    ...
    func testOmnibarSuggestionsCtrlNPWhenAddressBarFocused() {
        ...
        app.launchEnvironment["BMUX_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["BMUX_UI_TEST_DISABLE_REMOTE_SUGGESTIONS"] = "1"
        app.launchEnvironment["BMUX_UI_TEST_REMOTE_SUGGESTIONS_JSON"] = #"["go tutorial","go json","go fmt"]"#
        launchAndEnsureForeground(app)
    ...
    func testOmnibarArrowSelectedSuggestionIsCommittedOnEnter() {
        ...
        // (https://github.com/manaflow-ai/bmux/issues/5913). Reach the Gmail
    ...
    func testOmnibarReturnWithoutArrowSelectionNavigatesTypedText() {
        // Regression for https://github.com/manaflow-ai/bmux/issues/5913: a
    ...
    private func launchAndEnsureForeground(_ app: XCUIApplication, timeout: TimeInterval = 12.0) {
        if let browserHistorySeedJSON {
            app.launchEnvironment["BMUX_UI_TEST_BROWSER_HISTORY_JSON"] = browserHistorySeedJSON
        }
        app.launch()
        XCTAssertTrue(
