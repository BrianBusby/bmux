...
Most socket commands should not change the user's macOS focus. A background agent may be running in one workspace while the user is actively using another app or bmux workspace.
