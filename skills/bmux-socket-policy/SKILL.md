---
name: bmux-socket-policy
description: "Socket command threading and focus policy for bmux CLI/socket work. Use when adding or changing socket commands, CLI commands, telemetry commands, focus/select/open/close/send-key behavior, or automation that could steal app focus."
---
