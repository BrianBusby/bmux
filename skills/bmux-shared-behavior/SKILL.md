---
name: bmux-shared-behavior
description: "Shared behavior and mutation-path rules for bmux. Use when a behavior is exposed through multiple entrypoints such as keyboard shortcuts, command palette, context menu, CLI, settings, debug menu, optimistic UI, or tests that previously missed a bug."
---

# bmux Shared Behavior
