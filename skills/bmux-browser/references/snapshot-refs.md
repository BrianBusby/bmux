...
```bash
bmux browser surface:7 snapshot
bmux browser surface:7 snapshot --interactive
bmux browser surface:7 snapshot --interactive --compact --max-depth 3
```

## Using Refs

```bash
bmux browser surface:7 click e6
bmux browser surface:7 fill e10 "user@example.com"
bmux browser surface:7 fill e11 "password123"
bmux browser surface:7 click e12
```
...
bmux browser surface:7 click e1
...
```bash
bmux browser surface:7 wait --selector "#target" --timeout-ms 10000
bmux browser surface:7 scroll --dy 400
bmux browser surface:7 snapshot --interactive
```
...
```bash
bmux browser surface:7 snapshot --selector "form#checkout" --interactive
```
