# Command Reference (bmux Markdown)

## Opening a Markdown Panel

```bash
bmux markdown open <path>
bmux markdown <path>          # shorthand (implicit "open")
```
...
|------|-------------|---------|
| `--workspace <id\|ref\|index>` | Target workspace | `$BMUX_WORKSPACE_ID` |
...
bmux markdown open ./plan.md
bmux markdown open /Users/me/project/plan.md
```
