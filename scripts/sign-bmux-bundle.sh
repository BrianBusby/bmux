#!/usr/bin/env bash
# Inside-out codesign a bmux .app bundle for Developer ID + notarization.
#
# Usage:
#   scripts/sign-bmux-bundle.sh <app-path> <app-entitlements> <signing-identity>
#
# Example:
#   scripts/sign-bmux-bundle.sh \
#     "build-universal/Build/Products/Release/bmux NIGHTLY.app" \
#     bmux.nightly.entitlements \
#     "Developer ID Application: Manaflow, Inc. (7WLXT3NR37)"
#
# Optional env:
#   BMUX_HELPER_ENTITLEMENTS  (default: bmux-helper.entitlements)
#   BMUX_TIMESTAMP             set to "none" for un-timestamped local sigs
#
...
APP_ENTITLEMENTS="$2"
IDENTITY="$3"
HELPER_ENTITLEMENTS="${BMUX_HELPER_ENTITLEMENTS:-bmux-helper.entitlements}"
