#!/usr/bin/env python3
"""Generate / verify the SPM package grouping in bmux.xcworkspace.
...
WORKSPACE_DATA = os.path.join(ROOT, "bmux.xcworkspace", "contents.xcworkspacedata")
...
TOP_LEVEL_PROJECTS = ["group:bmux.xcodeproj", "group:ios/bmux-ios.xcodeproj"]
# The iOS app's own SwiftPM package lives outside Packages/; it heads the iOS
# group.
IOS_APP_PACKAGE_REF = "container:ios/bmuxPackage"
...
EXAMPLES_GROUP = (
    ...
    [
        ...
        "group:BmuxExtensionSidebarExamples",
    ],
)
