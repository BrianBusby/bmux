...
public struct AttentionQueueSidebar: BmuxSidebarProvider {
    public let descriptor = BmuxSidebarProviderDescriptor(
        id: "com.example.bmux.sidebar.attention-queue",
    ...
    private func needsAttention(_ workspace: BmuxSidebarProviderWorkspace) -> Bool {
    ...
    private func rowSubtitle(_ workspace: BmuxSidebarProviderWorkspace) -> BmuxSidebarProviderText? {
        ...
        return trimmed(workspace.customDescription).map(BmuxSidebarProviderText.plain)
    }

    private func hasRemoteTarget(_ workspace: BmuxSidebarProviderWorkspace) -> Bool {
