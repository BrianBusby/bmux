...
public struct SuperCompactSidebar: BmuxSidebarProvider {
    public let descriptor = BmuxSidebarProviderDescriptor(
        id: "com.example.bmux.sidebar.super-compact",
    ...
    private func compactTitle(_ workspace: BmuxSidebarProviderWorkspace) -> String {
    ...
    private func unreadTrailingText(_ workspace: BmuxSidebarProviderWorkspace) -> BmuxSidebarProviderText? {
