...
public struct LastPromptSidebar: BmuxSidebarProvider {
    public let descriptor = BmuxSidebarProviderDescriptor(
        id: "com.example.bmux.sidebar.last-prompt",
    ...
    private func promptSubtitle(_ workspace: BmuxSidebarProviderWorkspace) -> BmuxSidebarProviderText? {
    ...
    private func promptTrailingText(_ workspace: BmuxSidebarProviderWorkspace) -> BmuxSidebarProviderText? {
