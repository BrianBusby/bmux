...
public struct DevServerSidebar: BmuxSidebarProvider {
    public let descriptor = BmuxSidebarProviderDescriptor(
        id: "com.example.bmux.sidebar.dev-servers",
    ...
    private func hasServerSignal(_ workspace: BmuxSidebarProviderWorkspace) -> Bool {
    ...
    private func serverSubtitle(_ workspace: BmuxSidebarProviderWorkspace) -> BmuxSidebarProviderText? {
        if !workspace.listeningPorts.isEmpty {
