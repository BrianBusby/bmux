    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text(String(
                ...
                defaultValue: "Keep this app installed. Enable Tabs Visible Sidebar from bmux Sidebar Extensions, then choose the extension sidebar provider from the sidebar footer puzzle button."
            ))
