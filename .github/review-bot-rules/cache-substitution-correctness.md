...
Background: substituting an opportunistic cache for a fresh load in the close-history snapshot introduced a stale-undo edge (https://github.com/manaflow-ai/bmux/pull/5669); the durable fix made the cache event-driven so it is always current.
