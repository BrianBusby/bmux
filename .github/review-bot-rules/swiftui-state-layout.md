...
- `ObservableObject`, `@Published`, `@StateObject`, or `@EnvironmentObject` for new bmux-owned SwiftUI state where `@Observable` plus `@State` or value snapshots are the modern shape.
