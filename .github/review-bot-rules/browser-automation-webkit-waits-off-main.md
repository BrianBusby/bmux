...
Apply this rule to bmux browser socket automation commands in `Sources/TerminalController.swift` and `Packages/macOS/BmuxControlSocket/Sources/BmuxControlSocket/Wire/ControlCommandExecutionPolicy.swift`.
