# bmux-mux Programmability Contract

This directory is the source of truth for the bmux-mux control protocol, the generated `bmux-mux` command surface, and future generated language bindings. The implemented protocol described here is protocol version 5, as defined by `mux-core/src/server.rs`.
...
| `cli.md` | Generated `bmux-mux <verb>` conventions, exit codes, stdin rules, verb table, and examples |
