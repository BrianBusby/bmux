...
@Suite struct MobileRootAuthGateTests {
    @Test func allowsAttachTicketAuthenticationWithoutStackAuth() throws {
        ...
        let attachURL = try #require(URL(string: "bmux-ios://attach?v=1&payload=test"))
        ...
        let devAttachURL = try #require(URL(string: "bmux-ios-dev://attach?v=2&r=100.64.0.5:58465"))
        let authURL = try #require(URL(string: "stack-auth-mobile-oauth-url://callback?code=test"))
        let otherURL = try #require(URL(string: "bmux-ios://oauth?v=1"))
