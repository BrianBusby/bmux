...
@Suite struct QRCodeFrameSelectionTests {
    private let accepted = "bmux-ios://attach?v=2&r=100.64.0.5:52341"
    private let acceptsPairing: @Sendable (String) -> Bool = { $0.hasPrefix("bmux-ios://") }
    ...
    @Test func firstAcceptedCodeWinsAmongMultiple() {
        let other = "bmux-ios://attach?v=2&r=100.64.0.9:1024"
        let candidates = [
            QRCodeFrameCandidate(isQRCode: true, stringValue: accepted),
