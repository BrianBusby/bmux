...
struct GhosttySurfaceRepresentable: UIViewRepresentable {
    ...
    final class Coordinator: NSObject, GhosttySurfaceViewDelegate {
        let surfaceID: String
        weak var store: BMUXMobileShellStore?
        ...
        init(surfaceID: String, store: BMUXMobileShellStore) {
        ...
        @MainActor
        private func makeComposerController(store: BMUXMobileShellStore) -> UIHostingController<TerminalComposerView> {
