...
import BmuxAgentChatUI
import BmuxMobileBrowser
...
struct WorkspaceDetailView: View {
    ...
    private func copyDebugLogsFromMenu() {
        ...
        Task { @MainActor in
            ...
            NSLog("bmux.terminal copied %d debug log lines + visible terminal to pasteboard", count)
        }
    }
    #endif
    ...
    private var feedbackComposerExplanation: String {
        ...
        return L10n.string(
            ...
            defaultValue: "Emails your feedback to the bmux team, stamped with your app version and device."
        )
    }
