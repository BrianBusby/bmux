...
struct OnboardingPage: Sendable {
    ...
    /// The ordered first-run pages: what bmux is, how it connects (the private
    ...
    private static var whatItIs: OnboardingPage {
        OnboardingPage(
            ...
            body: L10n.string(
                ...
                defaultValue: "bmux runs your terminals and AI coding agents on your Mac. This app lets you watch them, type, and get notified when an agent needs you, right from your phone."
            )
        )
    }
        ...
        OnboardingPage(
            ...
            checklist: [
                ...
                L10n.string(
                    ...
                    defaultValue: "Keep both signed in to the same bmux account too. Pairing checks that they match."
                ),
            ],
            links: [
                OnboardingPageLink(
    ...
    private static var pairNow: OnboardingPage {
        OnboardingPage(
            ...
            body: L10n.string(
                ...
                defaultValue: "Make sure bmux on your Mac is signed in to the same account, then scan the pairing QR code it shows (or enter its address by hand). You only do this once per Mac."
            )
        )
    }
}
