...
/// can confirm which bmux account this device uses — the account must match the
...
struct MobileSettingsView: View {
    ...
    var store: BMUXMobileShellStore?
            ...
            Form {
                Section {
                    ...
                    Text(L10n.string(
                        ...
                        defaultValue: "This device must be signed in to the same bmux account as the computer you pair with."
                    ))
                }
