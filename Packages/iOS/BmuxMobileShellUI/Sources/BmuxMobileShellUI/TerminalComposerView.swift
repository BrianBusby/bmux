...
struct TerminalComposerView: View {
    ...
    init(store: BMUXMobileShellStore, terminalID: String, requestHeightRemeasure: @escaping () -> Void) {
        self.store = store
    ...
    private nonisolated static let maxImageBytes = BMUXMobileShellStore.maxPendingAttachmentImageBytes
    ...
    private static let maxAttachmentCount = BMUXMobileShellStore.maxPendingAttachmentCount
    ...
    private static let maxTotalAttachmentBytes = BMUXMobileShellStore.maxPendingAttachmentTotalBytes
    ...
    static var transferRepresentation: some TransferRepresentation {
        FileRepresentation(contentType: .image) { imported in
            ...
            let destination = FileManager.default.temporaryDirectory
                .appendingPathComponent("bmux-composer-import-" + name)
