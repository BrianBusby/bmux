...
extension WorkspaceListView {
    ...
    @discardableResult
    func selectWorkspaceFromList(_ id: BmuxMobileShellModel.MobileWorkspacePreview.ID) -> Task<Void, Never>? {
    ...
    var requestWorkspaceClose: ((BmuxMobileShellModel.MobileWorkspacePreview.ID) -> Void)? {
    ...
    func closeConfirmationBinding(for workspaceID: BmuxMobileShellModel.MobileWorkspacePreview.ID) -> Binding<Bool> {
        Binding(
