...
extension MacComputerSnapshot {
    ...
    /// shows and the one ``BMUXMobileShellStore/forgetMac`` actually removes.
    ...
    @MainActor
    static func snapshots(from store: BMUXMobileShellStore) -> [MacComputerSnapshot] {
    ...
    /// (bmux PR https://github.com/manaflow-ai/bmux/pull/6772) left one stored
