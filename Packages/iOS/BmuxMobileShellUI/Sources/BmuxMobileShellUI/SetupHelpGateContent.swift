...
struct SetupHelpGateContent {
    ...
    /// Founders Edition page: bmux for Mac download plus TestFlight enrollment,
    /// used by the "Run bmux on your Mac" gate.
    private static let setupHelpMacDownloadURL = URL(string: "https://github.com/manaflow-ai/bmux#founders-edition")!
    ...
    static func content(for gate: MobileSetupGuidanceState) -> SetupHelpGateContent {
        ...
        case .notSignedIn:
            return SetupHelpGateContent(
                ...
                body: L10n.string(
                    ...
                    defaultValue: "Sign in to bmux on this phone with the same account the paired computer uses. Without that, there is nothing to connect to."
                ),
                link: nil,
        ...
        case .signedInNeverPaired:
            return SetupHelpGateContent(
                ...
                title: L10n.string("mobile.setupHelp.macAppTitle", defaultValue: "Run bmux on your computer"),
                body: L10n.string(
                    "mobile.setupHelp.macAppBody",
                    defaultValue: "Install bmux on your computer and leave it running, signed in to the same account. The phone pairs to a running bmux build, so a quit or never-installed app is the most common reason pairing does nothing."
                ),
                link: SetupHelpGateLink(
                    title: L10n.string("mobile.setupHelp.macAppLink", defaultValue: "Download bmux"),
        ...
        case .macUnreachable:
            return SetupHelpGateContent(
                ...
                body: L10n.string(
                    ...
                    defaultValue: "You have paired this computer before but it is not reachable now. Wake it, make sure bmux is running, and confirm both devices are on the same tailnet or Wi-Fi. Then reconnect."
                ),
                link: nil,
        ...
        case .accountMismatch:
            return SetupHelpGateContent(
                ...
                body: L10n.string(
                    ...
                    defaultValue: "If the computer rejects this device's sign-in, the two are on different bmux accounts or this device's session is stale. Sign this phone in to the computer's account (or sign the computer in to this one), then pair again."
                ),
                link: nil,
