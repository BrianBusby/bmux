...
public final class MobileDisplaySettings {
    ...
    private static let wrapWorkspaceTitlesKey = "bmux.mobile.wrapWorkspaceTitles"
    private static let workspacePreviewLineCountKey = "bmux.mobile.workspacePreviewLineCount"
    private static let unreadIndicatorLeftShiftKey = "bmux.mobile.debug.unreadIndicatorLeftShift.v2"
    private static let profilePictureLeftShiftKey = "bmux.mobile.debug.profilePictureLeftShift"
    private static let profilePictureSizeKey = "bmux.mobile.debug.profilePictureSize"
