...
extension MobileMacConnectionStatus {
    ...
    var description: String {
        ...
        case .reconnecting:
            return L10n.string("mobile.connection.reconnectingDescription", defaultValue: "Trying to reach the selected bmux build.")
        case .unavailable:
            return L10n.string("mobile.connection.unavailableDescription", defaultValue: "The live connection dropped. The selected bmux build may still be online. Tap Reconnect.")
        }
    }
