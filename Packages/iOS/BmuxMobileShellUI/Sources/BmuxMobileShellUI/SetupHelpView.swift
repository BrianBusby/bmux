    ...
    private var networkSection: some View {
        Section {
            ...
            Text(L10n.string(
                ...
                defaultValue: "The computer and this phone must be signed in to the same bmux account, and on the same tailnet (or the same Wi-Fi for a manual local connection)."
            ))
        }
