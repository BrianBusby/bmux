...
struct WorkspaceDetailDelayedTerminalPreviewView: View {
    ...
    private static var usesLongTitle: Bool {
        ProcessInfo.processInfo.environment["BMUX_UITEST_WORKSPACE_DETAIL_LONG_TITLE"] == "1"
    }

    private static var showsChatToggle: Bool {
        ProcessInfo.processInfo.environment["BMUX_UITEST_WORKSPACE_DETAIL_CHAT_TOGGLE"] == "1"
    }
