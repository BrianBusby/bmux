...
@Suite struct MobileDisplaySettingsTests {
    ...
    @Test func previewLineCountDefaultsToTwoWithoutAWrite() throws {
        ...
        #expect(defaults.object(forKey: "bmux.mobile.workspacePreviewLineCount") == nil)
    }
    ...
    @Test func previewLineCountClampsToSupportedRange() throws {
        ...
        defaults.set(-5, forKey: "bmux.mobile.workspacePreviewLineCount")
        #expect(MobileDisplaySettings(defaults: defaults).workspacePreviewLineCount == 1)
    }
    ...
    @Test func debugLayoutSettingsDefaultWithoutAWrite() throws {
        ...
        #expect(defaults.object(forKey: "bmux.mobile.debug.unreadIndicatorLeftShift.v2") == nil)
        #expect(defaults.object(forKey: "bmux.mobile.debug.profilePictureLeftShift") == nil)
        #expect(defaults.object(forKey: "bmux.mobile.debug.profilePictureSize") == nil)
    }
    ...
    @Test func debugLayoutSettingsClampToSupportedRanges() throws {
        ...
        defaults.set(-5.0, forKey: "bmux.mobile.debug.unreadIndicatorLeftShift.v2")
        defaults.set(99.0, forKey: "bmux.mobile.debug.profilePictureLeftShift")
        defaults.set(1.0, forKey: "bmux.mobile.debug.profilePictureSize")
        let reloaded = MobileDisplaySettings(defaults: defaults)
