...
private let analyticsUploadLog = Logger(subsystem: "dev.bmux.ios", category: "analytics-upload")

/// An ``AnalyticsUploading`` that POSTs batches to the bmux web analytics proxy.
///
...
public struct HTTPAnalyticsUploader: AnalyticsUploading {
    ...
    ///
    /// - Parameters:
    ///   - apiBaseURL: The bmux web API base URL, no trailing slash (resolved at
