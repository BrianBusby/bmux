...
@Suite struct IOSBuildScopedPairedMacStoreTests {
    ...
    @Test func currentScopePrefersInstalledBundleSuffix() {
        #expect(MobileIOSBuildScope.current(infoDictionary: ["BMUXDevTag": "feat"], bundleIdentifier: "dev.bmux.ios.other")?.value == "other")
        #expect(MobileIOSBuildScope.current(infoDictionary: ["BMUXDevTag": ""], bundleIdentifier: "dev.bmux.ios.agent")?.value == "agent")
        #expect(MobileIOSBuildScope.current(infoDictionary: ["BMUXDevTag": ""], bundleIdentifier: "dev.bmux.ios") == nil)
