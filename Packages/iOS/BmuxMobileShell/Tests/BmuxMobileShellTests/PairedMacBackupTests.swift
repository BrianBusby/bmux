...
@Suite struct PairedMacBackupTests {
    ...
    @Test func flagResolvesEnvThenDefaultsThenBuild() {
        #expect(MobilePairedMacBackup.resolved(environment: ["BMUX_MOBILE_PAIRED_MAC_BACKUP": "1"], defaults: .standard, isDebugBuild: false).isEnabled)
        #expect(!MobilePairedMacBackup.resolved(environment: ["BMUX_MOBILE_PAIRED_MAC_BACKUP": "0"], defaults: .standard, isDebugBuild: true).isEnabled)
