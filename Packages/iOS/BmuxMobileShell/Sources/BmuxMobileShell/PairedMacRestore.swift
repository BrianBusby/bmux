...
private let pairedMacRestoreLog = Logger(subsystem: "com.bmuxterm.app", category: "PairedMacRestore")
...
public struct PairedMacRestore: Sendable {
    ...
    ///   already server-scoped to that team (`X-Bmux-Team-Id`), so every restored
