...
/// The iOS implementation of ``BmuxAgentChat/ChatEventSource``: adapts the
...
/// ``BmuxAgentChat/ChatConversationStore`` resubscribes through its `run()`
/// loop.
public actor MobileChatEventSource: ChatEventSource {
    ...
    ///
    /// Not part of ``BmuxAgentChat/ChatEventSource`` (which is scoped to one
