...
/// Default ``MobileFeedbackEmailSubmitting`` that POSTs to the bmux web
...
public struct MobileFeedbackEmailClient: MobileFeedbackEmailSubmitting {
    ...
    /// - Parameters:
    ///   - apiBaseURL: The bmux web API base URL with no trailing slash (e.g.
    ///     `https://bmux.dev`). `/api/feedback` is appended.
