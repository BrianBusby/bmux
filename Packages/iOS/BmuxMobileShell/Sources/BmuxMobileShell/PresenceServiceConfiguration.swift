...
extension PresenceClient {
    /// Env override, mirroring the Mac's `BMUX_PRESENCE_BASE_URL`.
    public static let serviceURLEnvKey = "BMUX_PRESENCE_BASE_URL"
    ...
    /// `BMUX_PRESENCE_BASE_URL`) to point the build at a per-developer isolated
    ...
    /// instance.
    public static let serviceURLInfoPlistKey = "BMUXPresenceBaseURL"
    /// The dev/staging worker (dev Stack project); see workers/presence/README.md.
    public static let debugDefaultServiceURL = "https://bmux-presence-dev.debussy.workers.dev"
    ...
    public static let productionServiceURL = "https://presence.bmux.dev"
