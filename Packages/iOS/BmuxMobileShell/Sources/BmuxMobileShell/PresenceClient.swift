...
///
/// This is the typed client for the bmux device presence service
/// (`workers/presence`), the realtime online/offline layer over the durable
/// device registry, and the seam for the iOS device tree
/// (https://github.com/manaflow-ai/bmux/pull/5648): the tree renders the
...
/// plus optional `X-Bmux-Team-Id`, with tokens supplied through
/// ``PresenceTokenSource``.
///
...
public actor PresenceClient {
    ...
    ///     the deployed bmux-presence worker URL.
