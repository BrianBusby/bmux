...
private let pairedMacStoreLog = Logger(subsystem: "com.bmuxterm.app", category: "PairedMacStore")
...
public actor MobilePairedMacStore: MobilePairedMacStoring {
    ...
    /// - Returns: The `paired-macs.sqlite3` URL under Application Support/bmux.
