/// A per-window bmux configuration store that can re-read its backing file.
///
/// The app target's `BmuxConfigStore` conforms to this so
/// `BmuxConfigStoreReloadCoordinator` can drive reloads without depending on the
...
@MainActor
public protocol BmuxConfigStoreReloading: AnyObject {
...
@MainActor
public protocol BmuxConfigStoreReloadEnvironment: AnyObject {
    ...
    var reloadableConfigStores: [any BmuxConfigStoreReloading] { get }
