...
/// keys bmux maps to a menu-style shortcut glyph.
///
...
/// package without importing GhosttyKit. Any Ghostty physical key bmux does not
...
public enum GhosttyTriggerPhysicalKey: String, Sendable, Equatable, Hashable, CaseIterable {
    ...
    /// The menu-style glyph bmux renders for this physical key.
    ///
