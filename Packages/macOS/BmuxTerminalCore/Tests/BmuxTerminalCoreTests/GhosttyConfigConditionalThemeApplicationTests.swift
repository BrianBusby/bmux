...
/// Regression coverage for https://github.com/manaflow-ai/bmux/issues/6411.
///
/// bmux paints the terminal background from its host layer
...
/// cross-side fell back to the other appearance's theme, bmux painted a light
...
@Suite struct GhosttyConfigConditionalThemeApplicationTests {
    ...
    private func makeThemesRoot() throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-6411-\(UUID().uuidString)", isDirectory: true)
