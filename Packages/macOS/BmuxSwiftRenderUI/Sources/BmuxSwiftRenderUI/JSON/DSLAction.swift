...
struct DSLAction: Codable, Equatable, Sendable {
    ...
    /// - any other `type` is treated as a bmux dispatcher method
    ///   (``ActionCommand/bmux(method:params:)`` with no params).
    var buttonAction: ButtonAction {
        ...
        default:
            return ButtonAction(commands: [.bmux(method: type, params: [:])])
        }
    }
}
