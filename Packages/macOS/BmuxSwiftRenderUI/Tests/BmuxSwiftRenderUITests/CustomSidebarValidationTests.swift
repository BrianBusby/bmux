...
import Foundation
import Testing
@testable import BmuxSwiftRenderUI
...
struct CustomSidebarValidationTests {
    ...
    private func temporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-sidebar-validation-\(UUID().uuidString)", isDirectory: true)
    ...
    private static let richSidebarContext: [String: SwiftValue] = [
        ...
        "selectedTitle": .string("bmux"),
        "selectedId": .string("workspace-bmux"),
        "unreadTotal": .int(4),
        "clock": .object([
        ...
        "workspaces": .array([
            .object([
                "id": .string("workspace-bmux"),
                "title": .string("bmux"),
                "selected": .bool(true),
                "pinned": .bool(true),
                "index": .int(0),
                "directory": .string("/Users/me/src/bmux"),
                ...
                "pr": .object([
                    ...
                    "url": .string("https://github.com/manaflow-ai/bmux/pull/5812"),
                    "status": .string("open"),
                    "stale": .bool(false),
                    "branch": .string("fix-crash-on-launch"),
                ]),
                ...
                "tabs": .array([
                    ...
                    .object([
                        ...
                        "focused": .bool(false),
                        "pinned": .bool(true),
                        "directory": .string("/Users/me/src/bmux/web"),
                        "branch": .string("fix-crash-on-launch"),
                        "dirty": .bool(false),
            ...
            .object([
                ...
                "pr": .object([
                    ...
                    "url": .string("https://github.com/manaflow-ai/bmux/pull/5801"),
