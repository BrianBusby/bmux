...
@Suite struct GitSlugAndConfigTests {
    @Test(arguments: [
        "git@github.com:manaflow-ai/bmux.git",
        "ssh://git@github.com/manaflow-ai/bmux.git",
        "https://github.com/manaflow-ai/bmux.git",
        "http://github.com/manaflow-ai/bmux",
        "git://github.com/manaflow-ai/bmux.git",
        "https://github.com/manaflow-ai/bmux",
    ])
    func parsesGitHubRemoteForms(url: String) {
        #expect(GitMetadataService.githubRepositorySlug(fromRemoteURL: url) == "manaflow-ai/bmux")
    }
