...
@Suite struct PullRequestProbeServiceTests {
    ...
    @Test func preferredPullRequestPrefersOpenOverMergedAndClosed() {
        let candidates = [
            item(number: 1889, state: "MERGED", url: "https://github.com/manaflow-ai/bmux/pull/1889", updatedAt: "2026-03-20T18:00:00Z"),
            item(number: 1891, state: "OPEN", url: "https://github.com/manaflow-ai/bmux/pull/1891", updatedAt: "2026-03-19T18:00:00Z"),
            item(number: 1800, state: "CLOSED", url: "https://github.com/manaflow-ai/bmux/pull/1800", updatedAt: "2026-03-21T18:00:00Z"),
        ]
    ...
    @Test func preferredPullRequestPrefersMostRecentlyUpdatedWithinSameStatus() {
        let olderOpen = item(number: 1880, state: "OPEN", url: "https://github.com/manaflow-ai/bmux/pull/1880", updatedAt: "2026-03-18T18:00:00Z")
        let newerOpen = item(number: 1890, state: "OPEN", url: "https://github.com/manaflow-ai/bmux/pull/1890", updatedAt: "2026-03-20T18:00:00Z")
    ...
    @Test func preferredPullRequestIgnoresMalformedCandidates() {
        let valid = item(number: 1888, state: "OPEN", url: "https://github.com/manaflow-ai/bmux/pull/1888", updatedAt: "2026-03-20T18:00:00Z")
        let preferred = PullRequestProbeService.preferredPullRequest(from: [
            item(number: 9999, state: "WHATEVER", url: "https://github.com/manaflow-ai/bmux/pull/9999", updatedAt: "2026-03-21T18:00:00Z"),
    ...
    @Test func pullRequestMapDropsStaleMergedHeadPullRequestForLongLivedBaseBranch() throws {
        ...
        let pullRequests = [
            item(number: 2400, state: "MERGED", url: "https://github.com/manaflow-ai/bmux/pull/2400", updatedAt: "2026-03-06T12:00:00Z", mergedAt: "2026-03-06T12:00:00Z", headRefName: "develop", baseRefName: "main"),
            item(number: 2501, state: "MERGED", url: "https://github.com/manaflow-ai/bmux/pull/2501", updatedAt: "2026-04-19T12:00:00Z", mergedAt: "2026-04-19T12:00:00Z", headRefName: "feature/recent-one", baseRefName: "develop"),
            item(number: 2502, state: "OPEN", url: "https://github.com/manaflow-ai/bmux/pull/2502", updatedAt: "2026-04-20T12:00:00Z", headRefName: "feature/recent-two", baseRefName: "develop"),
        ]
    ...
    @Test func decodesRESTItemsAndSynthesizesMergedState() throws {
        ...
        #expect(items[1].url == "https://github.com/manaflow-ai/bmux/pull/5293")
    }

    @Test func branchEndpointEncodesHeadFilterAndRejectsMalformedSlugs() throws {
        let endpoint = try #require(
            PullRequestProbeService.branchEndpoint(repoSlug: "manaflow-ai/bmux", branch: "feat/x")
        )
        #expect(endpoint.hasPrefix("repos/manaflow-ai/bmux/pulls?"))
