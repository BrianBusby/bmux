...
@Suite struct SentryScrubberTests {
    ...
    @Test func redactsInjectedHomeDirectory() {
        #expect(
            scrubber.scrub("loaded /Users/lawrence/.config/bmux/bmux.json")
                == "loaded /Users/<redacted>/.config/bmux/bmux.json"
        )
    }
    ...
    @Test func redactsAnyUsersPathEvenWhenNotTheRuntimeHome() {
        ...
        #expect(
            scrubber.scrub("/Users/buildbot/work/bmux/Sources/AppDelegate.swift")
                == "/Users/<redacted>/work/bmux/Sources/AppDelegate.swift"
        )
    }

    @Test func redactsLinuxHomePaths() {
        #expect(
            scrubber.scrub("at /home/runner/bmux/main.swift line 12")
                == "at /home/<redacted>/bmux/main.swift line 12"
        )
    }
    ...
    @Test func leavesSystemPathsUntouched() {
        let input = "/usr/lib/foo /System/Library/bar /Applications/bmux.app"
    ...
    @Test func redactsEmailAddresses() {
        #expect(
            scrubber.scrub("signed in as lawrence@bmux.com today")
    ...
    @Test func scrubsNestedDictionaryValues() {
        let input: [String: Any] = [
            "cwd": "/Users/lawrence/dev/bmux",
            "email": "lawrence@bmux.com",
            "count": 7,
            "nested": ["url": "https://x.com/?token=abcdef0123456789secret"] as [String: Any],
        ]
        let output = scrubber.scrub(dictionary: input)
        #expect(output["cwd"] as? String == "/Users/<redacted>/dev/bmux")
    ...
    @Test func combinedSecretEmailAndPathInOneString() {
        let input = "user lawrence@bmux.com opened /Users/lawrence/secret.txt with token=abcdef0123456789zz"
        #expect(
