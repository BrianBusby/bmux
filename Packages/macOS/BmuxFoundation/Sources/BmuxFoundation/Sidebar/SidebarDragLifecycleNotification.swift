...
public struct SidebarDragLifecycleNotification {
    ...
    public static let stateDidChange = Notification.Name("bmux.sidebarDragStateDidChange")
    /// Posted to request that any in-flight sidebar drag state be cleared.
    public static let requestClear = Notification.Name("bmux.sidebarDragRequestClear")
