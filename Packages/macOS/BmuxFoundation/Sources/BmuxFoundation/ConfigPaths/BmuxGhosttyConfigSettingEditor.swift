...
/// Reads and writes bmux's numeric Ghostty config settings (sidebar and
...
public struct BmuxGhosttyConfigSettingEditor {
    ...
    /// The smallest sidebar font size bmux allows.
    public static let minSidebarFontSize = 10.0
    /// The largest sidebar font size bmux allows.
    ...
    /// The smallest surface-tab-bar font size bmux allows.
    public static let minSurfaceTabBarFontSize = 8.0
    /// The largest surface-tab-bar font size bmux allows.
