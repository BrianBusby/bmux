...
/// Regression coverage for https://github.com/manaflow-ai/bmux/issues/6292: tagged DEV and
...
@Suite struct DevStagingUpdateGatingTests {
    ...
    @Test func classifiesDebugAndStagingBundlesAsDevLike() {
        #expect(UpdateController.isDevLikeBundleIdentifier("com.bmuxterm.app.debug"))
        #expect(UpdateController.isDevLikeBundleIdentifier("com.bmuxterm.app.debug.my-tag"))
        #expect(UpdateController.isDevLikeBundleIdentifier("com.bmuxterm.app.staging"))
        #expect(UpdateController.isDevLikeBundleIdentifier("com.bmuxterm.app.staging.my-tag"))
    }

    @Test func doesNotClassifyPublicOrNightlyOrNilAsDevLike() {
        #expect(!UpdateController.isDevLikeBundleIdentifier("com.bmuxterm.app"))
        ...
        #expect(!UpdateController.isDevLikeBundleIdentifier("com.bmuxterm.app.debugger"))
        #expect(!UpdateController.isDevLikeBundleIdentifier("com.bmuxterm.app.stagingx"))
    }
    ...
    @Test func devLikeBundleManualCheckIsSuppressed() throws {
        let suiteName = "com.bmuxterm.updatertests.\(UUID().uuidString)"
