...
/// replayed onto the model exactly as the production `bmux-update.log` recorded them.
///
...
/// NIGHTLY double-idle install loop (https://github.com/manaflow-ai/bmux/pull/7174).
@MainActor
@Suite struct UpdateControllerPipelineTests {
    ...
    /// The production bug, replayed end to end from the user's `bmux-update.log`: Install is
