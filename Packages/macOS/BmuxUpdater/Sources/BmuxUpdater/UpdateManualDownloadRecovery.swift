...
public struct UpdateManualDownloadRecovery: Sendable {
    ...
    public init(
        stableDownloadURLString: String = "https://github.com/manaflow-ai/bmux/releases/latest/download/bmux-macos.dmg",
        nightlyDownloadURLString: String = "https://github.com/manaflow-ai/bmux/releases/download/nightly/bmux-nightly-macos.dmg"
    ) {
    ...
    ///
    /// Returned for installation, extraction, resume, and download failures, including bmux's
