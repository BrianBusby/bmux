...
///
/// Stable releases ship with the stable appcast URL and `bmux NIGHTLY` has the nightly
...
public struct UpdateFeedResolver: Sendable {
    ...
    public init(fallbackFeedURL: String = "https://github.com/manaflow-ai/bmux/releases/latest/download/appcast.xml") {
