...
///
/// DEBUG-only test scaffolding. The feed contents are driven by `BMUX_UI_TEST_*` environment
/// variables.
final class UpdateTestURLProtocol: URLProtocol {
    static let host = "bmux.test"
    static let appcastPath = "/appcast.xml"
    static let updatePath = "/bmux-test.zip"
    ...
    private static func appcastData() -> Data {
        ...
        let mode = env["BMUX_UI_TEST_FEED_MODE"] ?? "available"
