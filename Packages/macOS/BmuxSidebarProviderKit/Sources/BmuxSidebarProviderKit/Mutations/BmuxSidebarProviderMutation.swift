...
public enum BmuxSidebarProviderMutation: Codable, Equatable, Sendable {
    /// Select a workspace.
    ...
    case moveWorkspace(BmuxSidebarProviderWorkspaceMove)
    /// Present host UI or a URL.
    case present(BmuxSidebarProviderPresentationRequest)
}
