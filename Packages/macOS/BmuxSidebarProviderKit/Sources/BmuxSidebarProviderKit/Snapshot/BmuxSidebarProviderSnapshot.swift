...
/// Snapshot of BMUX workspace state consumed by in-process sidebar providers.
public struct BmuxSidebarProviderSnapshot: Codable, Equatable, Sendable {
    /// Monotonic snapshot sequence.
    public var sequence: UInt64
    /// Currently selected workspace id, if any.
    public var selectedWorkspaceId: UUID?
    /// Workspaces visible to providers.
    public var workspaces: [BmuxSidebarProviderWorkspace]
    ...
    public init(
        ...
        workspaces: [BmuxSidebarProviderWorkspace],
        windowId: UUID? = nil
    ) {
