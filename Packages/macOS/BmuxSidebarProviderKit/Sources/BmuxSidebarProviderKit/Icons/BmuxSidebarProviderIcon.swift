...
public struct BmuxSidebarProviderIcon: Codable, Equatable, Sendable {
    ...
    /// Background shape.
    public var shape: BmuxSidebarProviderIconShape
    ...
    public init(
        ...
        shape: BmuxSidebarProviderIconShape = .circle
    ) {
