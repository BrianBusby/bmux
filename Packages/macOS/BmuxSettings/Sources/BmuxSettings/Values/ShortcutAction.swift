...
/// The stable, user-customisable shortcut actions bmux exposes.
///
...
/// identifier persisted in bmux.json.
...
extension ShortcutAction {
    ...
    ///
    /// Most bmux-owned shortcuts require a modifier on the first stroke to avoid
