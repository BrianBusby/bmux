...
public struct RightSidebarWidthSettings: Sendable {
    ...
    /// The `bmux.json` key under `sidebar` that stores the right sidebar maximum width.
    ...
    /// The largest width accepted by settings editors and imported `bmux.json` values.
