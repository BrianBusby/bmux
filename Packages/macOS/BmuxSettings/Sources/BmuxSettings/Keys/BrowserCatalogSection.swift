...
public struct BrowserCatalogSection: SettingCatalogSection {
    ...
    public let openTerminalLinksInBmuxBrowser = DefaultsKey<Bool>(
        id: "browser.openTerminalLinksInBmuxBrowser",
        defaultValue: true,
        userDefaultsKey: "browserOpenTerminalLinksInBmuxBrowser"
    )

    public let interceptTerminalOpenCommandInBmuxBrowser = DefaultsKey<Bool>(
        id: "browser.interceptTerminalOpenCommandInBmuxBrowser",
        defaultValue: true,
        userDefaultsKey: "browserInterceptTerminalOpenCommandInBmuxBrowser"
    )
    ...
    /// "Enable bmux Browser" toggle was a no-op until this was aligned.)
