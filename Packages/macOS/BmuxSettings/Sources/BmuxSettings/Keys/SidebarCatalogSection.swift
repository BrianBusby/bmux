...
public struct SidebarCatalogSection: SettingCatalogSection {
    ...
    /// shipped bmux build; using an enum here would silently revert
    ...
    public let openPullRequestLinksInBmuxBrowser = DefaultsKey<Bool>(
        id: "sidebar.openPullRequestLinksInBmuxBrowser",
        defaultValue: true,
        userDefaultsKey: "browserOpenSidebarPullRequestLinksInBmuxBrowser"
    )

    public let openPortLinksInBmuxBrowser = DefaultsKey<Bool>(
        id: "sidebar.openPortLinksInBmuxBrowser",
        defaultValue: true,
        userDefaultsKey: "browserOpenSidebarPortLinksInBmuxBrowser"
    )
