...
/// A strongly-typed handle to a setting persisted in the bmux JSON config file.
///
/// `JSONKey` is one of two key flavors in ``BmuxSettings``; the other is
...
public struct JSONKey<Value: SettingCodable>: Sendable, Equatable {
    /// The dotted identifier (also the JSON path inside the bmux config file).
