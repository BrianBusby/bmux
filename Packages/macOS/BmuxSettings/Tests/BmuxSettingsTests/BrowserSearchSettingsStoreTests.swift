...
struct BrowserSearchSettingsStoreTests {
    ...
    @Test func validatesAndRendersSearchURLTemplates() throws {
        ...
        #expect(placeholderURL.absoluteString.contains("src=bmux"))
        #expect(appendedURL.absoluteString.contains("source=bmux"))
        ...
        #expect(!store.isValidSearchURLTemplate("bmux://search?q={query}"))
    ...
    private func makeDefaults() throws -> (UserDefaults, String) {
        let suiteName = "bmux.browserSearchSettingsStoreTests.\(UUID().uuidString)"
