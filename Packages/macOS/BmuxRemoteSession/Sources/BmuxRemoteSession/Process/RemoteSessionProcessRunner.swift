...
public struct RemoteSessionProcessRunner: RemoteSessionProcessRunning {
    ...
    public func run(
        ...
        let captureQueue = DispatchQueue(label: "bmux.remote.process.capture")
        ...
        do {
            ...
            throw NSError(domain: "bmux.remote.process", code: 1, userInfo: [
        ...
        if !didExitBeforeTimeout, process.isRunning {
            ...
            throw NSError(domain: "bmux.remote.process", code: 2, userInfo: [
