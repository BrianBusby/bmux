...
public import BmuxTerminalCore
#if DEBUG
...
public final class TerminalSurface: Identifiable, ObservableObject {
    ...
    // The surface value DTOs live in BmuxTerminalCore; these aliases keep the
    // nested TerminalSurface.NamedKeySendResult/.InputSendResult names that
    // other files use.
    public typealias NamedKeySendResult = BmuxTerminalCore.NamedKeySendResult
    public typealias InputSendResult = BmuxTerminalCore.InputSendResult
    ...
    public typealias BmuxContextEnvironment = TerminalSurfaceBmuxContextEnvironment
    ...
    /// Port ordinal base/range for BMUX_PORT assignment, snapshotted by the app composition root.
    ...
    /// bmux renderer reclamation: whether the current runtime surface's GPU
    ...
    let configTemplate: BmuxSurfaceConfigTemplate?
    ...
    /// The retained byte-tee lease for the libghostty PTY tee callback (bmux
