...
extension TerminalSurface {
...
#if DEBUG
    static let surfaceLogPath = "/tmp/bmux-ghostty-surface.log"
    static let sizeLogPath = "/tmp/bmux-ghostty-size.log"
    ...
    static func sizeLog(_ message: String) {
        ...
        guard env["BMUX_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] == "1" else { return }
        let timestamp = ISO8601DateFormatter().string(from: Date())
        let line = "[\(timestamp)] \(message)\n"
