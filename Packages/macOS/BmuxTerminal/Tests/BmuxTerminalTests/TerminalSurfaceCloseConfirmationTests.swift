...
@_silgen_name("bmux_test_ghostty_runtime_stubs_reset")
private func resetGhosttyRuntimeStubs()

@_silgen_name("bmux_test_ghostty_runtime_stubs_set_close_state")
        ...
        return TerminalSurface(
            ...
            dependencies: TerminalSurfaceRuntimeDependencies(
                ...
                runtimeFilesystem: TerminalSurfaceRuntimeFilesystem(
                    claudeCommandShimTemporaryDirectory: URL(fileURLWithPath: "/tmp/bmux-terminal-tests", isDirectory: true),
                    installClaudeCommandShim: { _, _, _ in nil },
                    isExecutableFile: { _ in false }
                ),
                sessionPortBase: 40_000,
                sessionPortRangeSize: 100,
                scrollbackReplayEnvironmentKey: "BMUX_TEST_SCROLLBACK_REPLAY"
            )
        )
    }
