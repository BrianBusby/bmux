...
public final class NotificationDeliveryCoordinator {
    ...
    func notificationCategories() -> Set<UNNotificationCategory> {
        ...
        let permissionCategories = feedPermissionNotificationCategoryIds().map { categoryId in
            ...
            if categoryId.contains("Once") || categoryId == "BMUXFeedPermission" {
                actions.append(permissionOnceAction)
            }
            if categoryId.contains("Always") || categoryId == "BMUXFeedPermission" {
    ...
    private func feedPermissionNotificationCategoryIds() -> [String] {
        [
            "BMUXFeedPermission",
            "BMUXFeedPermissionDeny",
            "BMUXFeedPermissionOnce",
            "BMUXFeedPermissionAlways",
            "BMUXFeedPermissionAll",
            "BMUXFeedPermissionOnceAlways",
            "BMUXFeedPermissionOnceAll",
            "BMUXFeedPermissionAlwaysAll",
            "BMUXFeedPermissionOnceAlwaysAll",
        ]
    }
    ...
    private func handleFeedNotificationResponse(_ response: NotificationDeliveryResponse) -> Bool {
        ...
        guard categoryId.hasPrefix("BMUXFeedPermission")
