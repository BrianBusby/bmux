...
// WorkspaceRemoteConfiguration in BmuxCore.
extension RemoteDaemonRPCClient {
    func startViaSSHExec() throws {
        ...
        do {
            ...
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 1, userInfo: [
    ...
    func startViaBakedVMSocketForward() throws {
        ...
        do {
            ...
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 18, userInfo: [
        ...
        if let startupFailure = Self.startupFailureDetail(
            ...
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 19, userInfo: [
        ...
        do {
            ...
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 20, userInfo: [
    ...
    func startViaWebSocket() throws {
        guard let endpoint = configuration.daemonWebSocketEndpoint else {
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 23, userInfo: [
        ...
        guard let url = URL(string: endpoint.url),
            ...
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 24, userInfo: [
        ...
        guard delegate.waitForOpen(timeout: 15.0) else {
            ...
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 25, userInfo: [
        ...
        do {
            ...
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 26, userInfo: [
    ...
    static func allocateLoopbackPort() throws -> Int {
        ...
        throw NSError(domain: "bmux.remote.daemon.rpc", code: 21, userInfo: [
    ...
    static func connectLoopbackSocket(port: Int) throws -> FileHandle {
        guard port > 0 && port <= 65535 else {
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 22, userInfo: [
