...
extension RemoteDaemonRPCClient {
    ...
    public func openStream(host: String, port: Int, timeoutMs: Int = 10000) throws -> String {
        ...
        guard !streamID.isEmpty else {
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 3, userInfo: [
    ...
    public func attachStream(
        ...
        guard !trimmedStreamID.isEmpty else {
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 17, userInfo: [
    ...
    public func attachPTY(
        ...
        guard !trimmedSessionID.isEmpty else {
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 28, userInfo: [
                NSLocalizedDescriptionKey: "pty.attach requires session_id",
            ])
        }
        guard !trimmedAttachmentID.isEmpty else {
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 29, userInfo: [
    ...
    func call(method: String, params: [String: Any], timeout: TimeInterval) throws -> [String: Any] {
        ...
        do {
            ...
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 10, userInfo: [
        ...
        case .timedOut:
            ...
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 11, userInfo: [
                NSLocalizedDescriptionKey: "daemon RPC timeout waiting for \(method) response",
            ])
        case .failure(let failure):
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 12, userInfo: [
                NSLocalizedDescriptionKey: failure,
            ])
        case .missing:
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 13, userInfo: [
        ...
        throw NSError(domain: "bmux.remote.daemon.rpc", code: 14, userInfo: [
    ...
    func writePayload(_ payload: Data) throws {
        ...
        if let webSocketTask {
            guard let text = String(data: payload, encoding: .utf8) else {
                throw NSError(domain: "bmux.remote.daemon.rpc", code: 27, userInfo: [
            ...
            if let sendError = sendErrorBox.error {
                stop(suppressTerminationCallback: false)
                throw NSError(domain: "bmux.remote.daemon.rpc", code: 16, userInfo: [
        ...
        if stdinHandle === FileHandle.nullDevice {
            throw NSError(domain: "bmux.remote.daemon.rpc", code: 15, userInfo: [
