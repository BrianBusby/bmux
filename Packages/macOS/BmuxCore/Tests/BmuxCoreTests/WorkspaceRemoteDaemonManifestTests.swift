...
struct WorkspaceRemoteDaemonManifestTests {
    private let manifestJSON = """
    {
      "schemaVersion": 1,
      "appVersion": "0.20.0",
      "releaseTag": "bmuxd-remote-v0.20.0",
      "releaseURL": "https://github.com/manaflow-ai/bmux/releases/tag/bmuxd-remote-v0.20.0",
      ...
      "entries": [
        {
          ...
          "downloadURL": "https://example.invalid/bmuxd-remote-linux-amd64",
          "sha256": "abc123"
        },
        {
          "goOS": "darwin",
          "goArch": "arm64",
          "assetName": "bmuxd-remote-darwin-arm64",
          "downloadURL": "https://example.invalid/bmuxd-remote-darwin-arm64",
          "sha256": "def456"
        }
      ]
    }
    ...
    func entryLookup() throws {
        ...
        #expect(manifest.entry(goOS: "darwin", goArch: "arm64")?.assetName == "bmuxd-remote-darwin-arm64")
    ...
    func decodesFromInfoDictionary() throws {
        ...
        #expect(WorkspaceRemoteDaemonManifest.infoDictionaryKey == "BMUXRemoteDaemonManifestJSON")
        #expect(manifest.releaseTag == "bmuxd-remote-v0.20.0")
