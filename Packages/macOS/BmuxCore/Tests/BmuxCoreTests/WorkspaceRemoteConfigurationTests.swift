...
struct WorkspaceRemoteConfigurationValueTests {
    ...
    func managedCloudDisplayTarget() {
        ...
        #expect(plainSSH.displayTarget == "71smiccrg35sw9pydt8k+bmux@vm-ssh.freestyle.sh")
    }
    ...
    func sessionSnapshotGating() {
        ...
        #expect(managedWebSocketSnapshot?.persistentDaemonSlot == "bmux-default-freestyle-sshd-v1")
    }
