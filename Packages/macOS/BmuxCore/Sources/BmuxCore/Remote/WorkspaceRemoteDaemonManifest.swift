...
/// The release manifest describing downloadable bmuxd-remote daemon binaries
...
public struct WorkspaceRemoteDaemonManifest: Decodable, Equatable, Sendable {
    ...
    /// bmux app version the manifest was generated for.
...
extension WorkspaceRemoteDaemonManifest {
    ...
    /// JSON (`BMUXRemoteDaemonManifestJSON`); wire-pinned.
    public static let infoDictionaryKey = "BMUXRemoteDaemonManifestJSON"
