...
This document is the technical contract authority for adopters. It defines public integration contracts, not the full platform architecture or implementation roadmap. The complete package north star is `docs/reference-architecture.md`; the current implementation boundaries are in `docs/architecture.md`; monorepo Project Truth sequencing lives in `../../../../project/project-state.yaml` and generated status under `../../../../docs/generated/`.
