...
/// scope and domain filters, any bmux profiles created, and the per-mapping
/// outcome entries.
public struct BrowserImportOutcome: Sendable {
    ...
    /// Display names of bmux profiles created during this import.
    ...
    ///   - createdDestinationProfileNames: Names of bmux profiles created.
    ...
    /// JSON-serializable representation sent over the bmux automation socket.
