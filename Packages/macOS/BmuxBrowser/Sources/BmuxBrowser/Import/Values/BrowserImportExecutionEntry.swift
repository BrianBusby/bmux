...
/// One mapping in an import plan: a set of source profiles and the bmux
...
public struct BrowserImportExecutionEntry: Equatable, Sendable {
    ...
    /// The bmux destination profile request for this entry.
    ...
    ///   - destination: The bmux destination profile request.
