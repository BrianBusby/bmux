...
///
/// Faithfully lifted from the app target's `bmuxWindowFirstResponderBypassDepth`
/// global plus the `bmuxWithWindowFirstResponderBypass` /
/// `bmuxIsWindowFirstResponderBypassActive` free functions. The depth counter
