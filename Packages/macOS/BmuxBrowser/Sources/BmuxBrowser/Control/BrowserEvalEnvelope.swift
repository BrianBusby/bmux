...
///
/// The default values are the exact strings the bmux v2 browser RPC wire format
...
public struct BrowserEvalEnvelope: Sendable, Equatable {
    ...
    /// - Parameters:
    ///   - typeKey: JSON key for the discriminator. Defaults to the wire value `"__bmux_t"`.
    ///   - valueKey: JSON key for the payload. Defaults to the wire value `"__bmux_v"`.
    ...
    public init(
        typeKey: String = "__bmux_t",
        valueKey: String = "__bmux_v",
