...
public enum BmuxSidebarSplitDirection: String, Codable, CaseIterable, Equatable, Sendable {
    case left
    case right
    case up
    case down
...
public enum BmuxSidebarAction: Codable, Equatable, Sendable {
    ...
    case splitTerminal(workspaceID: UUID, surfaceID: UUID, direction: BmuxSidebarSplitDirection)
    case splitBrowser(workspaceID: UUID, surfaceID: UUID, direction: BmuxSidebarSplitDirection, url: String?)
    case toggleSurfaceZoom(workspaceID: UUID, surfaceID: UUID)
    case openURL(String)

    public var requiredScopes: Set<BmuxExtensionActionScope> {
        switch self {
