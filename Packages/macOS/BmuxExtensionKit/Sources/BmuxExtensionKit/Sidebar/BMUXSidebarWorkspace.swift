...
public struct BmuxSidebarWorkspace: Codable, Equatable, Identifiable, Sendable {
    public var id: UUID
    ...
    public func filtered(for scopes: some Sequence<BmuxExtensionScope>) -> BmuxSidebarWorkspace {
