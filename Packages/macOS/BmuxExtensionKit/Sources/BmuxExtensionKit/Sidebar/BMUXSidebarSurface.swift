...
/// The user-visible kind of a bmux sidebar surface.
public enum BmuxSidebarSurfaceKind: String, Codable, CaseIterable, Equatable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self = BmuxSidebarSurfaceKind(rawValue: rawValue) ?? .unknown
    }
}

/// A sidebar surface exposed to bmux extensions.
public struct BmuxSidebarSurface: Codable, Equatable, Identifiable, Sendable {
    /// The stable surface identifier.
    public var id: UUID
    /// The current surface title.
    public var title: String
    /// The kind of surface.
    public var kind: BmuxSidebarSurfaceKind
    ...
    public init(
        id: UUID,
        title: String,
        kind: BmuxSidebarSurfaceKind = .unknown,
    ...
    public func filtered(for scopes: some Sequence<BmuxExtensionScope>) -> BmuxSidebarSurface {
