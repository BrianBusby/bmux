...
public enum HermesAgentIndex {
    ...
    public static func loadSessions(
        ...
        do {
            guard let madeSnapshot = try makeSnapshot(stateDBPath: stateDBPath, prefix: "bmux-hermes-agent-search") else {
                return HermesAgentIndexResult(sessions: [], errors: [])
            }
    ...
    public static func loadTranscript(
        ...
        guard let snapshot = try makeSnapshot(stateDBPath: stateDBPath, prefix: "bmux-hermes-agent-preview") else {
