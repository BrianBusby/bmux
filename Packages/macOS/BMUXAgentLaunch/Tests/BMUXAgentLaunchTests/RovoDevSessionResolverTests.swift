...
struct RovoDevSessionResolverTests {
    ...
    func rejectsMissingAndNonExactCwd() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-rovo-resolver-\(UUID().uuidString)", isDirectory: true)
        ...
        let env = ["BMUX_ROVODEV_SESSIONS_DIR": sessionsRoot.path]
    ...
    func infersNewestMatchingWorkspaceSession() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-rovo-resolver-newest-\(UUID().uuidString)", isDirectory: true)
    ...
    func matchesSymlinkedWorkspacePaths() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-rovo-resolver-symlink-\(UUID().uuidString)", isDirectory: true)
