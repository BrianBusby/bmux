...
extension CustomSidebarRendererMode {
    ...
    var rendererDescription: String {
        ...
        case .inProcess:
            return String(localized: "customSidebarRenderer.inProcess.description", defaultValue: "Renders as native SwiftUI inside bmux with hover, focus, and typing. A faulty sidebar shares the app process.")
        }
    }
}
