...
extension Array where Element == CuratedSettingEntry {
    /// The bmux-shipped curated search entries.
    ///
    ...
    public static var bmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "supported-file-previews", title: "Open Supported Files in bmux", synonyms: "app.openSupportedFilesInBmux cmd click file preview pdf image video audio quicklook quick look editor external"),
            .init(section: .app, id: "markdown-viewer", title: "Open Markdown in bmux Viewer", synonyms: "app.openMarkdownInBmuxViewer md markdown mdx viewer preview readme"),
            ...
            .init(
                ...
                detailText: [
                    String(localized: "settings.terminal.memoryGuardrail.subtitleOn", defaultValue: "bmux warns you with a badge and a banner when one pane's process tree uses too much memory, so a single leak can't crash the whole app."),
            ...
            .init(section: .sidebarAppearance, id: "open-port-links", title: "Open Sidebar Port Links in bmux Browser", synonyms: "sidebar.openPortLinksInBmuxBrowser ports localhost links browser default external embedded"),
            ...
            .init(section: .automation, id: "port-base", title: "Port Base", synonyms: "automation.portBase bmux_port start first base env environment variable"),
            .init(section: .automation, id: "port-range", title: "Port Range Size", synonyms: "automation.portRange bmux_port_end range size count env ports"),

            // Browser
            .init(section: .browser, id: "enable-browser", title: "Enable bmux Browser", synonyms: "browser.disabled enable disable webview embedded browser tabs links"),
            ...
            .init(section: .browser, id: "terminal-links", title: "Open Terminal Links in bmux Browser", synonyms: "browser.openTerminalLinksInBmuxBrowser click url terminal links open in browser href"),
            .init(section: .browser, id: "intercept-open", title: "Intercept open http(s) in Terminal", synonyms: "browser.interceptTerminalOpenCommandInBmuxBrowser open command http https url terminal intercept"),
            ...
            .init(
                ...
                synonyms: [
                    "shortcuts.bindings hotkeys keybindings key bindings commands keyboard accelerators chords bmux json open diff viewer changes review git unstaged split left split right split up split down new pane new split move surface move tab focus pane resize pane close tab close workspace next previous select workspace",
            ...
            .init(section: .keyboardShortcuts, id: "shortcut-chords", title: "Shortcut Chords", synonyms: "tmux prefix ctrl-b control-b multi key sequence chord bmux json"),
            ...
            // bmux.json
            .init(section: .settingsJSON, id: "open-file", title: "User config file", synonyms: "open config file json jsonc config editor ~/.config bmux preferences"),
            .init(section: .settingsJSON, id: "documentation", title: "Documentation", synonyms: "docs documentation schema reference bmux json keys configuration"),
