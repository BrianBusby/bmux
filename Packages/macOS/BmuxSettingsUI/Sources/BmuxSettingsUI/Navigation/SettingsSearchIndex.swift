...
public struct SettingsSearchIndex: Sendable {
    ...
    /// Maps a dotted bmux.json path (e.g. `sidebar.showBranchDirectory`)
    ...
    /// Resolves a dotted bmux.json path to the curated entry id the
    ...
    ///
    /// - Parameter path: A dotted bmux.json path, e.g. `terminal.copyOnSelect`.
