...
public struct SidebarSection: View {
    ...
    public init(defaultsStore: UserDefaultsSettingsStore, catalog: SettingCatalog, hostActions: SettingsHostActions) {
        ...
        _prLinks = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.sidebar.openPullRequestLinksInBmuxBrowser))
        _portLinks = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.sidebar.openPortLinksInBmuxBrowser))
    ...
    private var mainCard: some View {
        SettingsCard {
            ...
            SettingsCardRow(
                configurationReview: .json("sidebar.openPullRequestLinksInBmuxBrowser"),
                String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in bmux Browser"),
                subtitle: prLinksSubtitle(prVisible: showPR.current, prClickable: prClickable.current, openInBmux: prLinks.current)
            ) {
            ...
            SettingsCardRow(
                configurationReview: .json("sidebar.openPortLinksInBmuxBrowser"),
                String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in bmux Browser"),
                subtitle: portLinks.current
                    ? String(localized: "settings.app.openSidebarPortLinks.subtitleOn", defaultValue: "Port clicks open inside bmux browser.")
    ...
    private func prLinksSubtitle(prVisible: Bool, prClickable: Bool, openInBmux: Bool) -> String {
        if !prVisible {
        ...
        return openInBmux
            ? String(localized: "settings.app.openSidebarPRLinks.subtitleOn", defaultValue: "Clicks open inside bmux browser.")
