...
/// bmux on iOS: the pairing-host toggle, the preferred listener port (with a
        ...
        Group {
            ...
            SettingsCard {
                ...
                SettingsCardNote(String(
                    ...
                    defaultValue: "Click Apply to change the port. bmux checks the port is free first: if it's in use, the current listener keeps running untouched; if it's free, it rebinds and connected devices reconnect on the new port."
                ))
            }
        }
