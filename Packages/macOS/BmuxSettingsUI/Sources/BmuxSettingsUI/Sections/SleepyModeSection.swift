            ...
            SettingsCard {
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.theme) {
                        Text(String(localized: "sleepyMode.theme.bmux", defaultValue: "bmux")).tag(SleepyTheme.bmux)
                ...
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.mascot) {
                        Text(String(localized: "sleepyMode.mascot.bmux", defaultValue: "bmux mascot")).tag(SleepyMascot.bmux)
                ...
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.glow) {
                        ...
                        Text(String(localized: "sleepyMode.glow.bmux", defaultValue: "bmux")).tag(SleepyGlow.bmux)
