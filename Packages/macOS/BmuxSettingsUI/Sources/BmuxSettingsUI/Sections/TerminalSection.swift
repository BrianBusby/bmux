        ...
        SettingsCard {
                ...
                VStack(alignment: .trailing, spacing: 4) {
                    HStack(spacing: 8) {
                        ...
                        Text(String.localizedStringWithFormat(String(localized: "settings.fontSize.valuePoints", defaultValue: "%@ pt"), hostActions.formattedFontSize(surfaceTabBarFont.points)))
                            .bmuxFont(size: 12, weight: .medium, design: .rounded)
                            .monospacedDigit()
            ...
            SettingsCardRow(
                ...
                subtitle: scrollBar.current
                    ? String(localized: "settings.terminal.scrollBar.subtitleOn", defaultValue: "Shows the right-edge terminal scroll bar in shell scrollback. bmux hides it automatically for alternate-screen style TUI surfaces.")
            ...
            SettingsCardRow(
                ...
                subtitle: copyOnSelect.current
                    ...
                    : String(localized: "settings.terminal.copyOnSelect.subtitleOff", defaultValue: "bmux does not add system-clipboard copy on selection. Ghostty config still controls Paste Selection.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: autoResume.current
                    ? String(localized: "settings.terminal.agentAutoResume.subtitleOn", defaultValue: "When bmux reopens after quit, restored agent terminals automatically run their resume command.")
                    : String(localized: "settings.terminal.agentAutoResume.subtitleOff", defaultValue: "When bmux reopens after quit, restored agent terminals stay idle until you resume them manually.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: hibernation.current
                    ...
                    : String(localized: "settings.terminal.agentHibernation.subtitleOff", defaultValue: "Agent terminals stay live until you close them or quit bmux.")
            ) {
