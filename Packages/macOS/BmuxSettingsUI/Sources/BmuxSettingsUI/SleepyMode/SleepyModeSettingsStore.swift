...
///
/// This (and `SleepyModeConfig` / the theme enums) lives in BmuxSettingsUI by
/// design: Sleepy Mode appearance is user *settings*, and BmuxSettingsUI is
/// bmux's settings-model module — it already houses the other persisted settings
