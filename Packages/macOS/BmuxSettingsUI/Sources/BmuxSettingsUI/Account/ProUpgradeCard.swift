...
///
/// Shows the bmux Pro pitch (one title line + one price/value subtitle)
...
struct ProUpgradeCard: View {
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 12) {
            VStack(alignment: .leading, spacing: 2) {
                Text(String(localized: "settings.account.pro.title", defaultValue: "bmux Pro"))
    ...
    private var subtitleText: String {
        ...
        return String(
            ...
            defaultValue: "Cloud dev boxes, the iOS app, and bmux AI. $30/month, or $240/year."
        )
    }
