...
/// section's anchor on click. This mirrors what bmux's settings
...
public struct SettingsWindowScene: Scene {
    ...
    public var body: some Scene {
        WindowGroup(String(localized: "settings.title", defaultValue: "Settings"), id: "bmux.settings") {
...
public struct SettingsWindowRoot: View {
    ...
    // sidebar selection changes plus an external app.bmux.settings
    ...
    public var body: some View {
        ...
        // its declared bmux.json paths to scroll/highlight anchor ids,
    ...
    public static let navigationRequestName = Notification.Name("bmux.settings.navigate")
    ...
    /// Posts a `bmux.settings.navigate` notification with the same
    ...
    /// Navigates from outside (e.g., a `bmux.settings.navigate`
