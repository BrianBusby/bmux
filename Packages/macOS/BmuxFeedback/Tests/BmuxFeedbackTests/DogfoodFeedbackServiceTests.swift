...
struct DogfoodFeedbackServiceTests {
    private func makeService(
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-dogfood-test-\(UUID().uuidString)", isDirectory: true)
    ...
    func writesBundle() async throws {
        ...
        #expect(manifest?["schema"] as? String == "bmux.dogfood.feedback.v1")
    ...
    func prunesOldBundles() async throws {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-dogfood-prune-\(UUID().uuidString)", isDirectory: true)
