...
extension RemoteCLIRelayServer {
    ...
    /// local bmux unix socket and returns the response (faithful lift of the
    ...
    final class Session: @unchecked Sendable {
        ...
        private let challengeProtocol = "bmux-relay-auth"
        ...
        private static func roundTripUnixSocket(socketPath: String, request: Data) throws -> Data {
            ...
            guard fd >= 0 else {
                throw NSError(domain: "bmux.remote.relay", code: 1, userInfo: [
            ...
            guard pathBytes.count <= MemoryLayout.size(ofValue: address.sun_path) else {
                throw NSError(domain: "bmux.remote.relay", code: 2, userInfo: [
            ...
            guard connectResult == 0 else {
                throw NSError(domain: "bmux.remote.relay", code: 3, userInfo: [
            ...
            try request.withUnsafeBytes { rawBuffer in
                ...
                while bytesRemaining > 0 {
                    ...
                    if written <= 0 {
                        throw NSError(domain: "bmux.remote.relay", code: 4, userInfo: [
            ...
            while true {
                ...
                if errno == EAGAIN || errno == EWOULDBLOCK {
                    ...
                    throw NSError(domain: "bmux.remote.relay", code: 5, userInfo: [
                        NSLocalizedDescriptionKey: "timed out waiting for local bmux response",
                    ])
                }
                throw NSError(domain: "bmux.remote.relay", code: 6, userInfo: [
