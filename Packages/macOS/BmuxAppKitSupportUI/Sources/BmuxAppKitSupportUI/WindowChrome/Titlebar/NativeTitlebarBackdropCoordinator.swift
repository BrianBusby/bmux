...
public final class NativeTitlebarBackdropCoordinator {
    ...
    /// Removes the bmux native titlebar backdrop view from a window.
    public func removeNativeTitlebarBackdrop(in window: NSWindow) {
        guard let contentView = window.contentView,
              let themeFrame = contentView.superview else { return }

        let identifier = NSUserInterfaceItemIdentifier("bmux.nativeTitlebarBackdrop")
    ...
    public func setTitlebarControlsHidden(
        ...
        let controlsId = NSUserInterfaceItemIdentifier("bmux.titlebarControls")
