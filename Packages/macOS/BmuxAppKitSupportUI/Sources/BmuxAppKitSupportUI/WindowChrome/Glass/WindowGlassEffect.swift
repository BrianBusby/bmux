...
public final class WindowGlassEffect: WindowGlassEffectManaging {
    static let backgroundIdentifier = NSUserInterfaceItemIdentifier("bmux.windowGlassBackground")
    static let rootIdentifier = NSUserInterfaceItemIdentifier("bmux.windowGlassRoot")
    static let foregroundContainerViewIdentifier = NSUserInterfaceItemIdentifier("bmux.windowGlassForeground")
