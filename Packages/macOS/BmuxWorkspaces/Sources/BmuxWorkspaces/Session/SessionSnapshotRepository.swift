...
/// pair under `Application Support/bmux/`, and the unusable-primary recovery
...
public struct SessionSnapshotRepository<SnapshotValue: SessionSnapshotRepresenting>: SessionSnapshotStoring {
    ...
    ///     composition root). Falls back to `com.bmuxterm.app` when nil or
    ///     blank.
    ...
    public func syncManualRestoreSnapshotCache() {
        ...
        case .unusable:
            ...
            // sessions (startup fallback and `bmux restore-session`).
            break
        }
    }
