...
public enum ControlPaneCreateResolution: Sendable, Equatable {
    ...
    /// A browser split was requested while the bmux browser is disabled and an
    ...
    /// A browser split was requested while the bmux browser is disabled and no
    /// URL was supplied (legacy `browser_disabled` / "bmux browser is
    /// disabled", `data: nil`).
    case browserDisabledNoURL
    /// A browser split was requested while the bmux browser is disabled and the
