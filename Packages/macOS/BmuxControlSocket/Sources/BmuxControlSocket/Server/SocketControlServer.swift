public import BmuxSettings
internal import Dispatch
internal import Foundation
internal import os

/// The bmux control-socket listener: path reservation, bind/listen lifecycle,
...
public final class SocketControlServer {
    ...
    struct ListenerState {
        ...
        var accessMode: SocketControlMode = .bmuxOnly
    }
    ...
    nonisolated let socketListenerQueue = DispatchQueue(label: "com.bmux.socket.listener")
