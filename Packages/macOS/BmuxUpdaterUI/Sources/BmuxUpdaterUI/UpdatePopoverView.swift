    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text(String(localized: "update.popover.autoUpdatesDescription", defaultValue: "bmux can automatically check for updates in the background."))
                    .bmuxFont(size: 11)
                    .foregroundColor(.secondary)
