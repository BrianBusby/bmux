...
/// Locates the built `bmux-sidebar-interpreter` worker executable so the client
...
func interpreterWorkerURL() -> URL {
    builtExecutableURL(named: "bmux-sidebar-interpreter")
}

/// Locates the built `bmux-sidebar-render-fixture` protocol fixture for the
/// `RenderWorkerClient` supervision tests (same lookup rules as the worker).
func renderFixtureURL() -> URL {
    builtExecutableURL(named: "bmux-sidebar-render-fixture")
}
...
private func builtExecutableURL(named workerName: String) -> URL {
    ...
    // <package>/Tests/BmuxSidebarInterpreterClientTests/<thisFile>
