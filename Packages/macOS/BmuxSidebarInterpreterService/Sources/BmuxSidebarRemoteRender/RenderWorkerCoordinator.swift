...
final class RenderWorkerCoordinator {
    ...
    /// Stderr diagnostics, enabled with `BMUX_RENDER_WORKER_DEBUG=1` in the
    ...
    private let debugEnabled = ProcessInfo.processInfo.environment["BMUX_RENDER_WORKER_DEBUG"] == "1"
