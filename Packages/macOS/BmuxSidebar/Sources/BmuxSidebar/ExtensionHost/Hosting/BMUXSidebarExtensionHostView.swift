...
@_spi(BmuxHostTransport) public import BmuxExtensionKit
public import Foundation
public import SwiftUI

@available(macOS 14.0, *)
/// SwiftUI bridge that hosts a sidebar extension scene through ExtensionKit.
@_spi(BmuxHostTransport) public struct BMUXSidebarExtensionHostView: NSViewControllerRepresentable {
    ...
    @_spi(BmuxHostTransport) public final class Coordinator: NSObject, EXHostViewControllerDelegate {
    ...
    public init(
        ...
        sceneID: String = BmuxSidebarExtensionPoint.defaultSceneID,
