...
public struct SidebarMultiSelectionShouldCollapseEvent: Sendable {
    /// The legacy notification name (`bmux.sidebarMultiSelectionShouldCollapse`).
    public static let notificationName = Notification.Name("bmux.sidebarMultiSelectionShouldCollapse")
