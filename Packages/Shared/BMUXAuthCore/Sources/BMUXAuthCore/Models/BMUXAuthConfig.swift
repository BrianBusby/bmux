...
public struct BMUXAuthConfig: Equatable, Sendable {
    ...
    ///     injected defaults.
    ///   - developmentProjectId: Default project id for ``BMUXAuthEnvironment/development``.
    ///   - productionProjectId: Default project id for ``BMUXAuthEnvironment/production``.
