...
public struct BMUXAuthState: Equatable, Sendable {
    ...
    public init(isAuthenticated: Bool, currentUser: BMUXAuthUser?, isRestoringSession: Bool) {
    ...
    public static func primed(
        ...
        fixtureUser: BMUXAuthUser?,
        autoLoginCredentials: BMUXAuthAutoLoginCredentials?,
        cachedUser: BMUXAuthUser?,
        hasTokens: Bool,
        mockUser: BMUXAuthUser
    ) -> Self {
