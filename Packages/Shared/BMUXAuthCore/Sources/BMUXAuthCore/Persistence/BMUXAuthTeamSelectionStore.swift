...
///
/// Backed by an injected ``BMUXAuthKeyValueStore`` (production: `UserDefaults`)
...
/// thread-safe, matching ``BMUXAuthSessionCache`` and ``BMUXAuthIdentityStore``.
public final class BMUXAuthTeamSelectionStore: @unchecked Sendable {
