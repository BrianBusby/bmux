...
@Suite struct BMUXAuthTeamSelectionStoreTests {
    @Test func roundTripsSelection() {
        let store = BMUXAuthTeamSelectionStore(
    ...
    @Test func nilAssignmentAndClearRemoveValue() {
        ...
        let store = BMUXAuthTeamSelectionStore(keyValueStore: backing, key: "selected_team")
        store.selectedTeamID = "team_a"
...
private final class SelectionTestKeyValueStore: BMUXAuthKeyValueStore {
