...
public struct ChatSessionDescriptor: Identifiable, Sendable, Equatable, Codable {
    ...
    /// The bmux workspace the session's terminal belongs to, when known.
    public let workspaceID: String?

    /// The bmux terminal surface hosting the session, when known. Required
    ...
    ///   - workspaceID: Owning bmux workspace when known.
    ///   - terminalID: Hosting bmux terminal surface when known.
