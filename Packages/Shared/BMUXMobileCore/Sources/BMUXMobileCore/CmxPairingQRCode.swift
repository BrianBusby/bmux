...
///
/// `bmux-ios://attach?v=2&ub=<stack-user-id>&pc=<compat>&av=<version>&ab=<build>&r=<host>:<port>[&r=<host>:<port>...]`
///
...
public struct CmxPairingQRCode: Sendable {
    ...
    /// Whether `components` (an already-parsed `bmux-ios://attach` URL) speaks
    ...
    /// - Parameter components: The parsed `bmux-ios://attach?v=2&...` URL.
