...
/// `BmuxSyncStore` `devices` collection as PROVISIONAL records (`rev == 0`), so
...
public struct PairedMacMigration: Sendable {
    ...
    private let syncStore: any BmuxSyncStoring

    public init(pairedStore: any MobilePairedMacStoring, syncStore: any BmuxSyncStoring) {
