...
private let syncStoreLog = Logger(subsystem: "com.bmuxterm.app", category: "BmuxSyncStore")
...
public actor BmuxSyncStore: BmuxSyncStoring {
    ...
    /// The default on-disk location, `bmux-sync.sqlite3` next to the paired-Mac
    /// db under Application Support/bmux.
    public static func defaultDatabaseURL(fileManager: FileManager = .default) throws -> URL {
        ...
        let dir = appSupport.appendingPathComponent("bmux", isDirectory: true)
        if !fileManager.fileExists(atPath: dir.path) {
            try fileManager.createDirectory(at: dir, withIntermediateDirectories: true)
        }
        return dir.appendingPathComponent("bmux-sync.sqlite3")
    }
    ...
    private func runMigrations() throws {
        ...
        case 1:
            break
        default:
            throw BmuxSyncStoreError.unknownSchemaVersion(Int(version))
        }
    }
