...
private let pushLog = Logger(subsystem: "ai.manaflow.bmux", category: "push")

/// Owns the push opt-in state and the device-token sync with the bmux web API.
///
...
public actor PushRegistrationService: PushRegistering {
    ...
    private static let cachedTokenKey = "bmux.notifications.deviceTokenHex"
