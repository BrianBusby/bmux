...
public extension ClientConfigFlag where Value == Bool {
    ...
    static let bmuxForWindows = Self(booleanKey: "bmux-for-windows")
    /// Enables Linux download/sign-up surfaces.
    static let bmuxForLinux = Self(booleanKey: "bmux-for-linux")
    /// Enables Android download/sign-up surfaces.
    static let bmuxForAndroid = Self(booleanKey: "bmux-for-android")
