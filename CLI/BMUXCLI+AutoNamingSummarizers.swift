...
extension BMUXCLI {
    func runAutoNamingSummarizer(
        ...
        let tempRoot = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-autoname-\(UUID().uuidString)", isDirectory: true)
        ...
        case "opencode":
            ...
            arguments = [
                ...
                "--dir", tempRoot.path,
                "--file", promptPath,
                "Follow the workspace auto-naming instructions in the prompt file exactly. Output only the requested title or keep-or-rename decision block."
            ]
            stdinPrompt = ""
        case "grok":
            guard let promptPath = promptFile() else { return nil }
    ...
    func runAutoNamingSummarizer(
        ...
        let outputURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-autoname-stdout-\(UUID().uuidString).txt")
