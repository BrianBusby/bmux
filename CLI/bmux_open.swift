...
extension BMUXCLI {
    ...
    private struct DiffViewerURLMapper {
        ...
        static let sessionHistoryMarker = "bmux-diff-viewer"
        ...
        func viewerURL(for fileURL: URL) throws -> URL {
            ...
            if origin.scheme == Self.scheme {
                ...
                // (`bmux-diff-viewer://<token>`), and the in-app scheme handler
    ...
    /// `/__bmux_diff_viewer_branch` regenerate endpoint runs in the separate
    /// server process, which has none of the original `bmux diff` invocation's
    ...
    private struct DiffViewerLabels {
        ...
        static func localized() -> DiffViewerLabels {
            DiffViewerLabels(values: [
                "additions": BMUXDiffViewerLocalization.string("diffViewer.additions", defaultValue: "Additions"),
                "addComment": BMUXDiffViewerLocalization.string("diffViewer.addComment", defaultValue: "Add comment"),
                "bars": BMUXDiffViewerLocalization.string("diffViewer.bars", defaultValue: "Bars"),
                "cancelComment": BMUXDiffViewerLocalization.string("diffViewer.cancelComment", defaultValue: "Cancel"),
                "comments": BMUXDiffViewerLocalization.string("diffViewer.comments", defaultValue: "Comments"),
                "commentPlaceholder": BMUXDiffViewerLocalization.string("diffViewer.commentPlaceholder", defaultValue: "Leave a comment"),
                "deleteComment": BMUXDiffViewerLocalization.string("diffViewer.deleteComment", defaultValue: "Delete"),
                "editComment": BMUXDiffViewerLocalization.string("diffViewer.editComment", defaultValue: "Edit"),
                "noComments": BMUXDiffViewerLocalization.string("diffViewer.noComments", defaultValue: "No comments yet"),
                "outdatedComment": BMUXDiffViewerLocalization.string("diffViewer.outdatedComment", defaultValue: "Outdated"),
                "saveComment": BMUXDiffViewerLocalization.string("diffViewer.saveComment", defaultValue: "Comment"),
                "changedFiles": BMUXDiffViewerLocalization.string("diffViewer.changedFiles", defaultValue: "Changed files"),
                "classic": BMUXDiffViewerLocalization.string("diffViewer.classic", defaultValue: "Classic"),
                "commit": BMUXDiffViewerLocalization.string("about.commit", defaultValue: "Commit"),
                "collapseAllDiffs": BMUXDiffViewerLocalization.string("diffViewer.collapseAllDiffs", defaultValue: "Collapse all diffs"),
                "collapseUnchangedContext": BMUXDiffViewerLocalization.string("diffViewer.collapseUnchangedContext", defaultValue: "Collapse unchanged context"),
                "copyFailedGitApplyCommand": BMUXDiffViewerLocalization.string("diffViewer.copyFailedGitApplyCommand", defaultValue: "Could not copy git apply command."),
                "copiedGitApplyCommand": BMUXDiffViewerLocalization.string("diffViewer.copiedGitApplyCommand", defaultValue: "Copied git apply command"),
                "copyGitApplyCommand": BMUXDiffViewerLocalization.string("diffViewer.copyGitApplyCommand", defaultValue: "Copy git apply command"),
                "deletions": BMUXDiffViewerLocalization.string("diffViewer.deletions", defaultValue: "Deletions"),
                "diffStats": BMUXDiffViewerLocalization.string("diffViewer.diffStats", defaultValue: "Diff stats"),
                "diffTarget": BMUXDiffViewerLocalization.string("diffViewer.diffTarget", defaultValue: "Diff target"),
                "diffViewer": BMUXDiffViewerLocalization.string("diffViewer.diffViewer", defaultValue: "Diff viewer"),
                "renderFailed": BMUXDiffViewerLocalization.string("diffViewer.renderFailed", defaultValue: "Could not render this diff. Check the patch input and try again."),
                "disableWordDiffs": BMUXDiffViewerLocalization.string("diffViewer.disableWordDiffs", defaultValue: "Disable word diffs"),
                "disableWordWrap": BMUXDiffViewerLocalization.string("diffViewer.disableWordWrap", defaultValue: "Disable word wrap"),
                "enableWordDiffs": BMUXDiffViewerLocalization.string("diffViewer.enableWordDiffs", defaultValue: "Enable word diffs"),
                "enableWordWrap": BMUXDiffViewerLocalization.string("diffViewer.enableWordWrap", defaultValue: "Enable word wrap"),
                "expandAllDiffs": BMUXDiffViewerLocalization.string("diffViewer.expandAllDiffs", defaultValue: "Expand all diffs"),
                "expandUnchangedContext": BMUXDiffViewerLocalization.string("diffViewer.expandUnchangedContext", defaultValue: "Expand unchanged context"),
                "files": BMUXDiffViewerLocalization.string("diffViewer.files", defaultValue: "Files"),
                "hideBackgrounds": BMUXDiffViewerLocalization.string("diffViewer.hideBackgrounds", defaultValue: "Hide backgrounds"),
                "hideFiles": BMUXDiffViewerLocalization.string("diffViewer.hideFiles", defaultValue: "Hide files"),
                "hideFileSearch": BMUXDiffViewerLocalization.string("diffViewer.hideFileSearch", defaultValue: "Hide file search"),
                "hideLineNumbers": BMUXDiffViewerLocalization.string("diffViewer.hideLineNumbers", defaultValue: "Hide line numbers"),
                "indicatorStyle": BMUXDiffViewerLocalization.string("diffViewer.indicatorStyle", defaultValue: "Indicator style"),
                "jumpToFile": BMUXDiffViewerLocalization.string("diffViewer.jumpToFile", defaultValue: "Jump to file"),
                "loadingDiff": BMUXDiffViewerLocalization.string("diffViewer.loadingDiff", defaultValue: "Loading diff..."),
                "loadingRenderer": BMUXDiffViewerLocalization.string("diffViewer.loadingRenderer", defaultValue: "Loading renderer..."),
                "noFileDiffs": BMUXDiffViewerLocalization.string("diffViewer.noFileDiffs", defaultValue: "No file diffs found in patch input."),
                "none": BMUXDiffViewerLocalization.string("diffViewer.none", defaultValue: "None"),
                "openSourceURL": BMUXDiffViewerLocalization.string("diffViewer.openSourceURL", defaultValue: "Open source URL"),
                "options": BMUXDiffViewerLocalization.string("diffViewer.options", defaultValue: "Options"),
                "parsingDiff": BMUXDiffViewerLocalization.string("diffViewer.parsingDiff", defaultValue: "Parsing diff..."),
                "refresh": BMUXDiffViewerLocalization.string("diffViewer.refresh", defaultValue: "Refresh"),
                "renderingDiff": BMUXDiffViewerLocalization.string("diffViewer.renderingDiff", defaultValue: "Rendering diff..."),
                "repoPath": BMUXDiffViewerLocalization.string("diffViewer.repoPath", defaultValue: "Repository path"),
                "branchBase": BMUXDiffViewerLocalization.string("diffViewer.branchBase", defaultValue: "Branch base"),
                "branchPickerCurrent": BMUXDiffViewerLocalization.string("diffViewer.branchPickerCurrent", defaultValue: "current"),
                "branchPickerBasePrefix": BMUXDiffViewerLocalization.string("diffViewer.branchPickerBasePrefix", defaultValue: "Base:"),
                "branchPickerComparing": BMUXDiffViewerLocalization.string("diffViewer.branchPickerComparing", defaultValue: "Comparing {head} against {base}"),
                "branchPickerFilterPlaceholder": BMUXDiffViewerLocalization.string("diffViewer.branchPickerFilterPlaceholder", defaultValue: "Filter branches"),
                "branchPickerGenerating": BMUXDiffViewerLocalization.string("diffViewer.branchPickerGenerating", defaultValue: "Generating diff against {ref}..."),
                "branchPickerGroupBranches": BMUXDiffViewerLocalization.string("diffViewer.branchPickerGroupBranches", defaultValue: "Branches"),
                "branchPickerGroupRecent": BMUXDiffViewerLocalization.string("diffViewer.branchPickerGroupRecent", defaultValue: "Recent"),
                "branchPickerGroupRemotes": BMUXDiffViewerLocalization.string("diffViewer.branchPickerGroupRemotes", defaultValue: "Remotes"),
                "branchPickerGroupSuggested": BMUXDiffViewerLocalization.string("diffViewer.branchPickerGroupSuggested", defaultValue: "Suggested"),
                "branchPickerGroupWorktrees": BMUXDiffViewerLocalization.string("diffViewer.branchPickerGroupWorktrees", defaultValue: "Worktrees"),
                "branchPickerLoadFailed": BMUXDiffViewerLocalization.string("diffViewer.branchPickerLoadFailed", defaultValue: "Could not load branches."),
                "branchPickerMore": BMUXDiffViewerLocalization.string("diffViewer.branchPickerMore", defaultValue: "{count} more, type to filter"),
                "branchPickerLoading": BMUXDiffViewerLocalization.string("diffViewer.branchPickerLoading", defaultValue: "Loading branches..."),
                "branchPickerNoMatches": BMUXDiffViewerLocalization.string("diffViewer.branchPickerNoMatches", defaultValue: "No matching branches"),
                "branchPickerOpen": BMUXDiffViewerLocalization.string("diffViewer.branchPickerOpen", defaultValue: "Change diff base"),
                "branchPickerUseRaw": BMUXDiffViewerLocalization.string("diffViewer.branchPickerUseRaw", defaultValue: "Use \"{ref}\" (raw)"),
                "showBackgrounds": BMUXDiffViewerLocalization.string("diffViewer.showBackgrounds", defaultValue: "Show backgrounds"),
                "showFiles": BMUXDiffViewerLocalization.string("diffViewer.showFiles", defaultValue: "Show files"),
                "showFileSearch": BMUXDiffViewerLocalization.string("diffViewer.showFileSearch", defaultValue: "Show file search"),
                "showLineNumbers": BMUXDiffViewerLocalization.string("diffViewer.showLineNumbers", defaultValue: "Show line numbers"),
                "switchToSplitDiff": BMUXDiffViewerLocalization.string("diffViewer.switchToSplitDiff", defaultValue: "Switch to split diff"),
                "switchToUnifiedDiff": BMUXDiffViewerLocalization.string("diffViewer.switchToUnifiedDiff", defaultValue: "Switch to unified diff"),
                "untitled": BMUXDiffViewerLocalization.string("diffViewer.untitled", defaultValue: "Untitled"),
            ])
        }
    }
    ...
    private enum DiffSource: CaseIterable, Equatable {
        ...
        var menuLabel: String {
            switch self {
            case .unstaged: return BMUXDiffViewerLocalization.string("diffViewer.source.unstaged", defaultValue: "Unstaged")
            case .staged: return BMUXDiffViewerLocalization.string("diffViewer.source.staged", defaultValue: "Staged")
            case .branch: return BMUXDiffViewerLocalization.string("diffViewer.source.branch", defaultValue: "Branch")
            case .lastTurn: return BMUXDiffViewerLocalization.string("diffViewer.source.lastTurn", defaultValue: "Last turn")
            }
        }

        var title: String {
            switch self {
            case .unstaged: return BMUXDiffViewerLocalization.string("diffViewer.title.unstagedChanges", defaultValue: "Unstaged changes")
            case .staged: return BMUXDiffViewerLocalization.string("diffViewer.title.stagedChanges", defaultValue: "Staged changes")
            case .branch: return BMUXDiffViewerLocalization.string("diffViewer.title.branchDiff", defaultValue: "Branch diff")
            case .lastTurn: return BMUXDiffViewerLocalization.string("diffViewer.title.lastTurnDiff", defaultValue: "Last turn diff")
            }
        }

        var emptyMessage: String {
            switch self {
            case .unstaged: return BMUXDiffViewerLocalization.string("diffViewer.empty.unstaged", defaultValue: "No unstaged changes to diff.")
            case .staged: return BMUXDiffViewerLocalization.string("diffViewer.empty.staged", defaultValue: "No staged changes to diff.")
            case .branch: return BMUXDiffViewerLocalization.string("diffViewer.empty.branch", defaultValue: "No branch changes to diff.")
            case .lastTurn: return BMUXDiffViewerLocalization.string("diffViewer.empty.lastTurn", defaultValue: "No last-turn changes to diff.")
            }
        }
    }
    ...
    func runOpenCommand(
        ...
        guard !parsedArgs.targets.isEmpty else {
            throw CLIError(message: "open requires at least one path or URL. Usage: bmux open <path-or-url>...")
        }
        ...
        let workspaceRaw = parsedArgs.workspace ?? (parsedArgs.window == nil ? ProcessInfo.processInfo.environment["BMUX_WORKSPACE_ID"] : nil)
        ...
        let surfaceRaw = parsedArgs.surface ?? (shouldInheritCallerSurface ? ProcessInfo.processInfo.environment["BMUX_SURFACE_ID"] : nil)
    ...
    func runDiffCommand(
        ...
        guard parsedArgs.inputs.count <= 1 else {
            throw CLIError(message: "diff accepts at most one patch file. Usage: bmux diff [patch-file|-] [options]")
        }
        ...
        func resolveTargetIfNeeded() throws {
            ...
            let surfaceRaw = parsedArgs.surface ?? (parsedArgs.window == nil ? ProcessInfo.processInfo.environment["BMUX_SURFACE_ID"] : nil)
    ...
    private func taggedDiffViewerExecutableURL(socketPath: String) -> URL? {
        ...
        let candidate = URL(fileURLWithPath: homePath, isDirectory: true)
            .appendingPathComponent("Library/Developer/Xcode/DerivedData/bmux-\(tag)", isDirectory: true)
            .appendingPathComponent("Build/Products/Debug/bmux DEV \(tag).app", isDirectory: true)
    ...
    private func parseOpenArguments(_ commandArgs: [String]) throws -> OpenArguments {
        ...
        while index < commandArgs.count {
            ...
            if isParsingOptions {
                ...
                default:
                    if arg.hasPrefix("-") {
                        throw CLIError(message: "open: unknown flag '\(arg)'. Usage: bmux open <path-or-url>... [--workspace <id|ref|index>] [--surface <id|ref|index>] [--pane <id|ref|index>] [--window <id|ref|index>] [--focus true|false] [--no-focus]")
                    }
                }
            }
            ...
            if isParsingOptions {
                ...
                default:
                    if arg.hasPrefix("-"), arg != "-" {
                        throw CLIError(message: "diff: unknown flag '\(arg)'. Usage: bmux diff [patch-file|-] [--source <unstaged|staged|branch|last-turn>] [--workspace <id|ref|index>] [--surface <id|ref|index>] [--window <id|ref|index>] [--session <id>] [--cwd <path>] [--base <ref>] [--focus true|false] [--no-focus] [--title <text>] [--layout split|unified] [--font-size <points>]")
                    }
                }
            }
    ...
    private func readDiffInput(
        ...
        guard let rawInput, rawInput != "-" else {
            guard isatty(STDIN_FILENO) == 0 else {
                throw CLIError(message: "diff requires a patch file, piped stdin, or a git source. Usage: bmux diff <patch-file>|-|--unstaged|--staged|--branch|--last-turn")
            }
            let data = FileHandle.standardInput.readDataToEndOfFile()
            return DiffInput(
                patch: try decodeDiffData(data, sourceDescription: "stdin"),
                sourceLabel: "stdin",
                defaultTitle: "bmux diff",
                emptyMessage: nil,
                externalURL: nil
            )
        }
        ...
        return DiffInput(
            ...
            defaultTitle: filename.isEmpty ? "bmux diff" : filename,
            emptyMessage: nil,
            externalURL: nil
        )
    }
    ...
    private func diffViewerShouldStreamRemotePatch() -> Bool {
        let value = ProcessInfo.processInfo.environment["BMUX_DIFF_VIEWER_STREAM_REMOTE"]?
            .trimmingCharacters(in: .whitespacesAndNewlines)
            .lowercased()
    ...
    private func readGitDiffInput(source: DiffSource, context: DiffSourceContext) throws -> DiffInput {
        ...
        case .lastTurn:
            guard let workspaceId = normalizedDiffSourceValue(context.workspaceId),
                ...
                throw CLIError(message: "bmux diff --last-turn requires a workspace and surface context. Run it from a bmux terminal or pass --workspace and --surface.")
            }
            let sessionId = normalizedDiffSourceValue(context.sessionId)
            let env = ProcessInfo.processInfo.environment
            let baselineStorePath = BMUXAgentTurnDiffBaselineFile.path(env: env)
    ...
    private func gitRepoRoot(startingAt directory: String) throws -> String {
        do {
            ...
            throw CLIError(message: "bmux diff git sources require a git repository")
        }
    }
    ...
    private func diffBranchBaseReasonLabel(_ reason: String) -> String {
        ...
        case DiffBranchBaseReason.createdFrom:
            return BMUXDiffViewerLocalization.string("diffViewer.baseReason.createdFrom", defaultValue: "created from")
        case DiffBranchBaseReason.prBase:
            return BMUXDiffViewerLocalization.string("diffViewer.baseReason.prBase", defaultValue: "PR base")
        case DiffBranchBaseReason.forkPoint:
            return BMUXDiffViewerLocalization.string("diffViewer.baseReason.forkPoint", defaultValue: "fork point")
        case DiffBranchBaseReason.default:
            return BMUXDiffViewerLocalization.string("diffViewer.baseReason.default", defaultValue: "default")
        case DiffBranchBaseReason.manual:
            return BMUXDiffViewerLocalization.string("diffViewer.baseReason.manual", defaultValue: "manual")
        default:
            return reason
        }
    }
    ...
    /// choice. Otherwise walk the heuristic order: recorded bmuxBase -> PR base ->
    ...
    private func resolvedDiffBranchBase(_ rawBaseRef: String?, in repoRoot: String) throws -> DiffBranchBase {
        ...
        // 1. Recorded creation base written by new-bmux-worktree.sh. Read-only.
        if let branchName,
           let recorded = try? gitSingleLine(["config", "--get", "branch.\(branchName).bmuxBase"], in: repoRoot),
           !recorded.isEmpty,
    ...
    private func diffBranchRefGroups(in repoRoot: String, selectedBaseRef: String?) -> [DiffBranchRefGroup] {
        ...
        // Surface each individual heuristic source so bmuxBase and PR base can
        ...
        if !suggestedRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "suggested",
                    label: BMUXDiffViewerLocalization.string("diffViewer.refGroup.suggested", defaultValue: "Suggested"),
                    rows: suggestedRows
                )
            )
        }
        ...
        if !worktreeRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "worktrees",
                    label: BMUXDiffViewerLocalization.string("diffViewer.refGroup.worktrees", defaultValue: "Worktrees"),
                    rows: worktreeRows
                )
            )
        }
        ...
        if !branchRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "branches",
                    label: BMUXDiffViewerLocalization.string("diffViewer.refGroup.branches", defaultValue: "Branches"),
                    rows: branchRows
                )
            )
        }
        ...
        if !remoteRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "remotes",
                    label: BMUXDiffViewerLocalization.string("diffViewer.refGroup.remotes", defaultValue: "Remotes"),
                    rows: remoteRows
                )
            )
        }
        ...
        if !recentRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "recent",
                    label: BMUXDiffViewerLocalization.string("diffViewer.refGroup.recent", defaultValue: "Recent"),
                    rows: recentRows
                )
            )
        }
    ...
    /// pattern fixed in https://github.com/manaflow-ai/bmux/pull/5347, and these
    ...
    private func gitUntrackedPatchSinceBaseline(
        record: BMUXAgentTurnDiffBaselineRecord,
        in repoRoot: String,
        storePath: String
    ) throws -> String {
    ...
    private func safeTemporaryGitPathURL(relativePath: String) -> (root: URL, file: URL)? {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("bmux-diff-untracked-\(UUID().uuidString)", isDirectory: true)
    ...
    private func gitUntrackedPathHashes(
        ...
        for path in paths {
            guard hashes.count < BMUXAgentTurnUntrackedSnapshotLimits.maxFiles,
            ...
            guard fileSize <= BMUXAgentTurnUntrackedSnapshotLimits.maxFileBytes,
                  capturedBytes + fileSize <= BMUXAgentTurnUntrackedSnapshotLimits.maxTotalBytes else {
                continue
            }
            do {
    ...
    func recordAgentTurnDiffBaseline(
        ...
        let storePath = BMUXAgentTurnDiffBaselineFile.path(env: env)
        let untrackedSnapshot = try gitUntrackedPathHashes(
            paths: untrackedPaths,
            in: repoRoot,
            storePath: storePath
        )
        let record = BMUXAgentTurnDiffBaselineRecord(
            workspaceId: workspaceId,
            surfaceId: surfaceId,
        ...
        do {
            var removedRecords: [BMUXAgentTurnDiffBaselineRecord] = []
            ...
            try updateAgentTurnDiffBaselineStore(path: storePath, update: { store in
                func matchesCurrentScope(_ existing: BMUXAgentTurnDiffBaselineRecord) -> Bool {
    ...
    private func agentTurnDiffBaselineCommit(in repoRoot: String) throws -> String {
        let stashResult = CLIProcessRunner.runProcess(
            executablePath: "/usr/bin/env",
            arguments: ["git", "-C", repoRoot, "stash", "create", "bmux last turn baseline"],
            timeout: 60
        )
    ...
    private func latestAgentTurnDiffBaseline(
        ...
        sessionId: String?,
        env: [String: String]
    ) throws -> BMUXAgentTurnDiffBaselineRecord? {
        let store = try readAgentTurnDiffBaselineStore(path: BMUXAgentTurnDiffBaselineFile.path(env: env))
    ...
    private func readAgentTurnDiffBaselineStore(path: String) throws -> BMUXAgentTurnDiffBaselineStore {
        let url = URL(fileURLWithPath: path)
        guard FileManager.default.fileExists(atPath: url.path) else {
            return BMUXAgentTurnDiffBaselineStore()
        }
        let data = try Data(contentsOf: url)
        return try JSONDecoder().decode(BMUXAgentTurnDiffBaselineStore.self, from: data)
    }

    private func updateAgentTurnDiffBaselineStore(
        path: String,
        update: (inout BMUXAgentTurnDiffBaselineStore) throws -> Void,
        afterWrite: ((BMUXAgentTurnDiffBaselineStore) -> Void)? = nil
    ) throws {
        let url = URL(fileURLWithPath: path)
        ...
        var store = (try? readAgentTurnDiffBaselineStore(path: path)) ?? BMUXAgentTurnDiffBaselineStore()
        try update(&store)
    ...
    private func pruneAgentTurnDiffBaselineStore(_ store: inout BMUXAgentTurnDiffBaselineStore) {
    ...
    private func pruneAgentTurnDiffBaselineArtifacts(
        storePath: String,
        removedRecords: [BMUXAgentTurnDiffBaselineRecord],
        retainedRecords: [BMUXAgentTurnDiffBaselineRecord]
    ) {
    ...
    private func agentTurnDiffBaselineRecordEquals(
        _ lhs: BMUXAgentTurnDiffBaselineRecord,
        _ rhs: BMUXAgentTurnDiffBaselineRecord
    ) -> Bool {
    ...
    private func diffViewerAppearance(socketPath: String, fontSizeOverride: Double?) -> DiffViewerAppearance {
        ...
        appearance.lightTheme.generatedName = "bmux-ghostty-light-\(themeSuffix)"
        appearance.darkTheme.generatedName = "bmux-ghostty-dark-\(themeSuffix)"
    ...
    private func defaultDiffViewerAppearance() -> DiffViewerAppearance {
        var lightTheme = DiffViewerTheme(
            generatedName: "bmux-ghostty-light",
        ...
        var darkTheme = DiffViewerTheme(
            generatedName: "bmux-ghostty-dark",
    ...
    private func diffViewerLoadingDiffMessage(_ target: String) -> String {
        let format = BMUXDiffViewerLocalization.string(
    ...
    private func writeCompleteGitDiffViewerHTMLSet(
        ...
        // verbatim. With no explicit base, the heuristic resolver (bmuxBase -> PR
        ...
        for source in DiffSource.allCases {
            for option in repoCandidates where option.repoRoot != repoRoot {
                ...
                // renders against (and surfaces a picker for) the bmuxBase/PR/
    ...
    /// custom scheme (`bmux-diff-viewer://<token>`) it yields a scheme URL whose
    ...
    private func diffViewerBranchRegenerateURLTemplate(
        ...
        let withSentinel = diffViewerBranchEndpointURL(
            origin: origin,
            path: "/__bmux_diff_viewer_branch",
            queryItems: [
                URLQueryItem(name: "group", value: groupID),
                URLQueryItem(name: "repo", value: repoRoot),
                URLQueryItem(name: "token", value: token),
                URLQueryItem(name: "base", value: "__BMUX_REF__")
            ]
        )
        ...
        // (arbitrary user path), leaving `base=__BMUX_REF__` unfilled and breaking
        // regeneration. `base` is the last query item, so `base=__BMUX_REF__`
        // appears verbatim and uniquely.
        return withSentinel.replacingOccurrences(of: "base=__BMUX_REF__", with: "base={ref}")
    }

    // MARK: - Headless picker commands (for the in-app custom-scheme handler)

    /// `bmux __diff-viewer-refs --repo <root> [--base <ref>]` -> grouped refs JSON
    ...
    /// custom-scheme handler to mirror the HTTP `/__bmux_diff_viewer_refs` route.
    ...
    /// `bmux __diff-viewer-branch --group <g> --repo <root> --base <ref>` ->
    ...
    /// mirror the HTTP `/__bmux_diff_viewer_branch` route after an app restart,
    ...
    private func agentTurnDiffBaselineRepoURLs(context: DiffSourceContext) -> [URL] {
        guard let workspaceId = normalizedDiffSourceValue(context.workspaceId),
              ...
              let store = try? readAgentTurnDiffBaselineStore(
                path: BMUXAgentTurnDiffBaselineFile.path(env: ProcessInfo.processInfo.environment)
              ) else {
            return []
        }
        let sessionId = normalizedDiffSourceValue(context.sessionId)
    ...
    private func startDiffViewerHTTPServer(rootDirectory: URL, runtime: URL? = nil) throws -> URL {
        guard let executableURL = diffViewerExecutableURL(for: runtime) else {
            throw CLIError(message: "Failed to resolve bmux executable for diff viewer server")
        }
    ...
    private func diffViewerHTTPServerIsReachable(port: Int) -> Bool {
        guard let url = URL(string: "http://127.0.0.1:\(port)/__bmux_diff_viewer_healthz") else {
            return false
        }
    ...
    private func handleDiffViewerHTTPConnection(
        ...
        do {
            ...
            if request.path == "/__bmux_diff_viewer_healthz" {
                try sendDiffViewerHTTPResponse(
                    fileDescriptor: fd,
                    status: 200,
                    reason: "OK",
            ...
            if request.path == "/__bmux_diff_viewer_refs" {
            ...
            if request.path == "/__bmux_diff_viewer_branch" {
            ...
            if request.path.hasPrefix("/__bmux_diff_viewer_wait/") {
    ...
    /// `GET /__bmux_diff_viewer_refs?repo=<root>&token=<t>` -> grouped refs JSON.
    ...
    /// `GET /__bmux_diff_viewer_branch?group=<g>&repo=<root>&base=<ref>` ->
    ...
    private func sendDiffViewerHTTPWaitForReplacement(
        ...
        let prefix = "/__bmux_diff_viewer_wait/"
    ...
    private func diffViewerHTTPReplacementWaitTimeout() -> TimeInterval {
        ...
        let key = "BMUX_DIFF_VIEWER_WAIT_TIMEOUT_SECONDS"
    ...
    private func sendDiffViewerHTTPWaitTimedOut(fileDescriptor fd: Int32, omitBody: Bool) throws {
        let title = BMUXDiffViewerLocalization.string(
            "diffViewer.loadingDiff",
            defaultValue: "Loading diff..."
        )
        let message = BMUXDiffViewerLocalization.string(
    ...
    private func diffViewerHTTPFileIsPending(_ fileURL: URL) -> Bool {
        ...
        return text.contains("data-bmux-diff-pending=\"true\"")
    }
    ...
    private func sendDiffViewerHTTPRemotePatch(
        ...
        headers["X-BMUX-Diff-Viewer-Remote"] = "github"
    ...
    private func diffViewerHTTPBaseHeaders(port: Int?) -> [String: String] {
        ...
        if let port {
            ...
            headers["X-BMUX-Diff-Viewer-Origin"] = "http://127.0.0.1:\(port)"
        }
        return headers
    }
    ...
    private func writeDiffViewerRedirectHTML(
        ...
        <body data-bmux-diff-redirect="\(escapedTarget)">
          <script>
    ...
    private func writeDiffViewerHTML(
        ...
        let pendingAttribute = pollForReplacement ? " data-bmux-diff-pending=\"true\"" : ""
        let prepaintStyle = diffViewerPrepaintStyle(appearance: appearance)
        let html = """
        <!doctype html>
        ...
        <body>
          <script id="bmux-diff-viewer-config" type="application/json">\(configLiteral)</script>
          <div id="root"></div>
    ...
    private func diffViewerPrepaintStyle(appearance: DiffViewerAppearance) -> String {
        ...
        return """
        <style id="bmux-diff-viewer-prepaint">
          :root {
    ...
    private func ensureDiffViewerAssets(nextTo viewerURL: URL, runtime: URL? = nil) throws -> DiffViewerAssets {
        ...
        guard appAssetPaths.contains("main.mjs") else {
            throw CLIError(message: "Bundled bmux diff viewer app entry asset not found")
        }
    ...
    private func diffViewerBundledAppAssetDirectory(
        ...
        let candidates: [(sourceName: String, targetName: String)] = [
            ("webviews-app", "bmux-webviews-app"),
            ("diff-viewer-app", "bmux-diff-viewer-app")
        ]
        for candidate in candidates {
            ...
            if FileManager.default.fileExists(atPath: appDirectory.path, isDirectory: &isDirectory),
               ...
               FileManager.default.fileExists(atPath: entry.path) {
                // The shared /tmp asset cache is written by every running bmux
        ...
        throw CLIError(message: "Bundled bmux diff viewer app assets not found")
    }
    ...
    private func diffViewerBundledAssetDirectoryCandidates(runtime: URL? = nil) -> [URL] {
        ...
        if let executableURL = diffViewerExecutableURL(for: runtime) {
            ...
            for _ in 0..<6 {
                ...
                let projectMarker = current.appendingPathComponent("bmux.xcodeproj/project.pbxproj", isDirectory: false)
    ...
    func openSubcommandUsage() -> String {
        """
        Usage: bmux open <path-or-url>... [options]

        Open files, directories, or URLs in bmux.
        ...
        Options:
          --workspace <id|ref|index>   Target workspace (default: $BMUX_WORKSPACE_ID)
          --surface <id|ref|index>     Target surface whose pane should receive file tabs (default: $BMUX_SURFACE_ID)
        ...
        Examples:
          bmux open report.pdf
          bmux open image-a.png image-b.jpg
          bmux open ~/Downloads/movie.mov --pane pane:1
          bmux open https://example.com
        """
    }

    func diffSubcommandUsage() -> String {
        """
        Usage: bmux diff [patch-file|-] [options]

        Render a unified diff or patch in a bmux browser split.
        With no patch file or source, bmux diff reads piped stdin.
        ...
        Options:
          ...
          --workspace <id|ref|index>   Target workspace (default: $BMUX_WORKSPACE_ID)
          --surface <id|ref|index>     Source surface to split from (default: $BMUX_SURFACE_ID)
          ...
          --layout <split|unified>     Diff layout (default: unified; configurable via diffViewer.defaultLayout in bmux.json)
          --font-size <points>         Set diff font size (default: 10)

        Examples:
          bmux diff changes.patch
          git diff | bmux diff
          bmux diff --unstaged
          bmux diff --staged
          bmux diff --branch
          bmux diff --branch --base upstream/main --repo ../repo
          bmux diff --last-turn
          bmux diff pr.patch --layout unified --font-size 15 --focus true
        """
    }
