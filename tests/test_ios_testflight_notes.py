...
def main():
    ...
    with tempfile.TemporaryDirectory() as repo:
        ...
        _commit(repo, "ios/bmux/App.swift", "ios: fix the thing (#101)")
        ...
        _commit(repo, "ios/bmux/Chore.swift", "chore: bump deps (#105)")
        _commit(repo, "ios/bmux/Ci.swift", "ci: tweak workflow (#106)")
        ...
        _commit(repo, "ios/bmux/Pipe.swift", "ios: support A|B mode (#107)")
        _commit(repo, "ios/bmux/Pipe2.swift", "ios: support A (#108)")
        ...
        _commit(repo, "ios/bmux/Side.swift", "ios: side-branch only change (#900)")
