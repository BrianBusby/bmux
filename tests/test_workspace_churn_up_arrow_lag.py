...
MIN_BASELINE_P95_MS_FOR_RATIO = float(os.environ.get("BMUX_LAG_MIN_BASELINE_P95_MS_FOR_RATIO", "6.0"))
MIN_BASELINE_AVG_MS_FOR_RATIO = float(os.environ.get("BMUX_LAG_MIN_BASELINE_AVG_MS_FOR_RATIO", "4.0"))
