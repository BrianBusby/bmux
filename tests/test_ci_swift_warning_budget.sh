...
required_tokens = {
    ...
    "build log tee": "tee",
    "build log path": "bmux-build-output.txt",
...
cat >"$LOG" <<'LOG'
/Users/example/bmux/Sources/AppDelegate.swift:10:1: warning: add '@preconcurrency' to suppress 'Sendable'-related warnings from module 'ObjectiveC'
/Users/example/bmux/Sources/AppDelegate.swift:10:1: warning: add '@preconcurrency' to suppress 'Sendable'-related warnings from module 'ObjectiveC'
/Users/example/bmux/Sources/AppDelegate.swift:42:9: warning: result of call to 'closePanel(_:force:)' is unused
2026-04-28T09:40:13.8874600Z /Users/example/bmux/Sources/AppDelegate.swift:44:9: warning: capture of 'observer' with non-Sendable type '(any NSObjectProtocol)?' in a '@Sendable' closure; this is an error in the Swift 6 language mode
2026-04-28T09:40:13.8874610Z /Users/example/bmux/Sources/AppDelegate.swift:44:9: warning: capture of 'observer' with non-sendable type '(any NSObjectProtocol)?' in a '@Sendable' closure
/Users/example/bmux/vendor/bonsplit/Sources/Bonsplit/Public/BonsplitView.swift:1:1: warning: ignored vendor warning
/tmp/bmux/SourcePackages/checkouts/posthog-ios/PostHog/PostHogSDK.swift:1:1: warning: ignored package warning
...
cat >>"$LOG" <<'LOG'
/Users/example/bmux/Sources/AppDelegate.swift:43:9: warning: result of call to 'closePanel(_:force:)' is unused
LOG
