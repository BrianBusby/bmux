...
Verifies the guard reports "ok" on the real bmux repo and correctly *fails* on
...
Cases:
  (a) Real bmux repo passes (Sources/ContentView.swift).
...
def main():
    ...
    with tempfile.TemporaryDirectory() as workdir:
        ...
        # (i) Custom-Layout discovery must cover repo-owned Packages/ (where bmux
        ...
        write_text(os.path.join(fake_root, "Packages", "macOS", "BmuxSidebar",
                                "Sources", "X.swift"),
