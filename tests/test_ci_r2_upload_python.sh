...
BMUX_R2_UPLOAD_AMZ_DATE=20260102T030405Z \
...
assert request["url"] == "https://example-account.r2.cloudflarestorage.com/bmux-binaries/nightly/appcast.xml", request
