#!/usr/bin/env python3
"""
Regression test: `bmux omc` preserves fallback provider dirs in PATH.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="bmux-omc-fallback-path-") as td:
        root = Path(td)
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `bmux omc --version` failed with omc in a fallback dir")
    ...
    print("PASS: bmux omc preserves fallback provider dirs in PATH")
    return 0
