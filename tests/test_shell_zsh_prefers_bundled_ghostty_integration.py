#!/usr/bin/env python3
"""
Regression: the bmux zsh wrapper should prefer a bundled Ghostty zsh
integration file in BMUX_SHELL_INTEGRATION_DIR over the fallback integration
...
def main() -> int:
    ...
    base = Path("/tmp") / f"bmux_bundled_ghostty_zsh_{os.getpid()}"
    try:
